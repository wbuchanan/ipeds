...
*                                                        
insheet using "c:\dct\gr2004_l2_data_stata.csv", comma clear
label data "dct_gr2004_l2"
...
"
label variable xline_30 "Imputation field for LINE_30 - Tranfer-out students
"
label variable line_30 "Tranfer-out students
"
...
label define label_xline_10 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xline_45 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xline_50 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xline_11 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xline_30 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
