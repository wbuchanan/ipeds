...
*                                                        
insheet using "c:\dct\c9495_a2dig_data_stata.csv", comma clear
label data "dct_c9495_a2dig"
...
label define label_cipcode 950000 "95.0000 - Field of Study Not Reported", add 
label define label_cipcode 990000 "99.0000 - Award Level Total", add 
label values cipcode label_cipcode
label define label_awlevel -1 "{Missing/NA/LS}" 
