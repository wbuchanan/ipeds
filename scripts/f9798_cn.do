...
*                                                        
insheet using "c:\dct\f9798_cn_data_stata.csv", comma clear
label data "dct_f9798_cn"
...
label define label_xcn01 20 "Imputed using data from prior year", add 
label define label_xcn01 21 "Imputed using method other than prior year data", add 
label define label_xcn01 22 "Imputed using the Group Median procedure", add 
label define label_xcn01 30 "Not applicable", add 
label define label_xcn01 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn02 20 "Imputed using data from prior year", add 
label define label_xcn02 21 "Imputed using method other than prior year data", add 
label define label_xcn02 22 "Imputed using the Group Median procedure", add 
label define label_xcn02 30 "Not applicable", add 
label define label_xcn02 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn03 20 "Imputed using data from prior year", add 
label define label_xcn03 21 "Imputed using method other than prior year data", add 
label define label_xcn03 22 "Imputed using the Group Median procedure", add 
label define label_xcn03 30 "Not applicable", add 
label define label_xcn03 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn04 20 "Imputed using data from prior year", add 
label define label_xcn04 21 "Imputed using method other than prior year data", add 
label define label_xcn04 22 "Imputed using the Group Median procedure", add 
label define label_xcn04 30 "Not applicable", add 
label define label_xcn04 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn05 20 "Imputed using data from prior year", add 
label define label_xcn05 21 "Imputed using method other than prior year data", add 
label define label_xcn05 22 "Imputed using the Group Median procedure", add 
label define label_xcn05 30 "Not applicable", add 
label define label_xcn05 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn06 20 "Imputed using data from prior year", add 
label define label_xcn06 21 "Imputed using method other than prior year data", add 
label define label_xcn06 22 "Imputed using the Group Median procedure", add 
label define label_xcn06 30 "Not applicable", add 
label define label_xcn06 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn07 20 "Imputed using data from prior year", add 
label define label_xcn07 21 "Imputed using method other than prior year data", add 
label define label_xcn07 22 "Imputed using the Group Median procedure", add 
label define label_xcn07 30 "Not applicable", add 
label define label_xcn07 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn08 20 "Imputed using data from prior year", add 
label define label_xcn08 21 "Imputed using method other than prior year data", add 
label define label_xcn08 22 "Imputed using the Group Median procedure", add 
label define label_xcn08 30 "Not applicable", add 
label define label_xcn08 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn08a 20 "Imputed using data from prior year", add 
label define label_xcn08a 21 "Imputed using method other than prior year data", add 
label define label_xcn08a 22 "Imputed using the Group Median procedure", add 
label define label_xcn08a 30 "Not applicable", add 
label define label_xcn08a 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn08b 20 "Imputed using data from prior year", add 
label define label_xcn08b 21 "Imputed using method other than prior year data", add 
label define label_xcn08b 22 "Imputed using the Group Median procedure", add 
label define label_xcn08b 30 "Not applicable", add 
label define label_xcn08b 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn08c 20 "Imputed using data from prior year", add 
label define label_xcn08c 21 "Imputed using method other than prior year data", add 
label define label_xcn08c 22 "Imputed using the Group Median procedure", add 
label define label_xcn08c 30 "Not applicable", add 
label define label_xcn08c 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn08d 20 "Imputed using data from prior year", add 
label define label_xcn08d 21 "Imputed using method other than prior year data", add 
label define label_xcn08d 22 "Imputed using the Group Median procedure", add 
label define label_xcn08d 30 "Not applicable", add 
label define label_xcn08d 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn09 20 "Imputed using data from prior year", add 
label define label_xcn09 21 "Imputed using method other than prior year data", add 
label define label_xcn09 22 "Imputed using the Group Median procedure", add 
label define label_xcn09 30 "Not applicable", add 
label define label_xcn09 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn10 20 "Imputed using data from prior year", add 
label define label_xcn10 21 "Imputed using method other than prior year data", add 
label define label_xcn10 22 "Imputed using the Group Median procedure", add 
label define label_xcn10 30 "Not applicable", add 
label define label_xcn10 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn11 20 "Imputed using data from prior year", add 
label define label_xcn11 21 "Imputed using method other than prior year data", add 
label define label_xcn11 22 "Imputed using the Group Median procedure", add 
label define label_xcn11 30 "Not applicable", add 
label define label_xcn11 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xcn12 20 "Imputed using data from prior year", add 
label define label_xcn12 21 "Imputed using method other than prior year data", add 
label define label_xcn12 22 "Imputed using the Group Median procedure", add 
label define label_xcn12 30 "Not applicable", add 
label define label_xcn12 31 "Imputed using Nearest Neighbor procedure", add 
