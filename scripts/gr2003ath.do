...
*                                                        
insheet using "c:\dct\gr2003ath_data_stata.csv", comma clear
label data "dct_gr2003ath"
...
label define label_grtype 1 "Revised Cohort (4-yr institution)" 
...
label define label_grtype 9 "Revised cohort ( 2-yr institution)", add 
...
label define label_cohort 1 "Bachelors/ equiv+other degree/certif-seeking 1997 athletic subcohort (4-yr institution)" 
label define label_cohort 3 "Degree/certif-seeking students 2000 athletic subcohort ( 2-yr institution)", add 
...
label define label_line 80 "Tranfer-out students", add 
