...
*                                                        
insheet using "c:\dct\gr2000_data_stata.csv", comma clear
...
label define label_section 1 "Bachelors/ equiv +  other degree/certif-seeking 1994 subcohorts (4-yr institution)" 
label define label_section 2 "Bachelors or equiv 1994 subcohort (4-yr institution)", add 
label define label_section 3 "Other degree/certif-seeking 1994 subcohort (4-yr institution)", add 
label define label_section 4 "Degree/certif-seeking students 1997 cohort ( 2-yr and <2-yr institution)", add 
label values section label_section
label define label_cohort 1 "Bachelors/ equiv +  other degree/certif-seeking 1994 subcohorts (4-yr institution)" 
label define label_cohort 2 "Bachelors or equiv 1994 subcohort (4-yr institution)", add 
label define label_cohort 3 "Other degree/certif-seeking 1994 subcohort (4-yr institution)", add 
label define label_cohort 4 "Degree/certif-seeking students 1997 cohort ( 2-yr institution)", add 
label define label_cohort 5 "Degree/certif-seeking students 1997 cohort ( <2-yr institution)", add 
...
label define label_xgrrac01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac08 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac09 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac10 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac11 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac12 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac13 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac14 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac15 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac16 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac17 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac18 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac19 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac20 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac21 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac22 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac23 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xgrrac24 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
