...
*                                                        
insheet using "c:\dct\gr2005_data_stata.csv", comma clear
...
label define label_xgrrac01 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac02 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac03 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac04 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac05 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac06 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac07 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac08 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac09 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac10 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac11 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac12 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac13 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac14 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac15 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac16 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac17 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac18 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac19 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac20 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac21 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac22 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac23 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xgrrac24 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
