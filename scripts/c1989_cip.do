...
*                                                        
insheet using "c:\dct\c1989_cip_data_stata.csv", comma clear
label data "dct_c1989_cip"
label variable unitid "unitid"
label variable cipcode "6-digit cipcode"
label variable crace15 "Total men"
label variable crace16 "Total women"
label variable awlevel "Award level code"
label define label_cipcode 10101 "01.0101 - Agricultural Business and Management, General" 
...
label define label_cipcode 10203 "01.0203 - Agricultural Mechanics, Construction and Maintenance Skills", add 
label define label_cipcode 10204 "01.0204 - Agricultural Power Machinery Operator", add 
label define label_cipcode 10205 "01.0205 - Agricultural Structures, Equipment, and Facilities", add 
label define label_cipcode 10206 "01.0206 - Soil and Water Mechnical Practices", add 
label define label_cipcode 10299 "01.0299 - Agricultural Mechanization, Other", add 
label define label_cipcode 10301 "01.0301 - Agricultural Production Workers and Managers, General", add 
label define label_cipcode 10302 "01.0302 - Agricultural Animal Husbandry and Production Management", add 
label define label_cipcode 10303 "01.0303 - Aquaculture Operations and Production Management", add 
...
label define label_cipcode 10399 "01.0399 - Agricultural Production Workers and Managers, Other", add 
label define label_cipcode 10401 "01.0401 - Agricultural and Food Products Processing Operations and Management", add 
label define label_cipcode 10402 "01.0402 - Food Products", add 
label define label_cipcode 10499 "01.0499 - Agricultural Products and Processing, Other", add 
label define label_cipcode 10501 "01.0501 - Agricultural Supplies Retailing and Wholesaling", add 
...
label define label_cipcode 10507 "01.0507 - Equestrian/Equine Studies, Horse Management and Training", add 
label define label_cipcode 10599 "01.0599 - Agricultural Supplies and Related Services, Other", add 
label define label_cipcode 10601 "01.0601 - Horticulture Services Operations and Management, General", add 
label define label_cipcode 10602 "01.0602 - Arboriculture", add 
label define label_cipcode 10603 "01.0603 - Ornamental Horticulture Operation and Management", add 
...
label define label_cipcode 10699 "01.0699 - Horticulture Services Operations and Management, Other", add 
...
label define label_cipcode 30203 "03.0203 - Natural Resources Law Enforcement and Protective Services", add 
label define label_cipcode 30299 "03.0299 - Natural Resources Management and Protective Services, Other", add 
label define label_cipcode 30301 "03.0301 - Fishing and Fisheries Sciences and Management", add 
label define label_cipcode 30401 "03.0401 - Forest Harvesting and Production Technology/Technician", add 
...
label define label_cipcode 39999 "03.9999 - Conservation and Renewable Natural Resources, Other", add 
label define label_cipcode 40101 "04.0101 - Architecture and Environmental Design, General", add 
...
label define label_cipcode 40801 "04.0801 - Land Use Managementand Reclamation", add 
...
label define label_cipcode 60401 "06.0401 - Business Admintration and Management, General", add 
label define label_cipcode 60402 "06.0402 - Contract Management and Procure/Purchasing", add 
label define label_cipcode 60403 "06.0403 - Product Management", add 
label define label_cipcode 60499 "06.0499 - Business Admintration and Management, Other", add 
...
label define label_cipcode 60702 "06.0702 - Recreational Enterprises Management", add 
...
label define label_cipcode 60799 "06.0799 - Institutional Management, Other", add 
label define label_cipcode 60801 "06.0801 - Insurance and Risk Management", add 
label define label_cipcode 60901 "06.0901 - International Business Management", add 
...
label define label_cipcode 61201 "06.1201 - Management Information Systems", add 
label define label_cipcode 61302 "06.1302 - Operations Research (Quant Methods)", add 
...
label define label_cipcode 61499 "06.1499 - Marketing Management and Research, Other", add 
...
label define label_cipcode 61801 "06.1801 - Small Business Management and Ownership", add 
label define label_cipcode 61901 "06.1901 - Taxation", add 
label define label_cipcode 62001 "06.2001 - Trade and Industrial Supervision and Management", add 
label define label_cipcode 69999 "06.9999 - Business and Management, Other", add 
label define label_cipcode 70101 "07.0101 - Accounting, Bookkeeping and Related Programs", add 
...
label define label_cipcode 70104 "07.0104 - Machine Billing, Bookeeping, and Computing", add 
label define label_cipcode 70199 "07.0199 - Accounting, Bookkeeping, and Related Programs, Other", add 
label define label_cipcode 70201 "07.0201 - Banking and Related Financial Programs, General", add 
label define label_cipcode 70203 "07.0203 - Insurance Clerk", add 
label define label_cipcode 70205 "07.0205 - Teller", add 
label define label_cipcode 70299 "07.0299 - Banking and Related Financial Programs, Other", add 
label define label_cipcode 70301 "07.0301 - Business Data Process and Related Programs, General", add 
label define label_cipcode 70302 "07.0302 - Business Computer and Console Operation", add 
label define label_cipcode 70303 "07.0303 - Business Data Entry Equipment Operation", add 
label define label_cipcode 70304 "07.0304 - Business Data Peripheral Equipment Operation", add 
...
label define label_cipcode 70399 "07.0399 - Business Data Process and Related Programs, Other", add 
label define label_cipcode 70401 "07.0401 - Office Supervision and Management", add 
label define label_cipcode 70501 "07.0501 - Personnel and Training Programs, General", add 
...
label define label_cipcode 70601 "07.0601 - Secretarial and Related Programs, General", add 
...
label define label_cipcode 70699 "07.0699 - Secretarial and Related Programs, Other", add 
label define label_cipcode 70701 "07.0701 - Typing, General Office and Related Programs, General", add 
...
label define label_cipcode 70707 "07.0707 - Receptionist", add 
...
label define label_cipcode 70799 "07.0799 - Typing General Office and Related Programs, Other", add 
label define label_cipcode 70801 "07.0801 - Word Processing", add 
label define label_cipcode 79999 "07.9999 - Business (Administrative Support), Other", add 
label define label_cipcode 80101 "08.0101 - Apparel and Accessories Marketing Operations, General", add 
...
label define label_cipcode 80199 "08.0199 - Apparel and Accessories Marketing Operations, Other", add 
label define label_cipcode 80201 "08.0201 - Business and Personal Services Marketing, General", add 
label define label_cipcode 80202 "08.0202 - Display", add 
label define label_cipcode 80203 "08.0203 - Markeing of Business or Personal Services", add 
label define label_cipcode 80299 "08.0299 - Business and Personal Services Marketing Operations, Other", add 
...
label define label_cipcode 80501 "08.0501 - Florist Farm Garden Supplies Marketing, General", add 
label define label_cipcode 80503 "08.0503 - Floristry Marketing Operations", add 
label define label_cipcode 80599 "08.0599 - Floristry, Farm and Garden Supplies Marketing, Other", add 
label define label_cipcode 80601 "08.0601 - Food Products Retailing and Wholesaling Operation, General", add 
...
label define label_cipcode 80706 "08.0706 - General Selling Skills and Sales Operations", add 
label define label_cipcode 80707 "08.0707 - Wholesaling", add 
label define label_cipcode 80708 "08.0708 - General Marketing Operations", add 
label define label_cipcode 80799 "08.0799 - General Retail and Wholesale Operations and Skills, Other", add 
label define label_cipcode 80801 "08.0801 - Home and Office Products Marketing Operations, General", add 
...
label define label_cipcode 80807 "08.0807 - Office Products and Equipment Marketing", add 
label define label_cipcode 80808 "08.0808 - Specialty Home Furnishings Marketing", add 
label define label_cipcode 80899 "08.0899 - Home and Office Products Marketing Operations, Other", add 
label define label_cipcode 80901 "08.0901 - Hospitality and Recreation Marketing Operations, General", add 
label define label_cipcode 80902 "08.0902 - Hotel/Motel Services Marketing Operation", add 
...
label define label_cipcode 80905 "08.0905 - Water/Waitress and Related Services", add 
label define label_cipcode 80999 "08.0999 - Hospitality and Recreation Marketing Operations, Other", add 
label define label_cipcode 81001 "08.1001 - Insurance Marketing Operations", add 
label define label_cipcode 81101 "08.1101 - Transportation and Travel Marketing, General", add 
...
label define label_cipcode 81199 "08.1199 - Tourism and Travel Services Marketing Operations, Other", add 
label define label_cipcode 81201 "08.1201 - Vehicles and Petrolem Marketing, General", add 
label define label_cipcode 81203 "08.1203 - Vehicle Parts and Accessories Marketing Operations", add 
label define label_cipcode 81299 "08.1299 - Vehicle and Petroleum Products Marketing Operations, Other", add 
label define label_cipcode 89999 "08.9999 - Marketing Operations/Marketing and Distribution, Other", add 
...
label define label_cipcode 90501 "09.0501 - Public Relations and Organizational Communications", add 
...
label define label_cipcode 100104 "10.0104 - Radio and Television Broadcasting Technology", add 
...
label define label_cipcode 120101 "12.0101 - Drycleaning and Laundering Services", add 
...
label define label_cipcode 130299 "13.0299 - Bilingual/Crosscultural Education, Other", add 
...
label define label_cipcode 130405 "13.0405 - Elementary, Middle and Secondary Education Administration", add 
label define label_cipcode 130406 "13.0406 - Higher Education Administration", add 
label define label_cipcode 130407 "13.0407 - Community and Junior College Administration", add 
...
label define label_cipcode 130605 "13.0605 - Elementary and Secondary Research", add 
label define label_cipcode 130606 "13.0606 - Higher Education Admin.", add 
label define label_cipcode 130699 "13.0699 - Educational Evaluation, Research and Statistics, Other", add 
...
label define label_cipcode 131002 "13.1002 - Education of the Cultural Disadvantaged", add 
...
label define label_cipcode 131009 "13.1009 - Education of Blind and Visually Handicapped", add 
...
label define label_cipcode 131101 "13.1101 - Counselor Education/Student Counseling and Guidance Services", add 
...
label define label_cipcode 131203 "13.1203 - Junior High/Intermed/Middle School Teacher Education", add 
label define label_cipcode 131204 "13.1204 - Pre-Elementary Education/Early Childhd/Kindergarten Teacher Education", add 
...
label define label_cipcode 131309 "13.1309 - Technology/Industrial Arts Teacher Education", add 
label define label_cipcode 131310 "13.1310 - Marketing Operations Teacher Education/Marketing and Distributive Teacher Education", add 
...
label define label_cipcode 131320 "13.1320 - Trade and Industrial Teacher Education (Vocational)", add 
label define label_cipcode 131321 "13.1321 - Computer Teacher Education", add 
label define label_cipcode 131399 "13.1399 - Teacher Education, Specific Academic and Vocational Programs, Other", add 
...
label define label_cipcode 141001 "14.1001 - Electrical, Electronics and Communication Engineering", add 
label define label_cipcode 141002 "14.1002 - Electrical, Electronics and Communication Engineering", add 
...
label define label_cipcode 150102 "15.0102 - Architectural Engineering Technology/Technician", add 
label define label_cipcode 150199 "15.0199 - Architectural Engineering Technology/Technician", add 
...
label define label_cipcode 150203 "15.0203 - Surveying and Mapping Technology", add 
...
label define label_cipcode 150303 "15.0303 - Electrical, Electronic and Communications Engineering Tech./Technician", add 
label define label_cipcode 150304 "15.0304 - Laser and Optical Tech./Technician", add 
label define label_cipcode 150399 "15.0399 - Electrical and Electronic Engineering-Related Tech./Technician, Other", add 
label define label_cipcode 150401 "15.0401 - Biomedical Engineering-Related Tech./Technician", add 
label define label_cipcode 150402 "15.0402 - Computer Maintenance Tech./Technician", add 
...
label define label_cipcode 150499 "15.0499 - Electromechanical Instrumentation and Maintenance Tech./Technician, Other", add 
label define label_cipcode 150501 "15.0501 - Heating, Air Conditioning and Refrigeration Tech./Technician", add 
label define label_cipcode 150502 "15.0502 - Air Pollution Control Tech.", add 
label define label_cipcode 150503 "15.0503 - Energy Management and Systems Tech./Techician", add 
...
label define label_cipcode 150699 "15.0699 - Industrial Production Technology/Techicians, Other", add 
label define label_cipcode 150701 "15.0701 - Occupational Safety and Health Tech./Technician", add 
label define label_cipcode 150702 "15.0702 - Quality Control Technology/Technician", add 
label define label_cipcode 150799 "15.0799 - Quality Control and Safety Technology/Technicians", add 
label define label_cipcode 150801 "15.0801 - Aeronautical and Aerospace Engineering Technology/Technician", add 
...
label define label_cipcode 150805 "15.0805 - Mechanical Engineering/Mechanical Technology", add 
label define label_cipcode 150899 "15.0899 - Mechanical Engineering-Related Technology, Other", add 
label define label_cipcode 150901 "15.0901 - Mining Technology/Technician", add 
label define label_cipcode 150902 "15.0902 - Mining Technology/Technician", add 
label define label_cipcode 150903 "15.0903 - Petroleum Technology/Technician", add 
label define label_cipcode 150999 "15.0999 - Mining and Petroleum Technology/Technician, Other", add 
label define label_cipcode 151001 "15.1001 - Construction/Building Technology/Technician", add 
label define label_cipcode 159999 "15.9999 - Engineering-Related Technology/Technician, Other", add 
label define label_cipcode 160101 "16.0101 - Foreign Languages and Literatures, General", add 
label define label_cipcode 160201 "16.0201 - Foreign Languages and Literatures, Other", add 
...
label define label_cipcode 160399 "16.0399 - East/Southeast Asian Language and Literature, Other", add 
label define label_cipcode 160402 "16.0402 - Russian Language and Literature", add 
label define label_cipcode 160403 "16.0403 - Slavic Language and Literature (Other than Russian)", add 
...
label define label_cipcode 170203 "17.0203 - Electrocardiograph Technology", add 
label define label_cipcode 170204 "17.0204 - Electroencephalograph Technology", add 
...
label define label_cipcode 170209 "17.0209 - Radiologic (Medical) Technology", add 
label define label_cipcode 170210 "17.0210 - Respiratory Therapy Technician", add 
...
label define label_cipcode 170299 "17.0299 - Diagnstic and Treatment Services, Other", add 
...
label define label_cipcode 170305 "17.0305 - Clinical Laboratory Assistant", add 
...
label define label_cipcode 170309 "17.0309 - Medical Laboratory Technician", add 
label define label_cipcode 170310 "17.0310 - Medical Technology", add 
label define label_cipcode 170311 "17.0311 - Microbiology Technician", add 
label define label_cipcode 170399 "17.0399 - Medical Lab Technologies/Technicians, Other", add 
...
label define label_cipcode 170405 "17.0405 - Mental Health/Hum Services, Assistant", add 
label define label_cipcode 170406 "17.0406 - Mental Health/Hum Services, Technician", add 
...
label define label_cipcode 170499 "17.0499 - Ment Health/Human Services, Other", add 
...
label define label_cipcode 170599 "17.0599 - Misc Allied Health Services, Other", add 
...
label define label_cipcode 170699 "17.0699 - Nursing-Related Services, Other", add 
...
label define label_cipcode 170808 "17.0808 - Occupational Therapy Assistant", add 
label define label_cipcode 170811 "17.0811 - Orthotics/Prosthetics", add 
label define label_cipcode 170812 "17.0812 - Orthopedic Assistants, Other", add 
...
label define label_cipcode 170815 "17.0815 - Physical Therapy Assistant", add 
label define label_cipcode 170816 "17.0816 - Recreational Therapy", add 
label define label_cipcode 170817 "17.0817 - Recreational Therapy Assistant", add 
label define label_cipcode 170818 "17.0818 - Respiratory Therapy", add 
label define label_cipcode 170819 "17.0819 - Respiratory Therapy Assistant", add 
...
label define label_cipcode 180199 "18.0199 - Audiology and Speech Pathology, Other", add 
...
label define label_cipcode 180299 "18.0299 - Basic Clinical Health Sciences, Other", add 
...
label define label_cipcode 180701 "18.0701 - Health Services Administration, General", add 
label define label_cipcode 180702 "18.0702 - Health Care Planning", add 
label define label_cipcode 180703 "18.0703 - Medical Records Administration", add 
label define label_cipcode 180799 "18.0799 - Health Services Administration, Other", add 
...
label define label_cipcode 181011 "18.1011 - Neurological Surgery/Neurosurgery Residency", add 
label define label_cipcode 181012 "18.1012 - Nuclear Medicine Residency", add 
label define label_cipcode 181013 "18.1013 - Obstetrics and Gynecology Residency", add 
label define label_cipcode 181016 "18.1016 - Orthopedic", add 
label define label_cipcode 181017 "18.1017 - Otorhinolayngology/otolaryngology", add 
...
label define label_cipcode 182204 "18.2204 - Public Health Practice and Management", add 
...
label define label_cipcode 190602 "19.0602 - Household Equipment", add 
...
label define label_cipcode 200101 "20.0101 - Comprehensive Consumer and Home Education", add 
...
label define label_cipcode 200105 "20.0105 - Exploratory Homemaking", add 
...
label define label_cipcode 200110 "20.0110 - Housing, Home Furnishings, and Equipment", add 
label define label_cipcode 200199 "20.0199 - Consumer and Homemaking Education, Other", add 
...
label define label_cipcode 200302 "20.0302 - Clothing Maintenance Aide", add 
...
label define label_cipcode 200399 "20.0399 - Clothing, Apparel and Textile Workers and Managers, Other", add 
label define label_cipcode 200401 "20.0401 - Institutional Food Workers and Administrators, General", add 
...
label define label_cipcode 200499 "20.0499 - Institutional Food Workers and Administrators, Other", add 
label define label_cipcode 200501 "20.0501 - Home Furnishings and Equipment Installer, General", add 
...
label define label_cipcode 200599 "20.0599 - Home Furnishings and Equipment Installer, Other", add 
...
label define label_cipcode 200699 "20.0699 - Custodial, Housekeeping and Home Services, Other", add 
...
label define label_cipcode 230601 "23.0601 - Linguistics", add 
...
label define label_cipcode 240199 "24.0199 - Liberal Art and Sciences, General Studies and Humanities, Other", add 
...
label define label_cipcode 270201 "27.0201 - Actuarial Science", add 
...
label define label_cipcode 300301 "30.0301 - Multi/Interdisciplinary Studies, Other", add 
...
label define label_cipcode 390101 "39.0101 - Biblical and Other Theological Languages and Literatures", add 
...
label define label_cipcode 410102 "41.0102 - Oceanography", add 
label define label_cipcode 410199 "41.0199 - Biological Technologies, Other", add 
label define label_cipcode 410201 "41.0201 - Nuclear Materials Handling Tech.", add 
label define label_cipcode 410202 "41.0202 - Nuclear Power Plant Operation Technology", add 
label define label_cipcode 410203 "41.0203 - Nuclear Power Plant Radiation Control Technology", add 
...
label define label_cipcode 410302 "41.0302 - Geological Technology", add 
...
label define label_cipcode 410305 "41.0305 - Oceanography", add 
...
label define label_cipcode 421001 "42.1001 - Phycology, Other", add 
...
label define label_cipcode 430201 "43.0201 - Fire Protection and Safety Tech./Technician", add 
...
label define label_cipcode 440201 "44.0201 - Community Organization, Resources and Services", add 
...
label define label_cipcode 450302 "45.0302 - Archaeology", add 
...
label define label_cipcode 460103 "46.0103 - Mason and Tile Setter", add 
label define label_cipcode 460199 "46.0199 - Brickmasonry, Stonemasonry, and Tile Setting, Other", add 
...
label define label_cipcode 460405 "46.0405 - Floor Covering Installation", add 
...
label define label_cipcode 460499 "46.0499 - Construction and Building Finishers and Managers, Other", add 
...
label define label_cipcode 460599 "46.0599 - Plumbing, Pipefitting and Steamfitting, Other", add 
label define label_cipcode 469999 "46.9999 - Construction Trades, Other", add 
label define label_cipcode 470101 "47.0101 - Electrical and Electronics Equipment Installer and Repairers, General", add 
label define label_cipcode 470102 "47.0102 - Business Machine Repairer", add 
label define label_cipcode 470103 "47.0103 - Communication Systems Installer and Repairer", add 
label define label_cipcode 470104 "47.0104 - Computer Installer and Repairer", add 
label define label_cipcode 470105 "47.0105 - Industrial Electronics Installer and Repairer", add 
...
label define label_cipcode 470109 "47.0109 - Electrical and Electronics Equipment Installer and Repairer, General", add 
label define label_cipcode 470199 "47.0199 - Electrical and Electronics Equipment Installer and Repairers, Other", add 
label define label_cipcode 470201 "47.0201 - Heating, Air Conditioning and Refrigeration Mechanic and Repairer", add 
...
label define label_cipcode 470299 "47.0299 - Heat Airconditioning and Refrigeration Mechanic and Repairer, Other", add 
label define label_cipcode 470301 "47.0301 - Industrial Equip. Main. and Repairers, General", add 
...
label define label_cipcode 470305 "47.0305 - Industrial Equipment Maintenance and Repairers, Other", add 
label define label_cipcode 470399 "47.0399 - Industrial Equipment Maintenance and Repairers, Other", add 
...
label define label_cipcode 470405 "47.0405 - Miscellaneous Mechanics and repairers, Other", add 
...
label define label_cipcode 470601 "47.0601 - Vehicle and Mobile Equipment Mechanics and Repairers, General", add 
...
label define label_cipcode 470699 "47.0699 - Vehicle and Mobile Equip. Mechanic and Repairer", add 
...
label define label_cipcode 480201 "48.0201 - Graphic and Printing Equipment Operator, General", add 
...
label define label_cipcode 480207 "48.0207 - Photographic Lab and Darkroom", add 
label define label_cipcode 480208 "48.0208 - Printing Press Operator", add 
label define label_cipcode 480209 "48.0209 - Silk Screen Making and Printing", add 
label define label_cipcode 480299 "48.0299 - Graphic and Printing Equipment Operator, Other", add 
...
label define label_cipcode 480403 "48.0403 - Meatcutter", add 
label define label_cipcode 480499 "48.0499 - Culinary Arts and Related Services, Other", add 
label define label_cipcode 480501 "48.0501 - Machinist/Machine Technologist", add 
label define label_cipcode 480502 "48.0502 - Precision Metal Workers, Other", add 
...
label define label_cipcode 480699 "48.0699 - Precision Worker, Assorted Materials, Other", add 
...
label define label_cipcode 490201 "49.0201 - Vehicle and Equipment Operators, General", add 
...
label define label_cipcode 490204 "49.0204 - Mining Equipment Operation", add 
label define label_cipcode 490205 "49.0205 - Truck, Bus and Other Commercial Vehicle Operators", add 
label define label_cipcode 490299 "49.0299 - Vehicle and Equipment Operators, Other", add 
label define label_cipcode 490301 "49.0301 - Water Transportation, General", add 
...
label define label_cipcode 499999 "49.9999 - Transportation and Materials Moving Workers, Other", add 
...
label define label_cipcode 500402 "50.0402 - Graphic Design, Commercial Art and Illustration", add 
...
label define label_cipcode 500602 "50.0602 - Film-Video Making/Cinematography and Production", add 
