...
*                                                        
insheet using "c:\dct\s2001_abd_data_stata.csv", comma clear
label data "dct_s2001_abd"
label variable unitid "unitid"
label variable line "Primary function/occupational activity"
...
label define label_line 17 "Full-time faculty on 11/12 month contract", add 
label define label_line 18 "Total full-time faculty (Instruction/research/public service)", add 
label define label_line 26 "Full-time executive/administrative and managerial", add 
label define label_line 34 "Full-time other administrative", add 
...
label define label_line 71 "Part-time other administrative", add 
label define label_line 72 "Part-time other professionals", add 
label define label_line 73 "Part-time technical and paraprofessionals", add 
label define label_line 74 "Part-time clerical and secretarial", add 
label define label_line 75 "Part-time skilled crafts", add 
label define label_line 76 "Part-time service/maintenance", add 
label define label_line 77 "Total part-time employees", add 
label define label_line 78 "Grand total full- and part-time employees", add 
label define label_line 9 "Full-time faculty on 9/10 month contract .", add 
