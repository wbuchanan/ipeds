...
*                                                        
insheet using "c:\dct\sal1984_ic_data_stata.csv", comma clear
label data "dct_sal1984_ic"
...
label define label_box1 1 "Imputed data", add 
