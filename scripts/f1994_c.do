...
*                                                        
insheet using "c:\dct\f1994_c_data_stata.csv", comma clear
label data "dct_f1994_c"
...
label variable c9a "Interest income, revenues from other sources"
label variable c9b "Total interest income"
label variable c9c "Total gains"
...
label variable c4a1 "Does summer session operate independent of main?"
...
label variable c6 "Are some E and G expenditures not included in part B?"
...
label variable c8_3 "Expenditures for agricultural experiment services/stations  are not applicable"
