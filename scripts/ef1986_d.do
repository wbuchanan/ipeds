...
*                                                        
insheet using "c:\dct\ef1986_d_data_stata.csv", comma clear
label data "dct_ef1986_d"
...
label variable d1bft "Full-time students in remedial courses in Pt A"
label variable d1bpt "Part-time students in remedial courses in Pt A"
...
label variable d3bft "Full-time students branch campus, Foreign country Part A"
label variable d3bpt "Part-time students brnch campus, Foreign country PtA"
summarize d1aft
summarize d1apt
summarize d1bft
summarize d1bpt
