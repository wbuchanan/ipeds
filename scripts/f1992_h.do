...
*                                                        
insheet using "c:\dct\f1992_h_data_stata.csv", comma clear
label data "dct_f1992_h"
...
label define label_xh011 98 "Not a valid code value", add 
...
label define label_xh012 98 "Not a valid code value", add 
...
label define label_xh021 98 "Not a valid code value", add 
...
label define label_xh022 98 "Not a valid code value", add 
...
label define label_xh033 98 "Not a valid code value", add 
...
label define label_xh043 98 "Not a valid code value", add 
...
label define label_xh053 98 "Not a valid code value", add 
