...
*                                                        
insheet using "c:\dct\ef97_b_data_stata.csv", comma clear
label data "dct_ef97_b"
...
label variable efage03 "First-professional men (column 3)"
label variable efage04 "First-professional women (column 4)"
label variable efage05 "Graduate men (Column 5)"
label variable efage06 "Graduate women (Column 6)"
