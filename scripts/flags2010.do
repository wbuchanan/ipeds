...
*                                                        
insheet using "c:\dct\flags2010_data_stata.csv", comma clear
label data "dct_flags2010"
...
label variable pcf_f_rv "arent/child allocation factor - Finance, if institution submitted revision"
...
label define label_lock_c 1 "Has data, not edited", add 
...
label define label_re_c -1 "Not reported" 
label define label_re_c -2 "Not applicable", add 
label define label_re_c 1 "New race/ethnicity categories", add 
...
label define label_stat_e12 -2 "Not applicable" 
label define label_stat_e12 -9 "Not active", add 
label define label_stat_e12 1 "Respondent", add 
...
label define label_lock_e12 -2 "Not applicable" 
label define label_lock_e12 0 "No data submitted", add 
label define label_lock_e12 1 "Has data, not edited", add 
label define label_lock_e12 3 "Edited, some errors/warnings remain", add 
...
label define label_prch_e12 1 "Parent record includes data from child campuses", add 
...
label define label_imp_e12 1 "Carry foreward (CF)", add 
label define label_imp_e12 2 "Nearest neighbor (NN)", add 
label define label_imp_e12 6 "Ratio adjustment", add 
label values imp_e12 label_imp_e12
label define label_re_e12 -1 "Not reported" 
label define label_re_e12 -2 "Not applicable", add 
label define label_re_e12 1 "New race/ethnicity categories", add 
...
label define label_lock_hr 1 "Has data, not edited", add 
...
label define label_fybeg 022009 "February 2009", add
label define label_fybeg 032009 "March 2009", add
label define label_fybeg 042009 "April 2009", add
label define label_fybeg 052009 "May 2009", add
label define label_fybeg 062009 "June 2009", add
label define label_fybeg 072009 "July 2009", add
label define label_fybeg 082009 "August 2009", add
label define label_fybeg 092009 "September 2009", add
label define label_fybeg 102009 "October 2009", add
label define label_fybeg 112009 "November 2009", add
label define label_fybeg 122009 "December 2009", add
label define label_fybeg 012010 "January 2010", add
label define label_fybeg 022010 "February 2010", add
...
label define label_fyend 102009 "October 2009", add 
label define label_fyend 112009 "November 2009", add 
label define label_fyend 122009 "December 2009", add 
label define label_fyend 012010 "January 2010", add 
label define label_fyend 022010 "February 2010", add 
label define label_fyend 032010 "March 2010", add 
label define label_fyend 042010 "April 2010", add 
label define label_fyend 052010 "May 2010", add 
label define label_fyend 062010 "June 2010", add 
label define label_fyend 072010 "July 2010", add 
label define label_fyend 082010 "August 2010", add 
label define label_fyend 092010 "September 2010", add 
...
label define label_hasgrurl -1 "Not reported" 
label define label_hasgrurl -2 "Not applicable", add 
label define label_hasgrurl 1 "Yes, has website", add 
label define label_hasgrurl 2 "No, does not have website", add 
label values hasgrurl label_hasgrurl
label define label_stat_gr2 -2 "Not applicable" 
label define label_stat_gr2 -9 "Not active", add 
label define label_stat_gr2 1 "Respondent", add 
label define label_stat_gr2 2 "Partial respondent, imputed", add 
...
label define label_lock_gr2 -2 "Not applicable" 
label define label_lock_gr2 0 "No data submitted", add 
label define label_lock_gr2 1 "Has, not edited", add 
...
label define label_prch_gr2 1 "Parent record -  includes data from child campuses", add 
...
label define label_imp_gr2 1 "Carry foreward (CF)", add 
label define label_imp_gr2 2 "Nearest neighbor (NN)", add 
label define label_imp_gr2 3 "Group median (GM)", add 
label values imp_gr2 label_imp_gr2
label define label_re_gr -1 "Not reported" 
label define label_re_gr -2 "Not applicable", add 
label define label_re_gr 1 "New race/ethnicity categories", add 
...
label define label_ntrldstr 1 "Yes", add 
label values ntrldstr label_ntrldstr
label define label_rev_ic -2 "Not applicable" 
label define label_rev_ic 1 "Submitted revised data", add 
label define label_rev_ic 0 "Did not submit revised data", add 
label values rev_ic label_rev_ic
label define label_rev_c -2 "Not applicable" 
...
label define label_rev_e12 -2 "Not applicable" 
label define label_rev_e12 1 "Submitted revised data", add 
label define label_rev_e12 0 "Did not submit revised data", add 
label values rev_e12 label_rev_e12
label define label_rev_sfa -2 "Not applicable" 
...
label define label_rev_hr -2 "Not applicable" 
label define label_rev_hr 1 "Submitted revised data", add 
label define label_rev_hr 0 "Did not submit revised data", add 
label values rev_hr label_rev_hr
label define label_rev_ef -2 "Not applicable" 
...
label define label_rev_f -2 "Not applicable" 
...
label define label_rev_gr -2 "Not applicable" 
...
label define label_rev_gr2 -2 "Not applicable" 
label define label_rev_gr2 1 "Submitted revised data", add 
