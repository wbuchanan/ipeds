...
*                                                        
insheet using "c:\dct\f1993_k_data_stata.csv", comma clear
label data "dct_f1993_k"
...
label define label_xk011 20 "Imputed for a missing item using data from prior year", add 
label define label_xk011 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk011 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk011 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk012 20 "Imputed for a missing item using data from prior year", add 
label define label_xk012 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk012 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk012 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk013 20 "Imputed for a missing item using data from prior year", add 
label define label_xk013 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk013 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk013 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk014 20 "Imputed for a missing item using data from prior year", add 
label define label_xk014 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk014 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk014 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk021 20 "Imputed for a missing item using data from prior year", add 
label define label_xk021 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk021 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk021 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk022 20 "Imputed for a missing item using data from prior year", add 
label define label_xk022 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk022 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk022 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk023 20 "Imputed for a missing item using data from prior year", add 
label define label_xk023 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk023 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk023 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk024 20 "Imputed for a missing item using data from prior year", add 
label define label_xk024 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk024 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk024 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk025 20 "Imputed for a missing item using data from prior year", add 
label define label_xk025 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk025 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk025 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk031 20 "Imputed for a missing item using data from prior year", add 
label define label_xk031 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk031 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk031 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk032 20 "Imputed for a missing item using data from prior year", add 
label define label_xk032 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk032 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk032 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk033 20 "Imputed for a missing item using data from prior year", add 
label define label_xk033 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk033 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk033 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk034 20 "Imputed for a missing item using data from prior year", add 
label define label_xk034 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk034 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk034 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xk035 20 "Imputed for a missing item using data from prior year", add 
label define label_xk035 21 "Imputed for a missing item using method other than prior year", add 
label define label_xk035 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xk035 26 "Imputed for an item that was previously reported using method other than prior year", add 
