...
*                                                        
insheet using "c:\dct\f0203_f1a_f_data_stata.csv", comma clear
label data "dct_f0203_f1a_f"
...
label define label_xf1af01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af10 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af11 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af12 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af12a 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af13 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af14 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af15 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af16 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af17 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1af18 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
