...
*                                                        
insheet using "c:\dct\sal1984_a_data_stata.csv", comma clear
label data "dct_sal1984_a"
label variable unitid "unitid"
label variable impcode "Imputation code"
label variable contract "Contract type"
label variable line "Academic rank by contract length"
...
label define label_contract B "Faculty on 12-month salary contracts", add 
...
label define label_line 8 "12-month contract professors
", add 
label define label_line 9 "12-month contract associate professors", add 
label values line label_line
label define label_xsaa1 10 "Reported" 
label define label_xsaa1 11 "Adjusted data", add 
label define label_xsaa1 12 "Data maybe imputed or adjusted", add 
label define label_xsaa1 20 "Imputed", add 
label define label_xsaa1 98 "Entry unknown", add 
label values xsaa1 label_xsaa1
label define label_xsaa2 10 "Reported" 
label define label_xsaa2 11 "Adjusted data", add 
label define label_xsaa2 12 "Data maybe imputed or adjusted", add 
label define label_xsaa2 20 "Imputed", add 
label define label_xsaa2 98 "Entry unknown", add 
label values xsaa2 label_xsaa2
label define label_xsaa3 10 "Reported" 
label define label_xsaa3 11 "Adjusted data", add 
label define label_xsaa3 12 "Data maybe imputed or adjusted", add 
label define label_xsaa3 20 "Imputed", add 
label define label_xsaa3 98 "Entry unknown", add 
label values xsaa3 label_xsaa3
label define label_xsaa4 10 "Reported" 
label define label_xsaa4 11 "Adjusted data", add 
label define label_xsaa4 12 "Data maybe imputed or adjusted", add 
label define label_xsaa4 20 "Imputed", add 
label define label_xsaa4 98 "Entry unknown", add 
label values xsaa4 label_xsaa4
label define label_xsaa5 10 "Reported" 
label define label_xsaa5 11 "Adjusted data", add 
label define label_xsaa5 12 "Data maybe imputed or adjusted", add 
label define label_xsaa5 20 "Imputed", add 
label define label_xsaa5 98 "Entry unknown", add 
label values xsaa5 label_xsaa5
label define label_xsaa6 10 "Reported" 
label define label_xsaa6 11 "Adjusted data", add 
label define label_xsaa6 12 "Data maybe imputed or adjusted", add 
label define label_xsaa6 20 "Imputed", add 
label define label_xsaa6 98 "Entry unknown", add 
