...
*                                                        
insheet using "c:\dct\ef2001a_data_stata.csv", comma clear
...
label define label_line 20 "Total, part-time degee-seeking undergraduates", add 
label define label_line 21 "Part-time nondegree-seeking", add 
...
label define label_line 29 "Grand total, all students", add 
