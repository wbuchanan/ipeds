...
*                                                        
insheet using "c:\dct\c2001_a_data_stata.csv", comma clear
label data "dct_c2001_a"
...
label define label_cipcode 10101 "01.0101 - Agricultural Business and Management, Ge" 
label define label_cipcode 10102 "01.0102 - Agricultural Business/Agribusiness Opera", add 
...
label define label_cipcode 10199 "01.0199 - Agricultural Business and Management, Ot", add 
...
label define label_cipcode 10301 "01.0301 - Agricultural Production Workers and Mana", add 
label define label_cipcode 10302 "01.0302 - Agricultural Animal Husbandry and Produc", add 
label define label_cipcode 10303 "01.0303 - Aquaculture Operations and Production Ma", add 
label define label_cipcode 10304 "01.0304 - Crop Production Operations and Managemen", add 
label define label_cipcode 10399 "01.0399 - Agricultural Production Workers and Mana", add 
label define label_cipcode 10401 "01.0401 - Agriculture/Food Products Processing Ope", add 
label define label_cipcode 10501 "01.0501 - Agricultural Supplies Retailing and Whol", add 
label define label_cipcode 10505 "01.0505 - Animal Trainer", add 
label define label_cipcode 10507 "01.0507 - Equestrian/Equine Studies, Horse Managem", add 
label define label_cipcode 10599 "01.0599 - Agricultural Supplies and Related Servic", add 
label define label_cipcode 10601 "01.0601 - Horticulture Services Operations and Man", add 
label define label_cipcode 10603 "01.0603 - Ornamental Horticulture Operations and M", add 
...
label define label_cipcode 10699 "01.0699 - Horticulture Services Operations and Man", add 
label define label_cipcode 10701 "01.0701 - International Agriculture", add 
label define label_cipcode 19999 "01.9999 - Agricultural Business and Production, Ot", add 
label define label_cipcode 20101 "02.0101 - Agriculture/Agricultural Sciences, Gener", add 
...
label define label_cipcode 20202 "02.0202 - Agricultural Animal Breeding and Genetic", add 
...
label define label_cipcode 20301 "02.0301 - Food Sciences and Technology", add 
...
label define label_cipcode 30203 "03.0203 - Natural Resources Law Enforcement and Pr", add 
label define label_cipcode 30299 "03.0299 - Natural Resources Management and Protect", add 
label define label_cipcode 30301 "03.0301 - Fishing and Fisheries Sciences and Manag", add 
label define label_cipcode 30401 "03.0401 - Forest Harvesting and Production Technol", add 
...
label define label_cipcode 30509 "03.0509 - Wood Science and Pulp / Paper Technology", add 
...
label define label_cipcode 39999 "03.9999 - Conservation and Renewable Natural Resou", add 
label define label_cipcode 40201 "04.0201 - Architecture", add 
label define label_cipcode 40301 "04.0301 - City / Urban, Community & Regional Plann", add 
...
label define label_cipcode 50202 "05.0202 - American Indian / Native American Studie", add 
...
label define label_cipcode 80101 "08.0101 - Apparel and Accessories Marketing Operat", add 
label define label_cipcode 80102 "08.0102 - Fashion Merchandising", add 
label define label_cipcode 80199 "08.0199 - Apparel and Accessories Marketing Operat", add 
...
label define label_cipcode 80299 "08.0299 - Business and Personal Services Marketing", add 
...
label define label_cipcode 80601 "08.0601 - Food Products Retailing and Wholesaling", add 
...
label define label_cipcode 80706 "08.0706 - General Selling Skills and Sales Operati", add 
...
label define label_cipcode 80799 "08.0799 - Gen. Retailing/Wholesaling Operations &", add 
...
label define label_cipcode 80899 "08.0899 - Home and Office Products Marketing Opera", add 
label define label_cipcode 80901 "08.0901 - Hospitality and Recreation Marketing Ope", add 
label define label_cipcode 80902 "08.0902 - Hotel / Motel Services Marketing Operati", add 
label define label_cipcode 80903 "08.0903 - Recreation Products / Services Marketing", add 
label define label_cipcode 80906 "08.0906 - Food Sales Operations", add 
label define label_cipcode 80999 "08.0999 - Hospitality and Recreation Marketing Ope", add 
...
label define label_cipcode 81199 "08.1199 - Tourism and Travel Services Marketing Op", add 
label define label_cipcode 81203 "08.1203 - Vehicle Parts and Accessories Marketing", add 
label define label_cipcode 81208 "08.1208 - Vehicle Marketing Operations", add 
label define label_cipcode 81299 "08.1299 - Vehicle & Petrol Prod. Marketing Op Other", add 
label define label_cipcode 81301 "08.1301 - Health Products and Services Marketing O", add 
label define label_cipcode 89999 "08.9999 - Marketing Operations / Marketing and Dis", add 
...
label define label_cipcode 100101 "10.0101 - Educational / Instructional Media Techno", add 
label define label_cipcode 100103 "10.0103 - Photographic Technology/Technician", add 
label define label_cipcode 100104 "10.0104 - Radio and Television Broadcasting Techno", add 
label define label_cipcode 100199 "10.0199 - Communications Technologies/Technicians,", add 
label define label_cipcode 110101 "11.0101 - Computer and Information Sciences, Gener", add 
...
label define label_cipcode 120299 "12.0299 - Gaming & Sports Officiating Services, Ot", add 
...
label define label_cipcode 120504 "12.0504 - Food and Beverage / Restaurant Operation", add 
label define label_cipcode 120505 "12.0505 - Kitchen Personnel / Cook and Assistant T", add 
...
label define label_cipcode 120599 "12.0599 - Culinary Arts and Related Services, Othe", add 
label define label_cipcode 129999 "12.9999 - Personal and Miscellaneous Services, Oth", add 
...
label define label_cipcode 130401 "13.0401 - Education Administration and Supervision", add 
label define label_cipcode 130402 "13.0402 - Administration of Special Education", add 
label define label_cipcode 130403 "13.0403 - Adult and Continuing Education Administr", add 
label define label_cipcode 130404 "13.0404 - Educational Supervision", add 
label define label_cipcode 130405 "13.0405 - Elementary, Middle and Secondary Educati", add 
label define label_cipcode 130406 "13.0406 - Higher Education Administration", add 
label define label_cipcode 130407 "13.0407 - Community and Junior College Administrat", add 
label define label_cipcode 130499 "13.0499 - Education Administration and Supervision", add 
...
label define label_cipcode 130603 "13.0603 - Educational Statistics and Research Meth", add 
label define label_cipcode 130604 "13.0604 - Educational Assessment, Testing and Meas", add 
label define label_cipcode 130699 "13.0699 - Educational Evaluation, Research and Sta", add 
...
label define label_cipcode 130901 "13.0901 - Social and Philosophical Foundations of", add 
...
label define label_cipcode 131009 "13.1009 - Education of the Blind and Visually Hand", add 
label define label_cipcode 131011 "13.1011 - Education of the Specific Learning Disab", add 
...
label define label_cipcode 131101 "13.1101 - Counselor Education/Counseling and Guida", add 
label define label_cipcode 131102 "13.1102 - College/Postsec. Student Counseling/Pers", add 
...
label define label_cipcode 131203 "13.1203 - Junior High/Intermediate/Middle School T", add 
label define label_cipcode 131204 "13.1204 - Pre-Elementary/Early Childhood/Kindergar", add 
...
label define label_cipcode 131301 "13.1301 - Agricultural Teacher Education (Vocation", add 
...
label define label_cipcode 131308 "13.1308 - Home Economics Teacher Education (Vocati", add 
label define label_cipcode 131309 "13.1309 - Technology/Industrial Arts Teacher Educa", add 
label define label_cipcode 131310 "13.1310 - Marketing Operations / Distribution Teac", add 
...
label define label_cipcode 131327 "13.1327 - Health Occupations Teacher Education (Vo", add 
...
label define label_cipcode 131399 "13.1399 - Teacher Education, Specific Programs, Ot", add 
label define label_cipcode 131401 "13.1401 - Teaching English as a Second Language /", add 
...
label define label_cipcode 140201 "14.0201 - Aerospace, Aeronautical and Astronautica", add 
...
label define label_cipcode 141001 "14.1001 - Electrical, Electronics and Communicatio", add 
...
label define label_cipcode 141401 "14.1401 - Environmental / Environmental Health Eng", add 
...
label define label_cipcode 150101 "15.0101 - Architectural Engineering Technology/Tec", add 
label define label_cipcode 150201 "15.0201 - Civil Engineering / Civil Technology/Tec", add 
label define label_cipcode 150301 "15.0301 - Computer Engineering Technology/Technici", add 
label define label_cipcode 150303 "15.0303 - Electrical/Electronic/Communications Eng", add 
label define label_cipcode 150304 "15.0304 - Laser and Optical Technology/Technician", add 
label define label_cipcode 150399 "15.0399 - Electrical/Electronic Engineering Techno", add 
label define label_cipcode 150401 "15.0401 - Biomedical Engineering-Related Technolog", add 
label define label_cipcode 150402 "15.0402 - Computer Maintenance Technology/Technici", add 
...
label define label_cipcode 150499 "15.0499 - Electromechanical Instrumentation/Maint.", add 
label define label_cipcode 150501 "15.0501 - Heating/Air Conditioning/Refrigeration T", add 
label define label_cipcode 150503 "15.0503 - Energy / Management and Systems Technolo", add 
label define label_cipcode 150505 "15.0505 - Solar Technology Technician", add 
label define label_cipcode 150506 "15.0506 - Water Quality and Wastewater Treatment T", add 
label define label_cipcode 150507 "15.0507 - Environmental and Pollution Control Tech", add 
label define label_cipcode 150599 "15.0599 - Environmental Control Technologies, Othe", add 
label define label_cipcode 150603 "15.0603 - Industrial / Manufacturing Technology/Te", add 
...
label define label_cipcode 150699 "15.0699 - Industrial Productuction Technologies/Te", add 
label define label_cipcode 150701 "15.0701 - Occupational Safety and Health Technolog", add 
label define label_cipcode 150702 "15.0702 - Quality Control Technology/Technician", add 
label define label_cipcode 150799 "15.0799 - Quality Control and Safety Technology/Te", add 
label define label_cipcode 150801 "15.0801 - Aeronautical & Aerospace Engineering Tec", add 
label define label_cipcode 150803 "15.0803 - Automotive Engineering Technology/Techni", add 
label define label_cipcode 150805 "15.0805 - Mechanical Engineering / Mechanical Tech", add 
label define label_cipcode 150899 "15.0899 - Mechanical Engineering-Rel. Technologies", add 
...
label define label_cipcode 150999 "15.0999 - Mining and Petroleum Technologies/Techni", add 
label define label_cipcode 151001 "15.1001 - Construction / Building Technology/Techn", add 
label define label_cipcode 151101 "15.1101 - Engineering Technology/Technician, Gener", add 
label define label_cipcode 151102 "15.1102 - Surveying", add 
label define label_cipcode 151103 "15.1103 - Hydraulic Technology/Technician", add 
label define label_cipcode 159999 "15.9999 - Engineering-Related Technologies/Technic", add 
label define label_cipcode 160101 "16.0101 - Foreign Languages and Literatures, Gener", add 
label define label_cipcode 160102 "16.0102 - Linguistics", add 
label define label_cipcode 160103 "16.0103 - Foreign Language Interpretation & Transl", add 
...
label define label_cipcode 160399 "16.0399 - East and Southeast Asian Languages and L", add 
label define label_cipcode 160402 "16.0402 - Russian Language and Literature", add 
label define label_cipcode 160403 "16.0403 - Slavic Languages and Literatures (Other", add 
label define label_cipcode 160499 "16.0499 - East European Languages and Literatures,", add 
...
label define label_cipcode 160599 "16.0599 - Germanic Languages and Literatures, Othe", add 
...
label define label_cipcode 161199 "16.1199 - Middle Eastern Languages and Literatures", add 
label define label_cipcode 161201 "16.1201 - Classics and Classical Languages and Lit", add 
label define label_cipcode 161202 "16.1202 - Greek Language and Literature (Ancient/M", add 
label define label_cipcode 161203 "16.1203 - Latin Language and Literature (Ancient/M", add 
label define label_cipcode 161299 "16.1299 - Classical/Ancient Near Eastern Languages", add 
...
label define label_cipcode 190499 "19.0499 - Family / Consumer Resource Management, O", add 
...
label define label_cipcode 190701 "19.0701 - Individual and Family Development Studie", add 
...
label define label_cipcode 190706 "19.0706 - Child Growth, Care and Development Studi", add 
label define label_cipcode 190799 "19.0799 - Individual and Family Development Studie", add 
...
label define label_cipcode 200201 "20.0201 - Child Care and Guidance Workers and Mana", add 
...
label define label_cipcode 200299 "20.0299 - Child Care and Guidance Workers and Mana", add 
label define label_cipcode 200301 "20.0301 - Clothing, Apparel and Textile Workers an", add 
...
label define label_cipcode 200309 "20.0309 - Drycleaner and Launderer", add 
label define label_cipcode 200399 "20.0399 - Clothing, Apparel and Textile Workers an", add 
label define label_cipcode 200401 "20.0401 - Institutional Food Workers and Administr", add 
...
label define label_cipcode 200409 "20.0409 - Institutional Food Services Administrato", add 
label define label_cipcode 200499 "20.0499 - Institutional Food Workers and Administr", add 
label define label_cipcode 200501 "20.0501 - Home Furnishings/Equipment Installers/Co", add 
label define label_cipcode 200502 "20.0502 - Window Treatment Maker and Installer", add 
label define label_cipcode 200599 "20.0599 - Home Furnishings/Equipment Installers/Co", add 
...
label define label_cipcode 239999 "23.9999 - English Language and Literature / Letter", add 
label define label_cipcode 240101 "24.0101 - Liberal Arts and Sciences / Liberal Stud", add 
...
label define label_cipcode 240199 "24.0199 - Liberal Arts & Sciences/General Studies/", add 
...
label define label_cipcode 260699 "26.0699 - Miscellaneous Biological Specializations", add 
...
label define label_cipcode 269999 "26.9999 - Biological Sciences / Life Sciences, Oth", add 
...
label define label_cipcode 301201 "30.1201 - Historic Preservation, Conservation & Ar", add 
...
label define label_cipcode 310301 "31.0301 - Parks, Recreation and Leisure Facilities", add 
label define label_cipcode 310501 "31.0501 - Health and Physical Education, General", add 
label define label_cipcode 310502 "31.0502 - Adapted Physical Education / Therapeutic", add 
label define label_cipcode 310503 "31.0503 - Athletic Training and Sports Medicine", add 
label define label_cipcode 310504 "31.0504 - Sport and Fitness Administration / Manag", add 
label define label_cipcode 310505 "31.0505 - Exercise Sciences / Physiology and Movem", add 
label define label_cipcode 310506 "31.0506 - Socio-Psychological Sports Studies", add 
label define label_cipcode 310599 "31.0599 - Health and Physical Education / Fitness,", add 
...
label define label_cipcode 390101 "39.0101 - Biblical and Other Theological Languages", add 
label define label_cipcode 390201 "39.0201 - Bible / Biblical Studies", add 
label define label_cipcode 390301 "39.0301 - Missions / Missionary Studies and Misolo", add 
...
label define label_cipcode 390604 "39.0604 - Pre-Theological / Pre-Ministerial Studie", add 
...
label define label_cipcode 390701 "39.0701 - Pastoral Counseling and Specialized Mini", add 
label define label_cipcode 399999 "39.9999 - Theological Studies and Religious Vocati", add 
...
label define label_cipcode 410204 "41.0204 - Industrial Radiologic Technology/Technic", add 
label define label_cipcode 410205 "41.0205 - Nuclear / Nuclear Power Technology/Techn", add 
label define label_cipcode 410299 "41.0299 - Nuclear/Industrial Radiologic Technologi", add 
label define label_cipcode 410301 "41.0301 - Chemical Technology/Technician", add 
label define label_cipcode 410399 "41.0399 - Physical Science Technology/Technicians,", add 
...
label define label_cipcode 420301 "42.0301 - Cognitive Psychology and Psycholinguisti", add 
...
label define label_cipcode 430102 "43.0102 - Corrections / Correctional Administratio", add 
...
label define label_cipcode 430201 "43.0201 - Fire Protection and Safety Technology/Te", add 
...
label define label_cipcode 440201 "44.0201 - Community Organization, Resources and Se", add 
...
label define label_cipcode 449999 "44.9999 - Public Administration and Services, Othe", add 
...
label define label_cipcode 450604 "45.0604 - Development Economics and International", add 
...
label define label_cipcode 450804 "45.0804 - History and Philosophy of Science and Te", add 
label define label_cipcode 450805 "45.0805 - Public / Applied History and Archival Ad", add 
...
label define label_cipcode 451001 "45.1001 - Political Science and Government, Genera", add 
...
label define label_cipcode 460201 "46.0201 - Carpenters", add 
...
label define label_cipcode 460401 "46.0401 - Building / Property Maintenance and Mana", add 
...
label define label_cipcode 460499 "46.0499 - Construction and Building Finishers and", add 
...
label define label_cipcode 470101 "47.0101 - Electrical/Electronics Equip. Installer/", add 
label define label_cipcode 470102 "47.0102 - Business Machine Repairer", add 
label define label_cipcode 470103 "47.0103 - Communication Systems Installer and Repa", add 
label define label_cipcode 470104 "47.0104 - Computer Installer and Repairer", add 
label define label_cipcode 470105 "47.0105 - Industrial Electronics Installer and Rep", add 
label define label_cipcode 470106 "47.0106 - Major Appliance Installer and Repairer", add 
label define label_cipcode 470199 "47.0199 - Electrical/Electronics Equip. Installer/", add 
label define label_cipcode 470201 "47.0201 - Heating/Air Conditioning/Refrigeration M", add 
label define label_cipcode 470302 "47.0302 - Heavy Equipment Maintenance and Repairer", add 
label define label_cipcode 470303 "47.0303 - Industrial Machinery Maintenance and Rep", add 
label define label_cipcode 470399 "47.0399 - Industrial Equipment Maintenance and Rep", add 
...
label define label_cipcode 470499 "47.0499 - Miscellaneous Mechanics and Repairers, O", add 
label define label_cipcode 470501 "47.0501 - Stationary Energy Sources Installer and", add 
...
label define label_cipcode 470608 "47.0608 - Aircraft Mechanic / Technician, Powerpla", add 
label define label_cipcode 470609 "47.0609 - Aviation Systems/Avionics Maintenance Te", add 
label define label_cipcode 470611 "47.0611 - Motorcycle Mechanic and Repairer", add 
label define label_cipcode 470699 "47.0699 - Vehicle and Mobile Equipment Mechanics a", add 
...
label define label_cipcode 480201 "48.0201 - Graphic and Printing Equipment Operator,", add 
...
label define label_cipcode 480211 "48.0211 - Computer Typography and Composition Equi", add 
label define label_cipcode 480212 "48.0212 - Desktop Publishing Equipment Operator", add 
label define label_cipcode 480299 "48.0299 - Graphic and Printing Equipment Operator,", add 
...
label define label_cipcode 490102 "49.0102 - Aircraft Pilot and Navigator (Profession", add 
...
label define label_cipcode 490205 "49.0205 - Truck, Bus and Other Commercial Vehicle", add 
...
label define label_cipcode 490306 "49.0306 - Marine Maintenance and Ship Repairer", add 
...
label define label_cipcode 500502 "50.0502 - Technical Theater / Theater Design and S", add 
...
label define label_cipcode 500505 "50.0505 - Drama / Theater Literature, History and", add 
label define label_cipcode 500599 "50.0599 - Dramatic / Theater Arts and Stagecraft,", add 
label define label_cipcode 500601 "50.0601 - Film / Cinema Studies", add 
label define label_cipcode 500602 "50.0602 - Film-Video Making / Cinematography and P", add 
label define label_cipcode 500605 "50.0605 - Photography", add 
label define label_cipcode 500699 "50.0699 - Film / Video and Photographic Arts, Othe", add 
...
label define label_cipcode 510299 "51.0299 - Communication Disorders Sciences and Ser", add 
label define label_cipcode 510301 "51.0301 - Community Health Liaison", add 
label define label_cipcode 510401 "51.0401 - Dentistry (First-professional)", add 
label define label_cipcode 510501 "51.0501 - Dental Clinical Sciences / Graduate Dent", add 
...
label define label_cipcode 510701 "51.0701 - Health System / Health Services Administ", add 
label define label_cipcode 510702 "51.0702 - Hospital / Health Facilities Administrat", add 
...
label define label_cipcode 510799 "51.0799 - Health and Medical Administrative Servic", add 
...
label define label_cipcode 510808 "51.0808 - Veterinarian Assistant / Animal Health T", add 
...
label define label_cipcode 510903 "51.0903 - Electroencephalograph Technology/Technic", add 
...
label define label_cipcode 510999 "51.0999 - Health and Medical Diagnostic and Treatm", add 
...
label define label_cipcode 511099 "51.1099 - Health & Medical Laboratory Technologies", add 
...
label define label_cipcode 511199 "51.1199 - Health and Medical Preparatory Programs,", add 
label define label_cipcode 511201 "51.1201 - Medicine (First-professional)", add 
...
label define label_cipcode 511502 "51.1502 - Psychiatric / Mental Health Services Tec", add 
...
label define label_cipcode 511610 "51.1610 - Nursing, Psychiatric / Mental Health (Po", add 
...
label define label_cipcode 511899 "51.1899 - Ophthalmic/Optom Svcs, Oth", add 
...
label define label_cipcode 512002 "51.2002 - Pharmacy Administration and Pharmaceutic", add 
label define label_cipcode 512003 "51.2003 - Medical Pharmacology and Pharmaceutical", add 
...
label define label_cipcode 512206 "51.2206 - Occupational Health and Industrial Hygie", add 
...
label define label_cipcode 512399 "51.2399 - Rehabilitation / Therapeutic Services, O", add 
...
label define label_cipcode 519999 "51.9999 - Health Professions and Related Sciences,", add 
label define label_cipcode 520101 "52.0101 - Business, General", add 
label define label_cipcode 520201 "52.0201 - Business Administration and Management,", add 
label define label_cipcode 520202 "52.0202 - Purchasing, Procurement and Contracts Ma", add 
...
label define label_cipcode 520299 "52.0299 - Business Administration and Management,", add 
...
label define label_cipcode 520401 "52.0401 - Administrative Assistant / Secretarial S", add 
label define label_cipcode 520402 "52.0402 - Executive Assistant / Secretary", add 
label define label_cipcode 520403 "52.0403 - Legal Administrative Assistant / Secreta", add 
label define label_cipcode 520404 "52.0404 - Medical Administrative Assistant / Secre", add 
...
label define label_cipcode 520408 "52.0408 - General Office / Clerical and Typing Ser", add 
label define label_cipcode 520499 "52.0499 - Administrative and Secretarial Services,", add 
...
label define label_cipcode 520701 "52.0701 - Enterprise Management and Operation, Gen", add 
label define label_cipcode 520799 "52.0799 - Enterprise Management and Operation, Oth", add 
...
label define label_cipcode 521201 "52.1201 - Management Info. Systems & Business Data", add 
label define label_cipcode 521202 "52.1202 - Business Computer Programming / Programm", add 
...
label define label_cipcode 521399 "52.1399 - Business Quantitative Methods and Manage", add 
label define label_cipcode 521401 "52.1401 - Business Marketing and Marketing Managem", add 
...
label define label_cipcode 529999 "52.9999 - Business Management and Administrative S", add 
...
label define label_awlevel 2 "Awards at least 1 but less than 2 academ", add 
label define label_awlevel 3 "Associates degrees", add 
label define label_awlevel 4 "Awards at least 2 but less than 4 academ", add 
...
label define label_xcrace01 23 "Partial imputation", add 
...
label define label_xcrace02 23 "Partial imputation", add 
...
label define label_xcrace03 23 "Partial imputation", add 
...
label define label_xcrace04 23 "Partial imputation", add 
...
label define label_xcrace05 23 "Partial imputation", add 
...
label define label_xcrace06 23 "Partial imputation", add 
...
label define label_xcrace07 23 "Partial imputation", add 
...
label define label_xcrace08 23 "Partial imputation", add 
...
label define label_xcrace09 23 "Partial imputation", add 
...
label define label_xcrace10 23 "Partial imputation", add 
...
label define label_xcrace11 23 "Partial imputation", add 
...
label define label_xcrace12 23 "Partial imputation", add 
...
label define label_xcrace13 23 "Partial imputation", add 
...
label define label_xcrace14 23 "Partial imputation", add 
...
label define label_xcrace15 23 "Partial imputation", add 
...
label define label_xcrace16 23 "Partial imputation", add 
