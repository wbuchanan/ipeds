...
*                                                        
insheet using "c:\dct\ef2003d_data_stata.csv", comma clear
label data "dct_ef2003d"
...
label variable xugenter "Imputation field for UGENTERN - Total entering students at the undergraduate level, fall 2003"
label variable ugentern "Total entering students at the undergraduate level, fall 2003"
...
label variable xret_pcf "Imputation field for RET_PCF - Percent of first-time full-time degree/certificate-seeking undergraduate students in fall 2002 returning in fall 2003"
label variable ret_pcf "Percent of first-time full-time degree/certificate-seeking undergraduate students in fall 2002 returning in fall 2003"
label variable xret_pcp "Imputation field for RET_PCP - Percent of first-time part-time degree/certificate-seeking undergraduate students in fall 2002 returning in fall 2003"
label variable ret_pcp "Percent of first-time part-time degree/certificate-seeking undergraduate students in fall 2002 returning in fall 2003"
...
label define label_xgrcohrt 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xugenter 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xpgrcohr 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xret_pcf 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xret_pcp 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
