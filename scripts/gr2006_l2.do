...
*                                                        
insheet using "c:\dct\gr2006_l2_data_stata.csv", comma clear
label data "dct_gr2006_l2"
...
label define label_xline_10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xline_10 51 "Outlier value derived from imported data", add 
label define label_xline_10 52 "Value not derived - parent/child differs across components", add 
label define label_xline_10 53 "Value not derived - data not usable", add 
...
label define label_xline_45 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xline_45 51 "Outlier value derived from imported data", add 
label define label_xline_45 52 "Value not derived - parent/child differs across components", add 
label define label_xline_45 53 "Value not derived - data not usable", add 
...
label define label_xline_50 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xline_50 51 "Outlier value derived from imported data", add 
label define label_xline_50 52 "Value not derived - parent/child differs across components", add 
label define label_xline_50 53 "Value not derived - data not usable", add 
...
label define label_xline_11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xline_11 51 "Outlier value derived from imported data", add 
label define label_xline_11 52 "Value not derived - parent/child differs across components", add 
label define label_xline_11 53 "Value not derived - data not usable", add 
...
label define label_xline_30 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xline_30 51 "Outlier value derived from imported data", add 
label define label_xline_30 52 "Value not derived - parent/child differs across components", add 
label define label_xline_30 53 "Value not derived - data not usable", add 
