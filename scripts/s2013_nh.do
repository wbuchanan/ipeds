...
*
insheet using "k:\ipedsdata\dct\s2013_nh_data_stata.csv", comma clear
label data "dct_s2013_nh"
...
label define label_snhcat 20000 "Instructional, research and public service",add
label define label_snhcat 21000 "Instructional staff",add
label define label_snhcat 21010 "Instructional staff, with faculty status, total",add
label define label_snhcat 21020 "Instructional staff, with faculty status, Tenured",add
label define label_snhcat 21030 "Instructional staff, with faculty status, On Tenure Track",add
label define label_snhcat 21040 "Instructional staff, with faculty status, Not on Tenure Track/No Tenure system",add
label define label_snhcat 21041 "Instructional staff, with faculty status, Not on Track/No Tenure sys, multi-year contract",add
label define label_snhcat 21042 "Instructional staff, with faculty status, Not on Track/No Tenure sys, annual contract",add
label define label_snhcat 21043 "Instructional staff, with faculty status, Not on Track/No Tenure sys, less-than-annual contract",add
label define label_snhcat 21050 "Instructional staff, without faculty status",add
label define label_snhcat 22000 "Research",add
label define label_snhcat 23000 "Public service",add
label define label_snhcat 25000 "Library and Student and Academic Affairs and Other Education Services",add
...
label define label_snhcat 33000 "Community, Social Service, Legal, Arts,Design, Entertainment, Sports and Media",add
