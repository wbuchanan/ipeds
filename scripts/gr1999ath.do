...
*                                                        
insheet using "c:\dct\gr1999ath_data_stata.csv", comma clear
label data "dct_gr1999ath"
...
label define label_grtype 1 "Degree/certificate seeking students total (4-yr institution)" 
label define label_grtype 10 "Degree/certificate-seeking students (2-year institutions) exclusions", add 
...
label define label_grtype 2 "Degree/certificate-seeking students (4-year institutions) exclusions", add 
...
label define label_sport 5 "All other sports combined", add 
label define label_sport 6 "All sports total", add 
label values sport label_sport
label define label_cohort 1 "Bachelors/ equiv+other degree/certif-seeking 1993 athletic subcohort (4-yr institution)" 
label define label_cohort 3 "Degree/certif-seeking students 1996 athletic subcohort ( 2-yr institution)", add 
