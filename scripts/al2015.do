...
*
insheet using "c:\dct\al2015_data_stata.csv", comma clear
label data "dct_al2015"
...
label variable xltcllct "Imputation field for ltcllct - Total library collections (physical and electronic)"
label variable ltcllct  "Total library collections (physical and electronic)"
...
label variable xltcrclt "Imputation field for ltcrclt - Total library circulations (physical and digital/electronic)"
label variable ltcrclt  "Total library circulations (physical and digital/electronic)"
...
label variable lswmsom  "Salaries/wages, benefits, materials/services, and operations/maintenance"
...
label define label_lsuppvrs 0 " "
label define label_lsuppvrs 1 "Yes",add
