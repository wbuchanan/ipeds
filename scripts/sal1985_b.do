...
*                                                        
insheet using "c:\dct\sal1985_b_data_stata.csv", comma clear
label data "dct_sal1985_b"
label variable unitid "unitid"
label variable impcode "Imputation code"
label variable line "Line number, ranges from 1 through 12"
