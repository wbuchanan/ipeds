...
*                                                        
insheet using "c:\dct\c1988_a2dig_data_stata.csv", comma clear
label data "dct_c1988_a2dig"
label variable unitid "unitid"
label variable cipcode "2-digit CIP code"
