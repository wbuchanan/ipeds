...
*                                                        
insheet using "c:\dct\c2010_a_rv_data_stata.csv", comma clear
label data "dct_c2010_a_rv"
...
label variable xcrace03 "Imputation field for CRACE03 - Black non-Hispanic men - old"
label variable crace03 "Black non-Hispanic men - old"
label variable xcrace04 "Imputation field for CRACE04 - Black non-Hispanic women - old"
label variable crace04 "Black non-Hispanic women - old"
label variable xcrace05 "Imputation field for CRACE05 - American Indian or Alaska Native men - old"
label variable crace05 "American Indian or Alaska Native men - old"
label variable xcrace06 "Imputation field for CRACE06 - American Indian or Alaska Native women - old"
label variable crace06 "American Indian or Alaska Native women - old"
label variable xcrace07 "Imputation field for CRACE07 - Asian or Pacific Islander men - old"
label variable crace07 "Asian or Pacific Islander men - old"
label variable xcrace08 "Imputation field for CRACE08 - Asian or Pacific Islander women - old"
label variable crace08 "Asian or Pacific Islander women - old"
label variable xcrace09 "Imputation field for CRACE09 - Hispanic men - old"
label variable crace09 "Hispanic men - old"
label variable xcrace10 "Imputation field for CRACE10 - Hispanic women - old"
label variable crace10 "Hispanic women - old"
label variable xcrace11 "Imputation field for CRACE11 - White non-Hispanic men - old"
label variable crace11 "White non-Hispanic men - old"
label variable xcrace12 "Imputation field for CRACE12 - White non-Hispanic women - old"
label variable crace12 "White non-Hispanic women - old"
...
label variable xcrace18 "Imputation field for CRACE18 - Black non-Hispanic  total - old"
label variable crace18 "Black non-Hispanic  total - old"
label variable xcrace19 "Imputation field for CRACE19 - American Indian or Alaska Native total - old"
label variable crace19 "American Indian or Alaska Native total - old"
label variable xcrace20 "Imputation field for CRACE20 - Asian or Pacific Islander total - old"
label variable crace20 "Asian or Pacific Islander total - old"
label variable xcrace21 "Imputation field for CRACE21 - Hispanic total - old"
label variable crace21 "Hispanic total - old"
label variable xcrace22 "Imputation field for CRACE22 - White non-Hispanic total - old"
label variable crace22 "White non-Hispanic total - old"
...
label variable xchispm "Imputation field for CHISPM - Hispanic or Latino men - new"
label variable chispm "Hispanic or Latino men - new"
label variable xchispw "Imputation field for CHISPW - Hispanic or Latino women - new"
label variable chispw "Hispanic or Latino women - new"
label variable xcaianm "Imputation field for CAIANM - American Indian or Alaska Native men - new"
label variable caianm "American Indian or Alaska Native men - new"
label variable xcaianw "Imputation field for CAIANW - American Indian or Alaska Native women - new"
label variable caianw "American Indian or Alaska Native women - new"
label variable xcasiam "Imputation field for CASIAM - Asian men - new"
label variable casiam "Asian men - new"
label variable xcasiaw "Imputation field for CASIAW - Asian women - new"
label variable casiaw "Asian women - new"
label variable xcbkaam "Imputation field for CBKAAM - Black or African American men - new"
label variable cbkaam "Black or African American men - new"
label variable xcbkaaw "Imputation field for CBKAAW - Black or African American women - new"
label variable cbkaaw "Black or African American women - new"
label variable xcnhpim "Imputation field for CNHPIM - Native Hawaiian or Other Pacific Islander men - new"
label variable cnhpim "Native Hawaiian or Other Pacific Islander men - new"
label variable xcnhpiw "Imputation field for CNHPIW - Native Hawaiian or Other Pacific Islander women - new"
label variable cnhpiw "Native Hawaiian or Other Pacific Islander women - new"
label variable xcwhitm "Imputation field for CWHITM - White men - new"
label variable cwhitm "White men - new"
label variable xcwhitw "Imputation field for CWHITW - White women - new"
label variable cwhitw "White women - new"
label variable xc2morm "Imputation field for C2MORM - Two or more races men - new"
label variable c2morm "Two or more races men - new"
label variable xc2morw "Imputation field for C2MORW - Two or more races women - new"
label variable c2morw "Two or more races women - new"
label variable xchispt "Imputation field for CHISPT - Hispanic or Latino total - new"
label variable chispt "Hispanic or Latino total - new"
label variable xcaiant "Imputation field for CAIANT - American Indian or Alaska Native total - new"
label variable caiant "American Indian or Alaska Native total - new"
label variable xcasiat "Imputation field for CASIAT - Asian total - new"
label variable casiat "Asian total - new"
label variable xcbkaat "Imputation field for CBKAAT - Black or African American total - new"
label variable cbkaat "Black or African American total - new"
label variable xcnhpit "Imputation field for CNHPIT - Native Hawaiian or Other Pacific Islander total - new"
label variable cnhpit "Native Hawaiian or Other Pacific Islander total - new"
label variable xcwhitt "Imputation field for CWHITT - White total - new"
label variable cwhitt "White total - new"
label variable xc2mort "Imputation field for C2MORT - Two or more races total - new"
label variable c2mort "Two or more races total - new"
label variable xdvcait "Imputation field for DVCAIT - American Indian or Alaska Native total - derived"
label variable dvcait "American Indian or Alaska Native total - derived"
label variable xdvcaim "Imputation field for DVCAIM - American Indian or Alaska Native men - derived"
label variable dvcaim "American Indian or Alaska Native men - derived"
label variable xdvcaiw "Imputation field for DVCAIW - American Indian or Alaska Native women - derived"
label variable dvcaiw "American Indian or Alaska Native women - derived"
label variable xdvcapt "Imputation field for DVCAPT - Asian/Native Hawaiian/Other Pacific Islander total - derived"
label variable dvcapt "Asian/Native Hawaiian/Other Pacific Islander total - derived"
label variable xdvcapm "Imputation field for DVCAPM - Asian/Native Hawaiian/Other Pacific Islander men - derived"
label variable dvcapm "Asian/Native Hawaiian/Other Pacific Islander men - derived"
label variable xdvcapw "Imputation field for DVCAPW - Asian/Native Hawaiian/Other Pacific Islander women - derived"
label variable dvcapw "Asian/Native Hawaiian/Other Pacific Islander women - derived"
label variable xdvcbkt "Imputation field for DVCBKT - Black or African American/Black non-Hispanic total - derived"
label variable dvcbkt "Black or African American/Black non-Hispanic total - derived"
label variable xdvcbkm "Imputation field for DVCBKM - Black or African American/Black non-Hispanic men - derived"
label variable dvcbkm "Black or African American/Black non-Hispanic men - derived"
label variable xdvcbkw "Imputation field for DVCBKW - Black or African American/Black non-Hispanic women - derived"
label variable dvcbkw "Black or African American/Black non-Hispanic women - derived"
label variable xdvchst "Imputation field for DVCHST - Hispanic or Latino/Hispanic total - derived"
label variable dvchst "Hispanic or Latino/Hispanic total - derived"
label variable xdvchsm "Imputation field for DVCHSM - Hispanic or Latino/Hispanic men - derived"
label variable dvchsm "Hispanic or Latino/Hispanic men - derived"
label variable xdvchsw "Imputation field for DVCHSW - Hispanic or Latino/Hispanic women - derived"
label variable dvchsw "Hispanic or Latino/Hispanic women - derived"
label variable xdvcwht "Imputation field for DVCWHT - White/White non-Hispanic total - derived"
label variable dvcwht "White/White non-Hispanic total - derived"
label variable xdvcwhm "Imputation field for DVCWHM - White/White non-Hispanic men - derived"
label variable dvcwhm "White/White non-Hispanic men - derived"
label variable xdvcwhw "Imputation field for DVCWHW - White/White non-Hispanic women - derived"
label variable dvcwhw "White/White non-Hispanic women - derived"
...
label define label_cipcode  90999 "09.0999 - Public Relations, Advertising, and Applied Communication, Othe", add
...
label define label_cipcode 131008 "13.1008 - Education/Teaching of Individuals with Orthopedic and Other Physical Health Impairments", add
...
label define label_cipcode 131018 "13.1018 - Education/Teaching of Individuals in Junior High/Middle School Special Education Programs", add
...
label define label_cipcode 131299 "13.1299 - Teacher Education and Professional Development, Specific Levels and Methods, Other", add
...
label define label_cipcode 141001 "14.1001 - Electrical and Electronics Engineerin", add
...
label define label_cipcode 150499 "15.0499 - Electromechanical and Instrumentation and Maintenance Technologies/Technicians, Other", add
label define label_cipcode 150501 "15.0501 - Heating, Ventilation, Air Conditioning and Refrigeration Engineering Technology/Technician", add
...
label define label_cipcode 150506 "15.0506 - Water Quality and Wastewater Treatment Management and Recycling Technology/Technician", add
...
label define label_cipcode 161100 "16.1100 - Middle/Near Eastern and Semitic Languages, Literatures, and Linguistics, General", add
...
label define label_cipcode 231405 "23.1405 - Childrens and Adolescent Literature", add
...
label define label_cipcode 390704 "39.0704 - Womens Ministry", add
...
label define label_cipcode 439999 "43.9999 - Homeland Security, Law Enforcement, Firefighting and Related Protective Services, Other", add
...
label define label_cipcode 470201 "47.0201 - Heating, Air Conditioning, Ventilation and Refrigeration Maintenance Technology/Technician", add
...
label define label_cipcode 470618 "47.0618 - Recreation Vehicle (RV) Service Technician", add
...
label define label_cipcode 480510 "48.0510 - Computer Numerically Controlled (CNC) Machinist Technology/CNC Machinist", add
...
label define label_cipcode 512502 "51.2502 - Veterinary Anatomy", add
...
label define label_cipcode 512599 "51.2599 - Veterinary Biomedical and Clinical Sciences, Other", add
...
label define label_cipcode 513822 "51.3822 - Womens Health Nurse/Nursing", add
label define label_cipcode 513899 "51.3899 - Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing, Other", add
...
label define label_awlevel 17 "Doctors degree - research/scholarship (new degree classification)", add 
label define label_awlevel 18 "Doctors degree - professional practice (new degree classification)", add 
label define label_awlevel 19 "Doctors degree - other (new degree classification)", add 
label values awlevel label_awlevel

* the following are the possible value labels for the imputation field variables
*'A'='Not applicable'
