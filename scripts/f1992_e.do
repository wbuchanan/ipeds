...
*                                                        
insheet using "c:\dct\f1992_e_data_stata.csv", comma clear
label data "dct_f1992_e"
...
label variable e031 "Unrestricted state government scholarships and fellowships"
label variable e032 "Restricted other federal scholarships and fellowships"
label variable e033 "Total state government scholarships and fellowships"
label variable e041 "Restricted local government scholarships and fellowships"
label variable e042 "Unrestricted local government scholarships and fellowships"
label variable e043 "Total local government scholarships and fellowships"
...
label variable xe031 "Imputation field for E031 - Unrestricted state government scholarships and fellowships"
label variable xe032 "Imputation field for E032 - Restricted other federal scholarships and fellowships"
label variable xe033 "Imputation field for E033 - Total state government scholarships and fellowships"
label variable xe041 "Imputation field for E041 - Restricted local government scholarships and fellowships"
label variable xe042 "Imputation field for E042 - Unrestricted local government scholarships and fellowships"
label variable xe043 "Imputation field for E043 - Total local government scholarships and fellowships"
...
label define label_xe012 98 "Not a valid code value", add 
...
label define label_xe013 98 "Not a valid code value", add 
...
label define label_xe021 98 "Not a valid code value", add 
...
label define label_xe022 98 "Not a valid code value", add 
...
label define label_xe023 98 "Not a valid code value", add 
...
label define label_xe031 98 "Not a valid code value", add 
...
label define label_xe032 98 "Not a valid code value", add 
...
label define label_xe033 98 "Not a valid code value", add 
...
label define label_xe041 98 "Not a valid code value", add 
...
label define label_xe042 98 "Not a valid code value", add 
...
label define label_xe043 98 "Not a valid code value", add 
...
label define label_xe051 98 "Not a valid code value", add 
...
label define label_xe052 98 "Not a valid code value", add 
...
label define label_xe053 98 "Not a valid code value", add 
...
label define label_xe061 98 "Not a valid code value", add 
...
label define label_xe062 98 "Not a valid code value", add 
...
label define label_xe063 98 "Not a valid code value", add 
...
label define label_xe071 98 "Not a valid code value", add 
...
label define label_xe072 98 "Not a valid code value", add 
...
label define label_xe073 98 "Not a valid code value", add 
