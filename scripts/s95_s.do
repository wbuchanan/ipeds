...
*                                                        
insheet using "c:\dct\s95_s_data_stata.csv", comma clear
label data "dct_s95_s"
...
label define label_part C "Part C", add 
label define label_part D "Part D", add 
label define label_part F "Part F", add 
label define label_part G "Part G", add 
label values part label_part
label define label_line 10 "FT Faculty 9-10 Month Contract" 
label define label_line 100 "Professors, no tenure track", add 
label define label_line 101 "Associate professors, no tenure track", add 
label define label_line 102 "Assistant professors, no tenure track", add 
label define label_line 103 "Instructors, no tenure track", add 
label define label_line 104 "Lecturers, no tenure track", add 
label define label_line 105 "No academic rank, no tenure track", add 
label define label_line 106 "Total non-tenured Faculty, no tenure track", add 
label define label_line 107 "Total Faculty", add 
label define label_line 108 "New Hires,Executive, Administrative, and Managerial", add 
...
label define label_line 21 "FT Faculty Total 11-12 Month Contract", add 
label define label_line 22 "FT Faculty", add 
...
label define label_line 71 "Total FT Professionals", add 
label define label_line 72 "Total FT Employees", add 
label define label_line 73 "Total Academic Rank,Tenure", add 
label define label_line 74 "Full-time Soft-Money Staff", add 
label define label_line 75 "FT Nonresident Aliens", add 
...
label define label_line 86 "Professors, tenure", add 
label define label_line 87 "Associate professors, Tenure", add 
label define label_line 88 "Assistant professors, Tenure", add 
label define label_line 89 "Instructors, Tenure", add 
label define label_line 90 "Lecturers, Tenure", add 
label define label_line 91 "No academic rank, Tenure", add 
label define label_line 92 "Total Faculty with Tenure", add 
label define label_line 93 "Professors, tenure track", add 
label define label_line 94 "Associate professors, tenure track", add 
label define label_line 95 "Assistant professors, tenure track", add 
label define label_line 96 "Instructors, tenure track", add 
label define label_line 97 "Lecturers, tenure track", add 
label define label_line 98 "No academic rank, tenure track", add 
label define label_line 99 "Total non-tenured Faculty,tenure track", add 
