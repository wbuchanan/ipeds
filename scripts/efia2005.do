...
*                                                        
insheet using "c:\dct\efia2005_data_stata.csv", comma clear
label data "dct_efia2005"
...
label variable xefteug "Imputation field for EFTEUG - Estimated full-time equivalent (FTE) undergraduate enrollment, academic year 2004-05"
label variable efteug "Estimated full-time equivalent (FTE) undergraduate enrollment, academic year 2004-05"
label variable xeftegd "Imputation field for EFTEGD - Estimated full-time equivalent (FTE) graduate enrollment, academic year 2004-05"
label variable eftegd "Estimated full-time equivalent (FTE) graduate enrollment, academic year 2004-05"
label variable xfteug "Imputation field for FTEUG - Reported full-time equivalent (FTE) undergraduate enrollment, academic year 2004-05"
label variable fteug "Reported full-time equivalent (FTE) undergraduate enrollment, academic year 2004-05"
label variable xftegd "Imputation field for FTEGD - Reported full-time equivalent (FTE) graduate enrollment, academic year 2004-05"
label variable ftegd "Reported full-time equivalent (FTE) graduate enrollment, academic year 2004-05"
...
label define label_xcdactua 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcnactua 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcdactga 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefteug 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xeftegd 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xfteug 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xftegd 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_acttype -2 "Not applicable" 
