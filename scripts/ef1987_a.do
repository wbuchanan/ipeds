...
*                                                        
insheet using "c:\dct\ef1987_a_data_stata.csv", comma clear
...
label define label_xefrac15 20 "Imputed using reported data from prior year", add 
label define label_xefrac15 21 "Imputed using hot deck institution", add 
label define label_xefrac15 23 "Imputed based on national averages", add 
...
label define label_xefrac16 20 "Imputed using reported data from prior year", add 
label define label_xefrac16 21 "Imputed using hot deck institution", add 
label define label_xefrac16 23 "Imputed based on national averages", add 
