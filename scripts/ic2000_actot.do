...
*                                                        
insheet using "c:\dct\ic2000_actot_data_stata.csv", comma clear
label data "dct_ic2000_actot"
...
label define label_accode 25 "Librarianship (LIB)", add 
label define label_accode 26 "Physician Assistant (PA)", add 
label define label_accode 28 "Cytotechnologist (CYTO)", add 
label define label_accode 29 "Diagnostic Medical Sonographer (DMS)", add 
label define label_accode 30 "Electroneurodiagnostic Technologist (ENDT)", add 
label define label_accode 31 "Emergency Medical Technician - Paramedic (EMTP)", add 
...
label define label_accode 42 "Perfusionist (PERF)", add 
label define label_accode 43 "Radiologic Technology (RAD)", add 
label define label_accode 44 "Respiratory Therapist (REST)", add 
label define label_accode 45 "Respiratory Therapy Technician (RESTT)", add 
label define label_accode 46 "Radiologic Technology (RADTT)", add 
label define label_accode 48 "Surgical Technologist (ST)", add 
...
label define label_accode 77 "Interior Design (FIDER)", add 
label define label_accode 78 "Medicine (MED)", add 
label define label_accode 80 "Cosmetology (COSME)", add 
label define label_accode 81 "Architecture (ARCH)", add 
...
label define label_accode 120 "Pathologists Assistant (Path)", add 
...
label define label_accode 126 "Occupational Therapy Assistant (OTA)", add 
label define label_accode 127 "Occupational Education (OCCDGR)", add 
label define label_accode 128 "Nursing (CNURED)", add 
label values accode label_accode
tab accode
save dct_ic2000_actot
