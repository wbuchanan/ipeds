...
*                                                        
insheet using "c:\dct\sal2005_b_data_stata.csv", comma clear
label data "dct_sal2005_b"
...
label define label_xsab09 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xsab11 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xsabeq9 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
