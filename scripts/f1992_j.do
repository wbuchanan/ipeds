...
*                                                        
insheet using "c:\dct\f1992_j_data_stata.csv", comma clear
label data "dct_f1992_j"
...
label define label_xj011 98 "Not a valid code value", add 
...
label define label_xj012 98 "Not a valid code value", add 
...
label define label_xj013 98 "Not a valid code value", add 
...
label define label_xj021 98 "Not a valid code value", add 
...
label define label_xj022 98 "Not a valid code value", add 
...
label define label_xj023 98 "Not a valid code value", add 
...
label define label_xj031 98 "Not a valid code value", add 
...
label define label_xj032 98 "Not a valid code value", add 
...
label define label_xj033 98 "Not a valid code value", add 
...
label define label_xj041 98 "Not a valid code value", add 
...
label define label_xj042 98 "Not a valid code value", add 
...
label define label_xj043 98 "Not a valid code value", add 
...
label define label_xj051 98 "Not a valid code value", add 
...
label define label_xj052 98 "Not a valid code value", add 
...
label define label_xj053 98 "Not a valid code value", add 
...
label define label_xj061 98 "Not a valid code value", add 
...
label define label_xj062 98 "Not a valid code value", add 
...
label define label_xj063 98 "Not a valid code value", add 
...
label define label_xj071 98 "Not a valid code value", add 
...
label define label_xj072 98 "Not a valid code value", add 
...
label define label_xj073 98 "Not a valid code value", add 
...
label define label_xj081 98 "Not a valid code value", add 
...
label define label_xj082 98 "Not a valid code value", add 
...
label define label_xj083 98 "Not a valid code value", add 
