...
*                                                        
insheet using "c:\dct\sal1992_b_data_stata.csv", comma clear
label data "dct_sal1992_b"
...
label variable b45 "Total fringe benefits, expenditures- 9/10-month contract"
label variable b47 "Total fringe benefits, expenditures- 11/12-month contract"
