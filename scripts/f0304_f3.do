...
*                                                        
insheet using "c:\dct\f0304_f3_data_stata.csv", comma clear
label data "dct_f0304_f3"
...
label define label_xf3a01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3a01 51 "Outlier value derived from imputed data", add 
...
label define label_xf3a02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3a02 51 "Outlier value derived from imputed data", add 
...
label define label_xf3a03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3a03 51 "Outlier value derived from imputed data", add 
...
label define label_xf3a04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3a04 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b01 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b02 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b03 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b04 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b05 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b06 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b07 51 "Outlier value derived from imputed data", add 
...
label define label_xf3b08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3b08 51 "Outlier value derived from imputed data", add 
...
label define label_xf3c01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3c01 51 "Outlier value derived from imputed data", add 
...
label define label_xf3c02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3c02 51 "Outlier value derived from imputed data", add 
...
label define label_xf3c03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3c03 51 "Outlier value derived from imputed data", add 
...
label define label_xf3c04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3c04 51 "Outlier value derived from imputed data", add 
...
label define label_xf3c05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3c05 51 "Outlier value derived from imputed data", add 
...
label define label_xf3c06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3c06 51 "Outlier value derived from imputed data", add 
...
label define label_xf3c07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3c07 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d01 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d02 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d03 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d04 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d05 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d06 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d07 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d08 51 "Outlier value derived from imputed data", add 
...
label define label_xf3d09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3d09 51 "Outlier value derived from imputed data", add 
...
label define label_xf3e01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3e01 51 "Outlier value derived from imputed data", add 
...
label define label_xf3e02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3e02 51 "Outlier value derived from imputed data", add 
...
label define label_xf3e03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3e03 51 "Outlier value derived from imputed data", add 
...
label define label_xf3e04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3e04 51 "Outlier value derived from imputed data", add 
...
label define label_xf3e05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3e05 51 "Outlier value derived from imputed data", add 
...
label define label_xf3e06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3e06 51 "Outlier value derived from imputed data", add 
...
label define label_xf3e07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf3e07 51 "Outlier value derived from imputed data", add 
