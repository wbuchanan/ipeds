...
*                                                        
insheet using "c:\dct\c9899_a_data_stata.csv", comma clear
label data "dct_c9899_a"
...
label define label_cipcode 10101 "01.0101 - Agricultural Business and Mgmt., General", add 
...
label define label_cipcode 103 "01.03 - Ag. Production/Workers and Managers", add 
...
label define label_cipcode 104 "01.04 - Ag. & Food Products Processing", add 
label define label_cipcode 10401 "01.0401 - Ag. & Food Products Process. Op. & Mgmt.", add 
label define label_cipcode 105 "01.05 - Ag. Supplies and Related Services", add 
...
label define label_cipcode 106 "01.06 - Horticulture Services Ops. and Mgmt.", add 
...
label define label_cipcode 199 "01.99 - Agricultural Business & Production, Oth.", add 
...
label define label_cipcode 201 "02.01 - Agriculture/Agricultural Sciences", add 
...
label define label_cipcode 202 "02.02 - Animal Sciences", add 
...
label define label_cipcode 203 "02.03 - Food Sciences and Technology", add 
label define label_cipcode 20301 "02.0301 - Food Sciences and Tech.", add 
label define label_cipcode 204 "02.04 - Plant Sciences", add 
...
label define label_cipcode 205 "02.05 - Soil Sciences", add 
label define label_cipcode 20501 "02.0501 - Soil Sciences", add 
label define label_cipcode 299 "02.99 - Agriculture/Agricultural Sciences, Other", add 
...
label define label_cipcode 301 "03.01 - Natural Resources Conservation", add 
...
label define label_cipcode 302 "03.02 - Natural Resources Mgmt. & Protect. Svcs.", add 
...
label define label_cipcode 303 "03.03 - Fishing and Fisheries Sciences and Mgmt.", add 
label define label_cipcode 30301 "03.0301 - Fishing and Fisheries Sciences and Mgmt.", add 
label define label_cipcode 304 "03.04 - Forest Production and Processing", add 
...
label define label_cipcode 305 "03.05 - Forestry and Related Sciences", add 
...
label define label_cipcode 306 "03.06 - Wildlife and Wildlands Management", add 
label define label_cipcode 30601 "03.0601 - Wildlife and Wildlands Management", add 
label define label_cipcode 399 "03.99 - Conservation & Renewable Nat. Resrs, Other", add 
...
label define label_cipcode 403 "04.03 - City/Urban, Community & Regional Planning", add 
label define label_cipcode 40301 "04.0301 - City/Urban, Community & Reg. Planning", add 
label define label_cipcode 404 "04.04 - Architectural Environmental Design", add 
...
label define label_cipcode 407 "04.07 - Architectural Urban Design and Planning", add 
label define label_cipcode 40701 "04.0701 - Architectural Urban Design and Planning", add 
label define label_cipcode 499 "04.99 - Architecture and Related Programs, Other", add 
...
label define label_cipcode 502 "05.02 - Ethnic and Cultural Studies", add 
...
label define label_cipcode 599 "05.99 - Area, Ethnic and Cultural Studies, Other", add 
...
label define label_cipcode 801 "08.01 - Apparel & Accessories Market. Opns.", add 
...
label define label_cipcode 802 "08.02 - Business & Personal Svcs. Mktg. Opns.", add 
...
label define label_cipcode 803 "08.03 - Entrepreneurship", add 
label define label_cipcode 80301 "08.0301 - Entrepreneurship", add 
label define label_cipcode 804 "08.04 - Financial Services Marketing Operations", add 
label define label_cipcode 80401 "08.0401 - Financial Services Marketing Operations", add 
label define label_cipcode 805 "08.05 - Floristry Marketing Operations", add 
label define label_cipcode 80503 "08.0503 - Floristry Marketing Operations", add 
label define label_cipcode 806 "08.06 - Food Products Retail and Wholesale Opns.", add 
label define label_cipcode 80601 "08.0601 - Food Products Retail and Wholesale Opns.", add 
label define label_cipcode 807 "08.07 - Gen. Retailing/Wholesaling Opns. & Skill", add 
...
label define label_cipcode 808 "08.08 - Home/Office Prods. Market. Opns.", add 
...
label define label_cipcode 809 "08.09 - Hospitality & Recreation Market. Opns.", add 
...
label define label_cipcode 810 "08.10 - Insurance Marketing Operations", add 
label define label_cipcode 81001 "08.1001 - Insurance Marketing Operations", add 
label define label_cipcode 811 "08.11 - Tourism/Travel Svcs. Market. Opns.", add 
...
label define label_cipcode 812 "08.12 - Vehicle/Petrol. Products Market. Opns.", add 
...
label define label_cipcode 813 "08.13 - Health Products & Services Marketing Operations", add 
label define label_cipcode 81301 "08.1301 - Health Products & Services Marketing Ops", add 
label define label_cipcode 899 "08.99 - Marketing Opns/Market. & Distrib.,Oth", add 
...
label define label_cipcode 901 "09.01 - Communications, General", add 
label define label_cipcode 90101 "09.0101 - Communications, General", add 
label define label_cipcode 902 "09.02 - Advertising", add 
label define label_cipcode 90201 "09.0201 - Advertising", add 
label define label_cipcode 904 "09.04 - Journalism and Mass Communications", add 
...
label define label_cipcode 905 "09.05 - Public Relations & Organizational Comm.", add 
label define label_cipcode 90501 "09.0501 - Public Relations & Organizational Comm.", add 
label define label_cipcode 907 "09.07 - Radio and Television Broadcasting", add 
label define label_cipcode 90701 "09.0701 - Radio and Television Broadcasting", add 
label define label_cipcode 999 "09.99 - Communications, Other", add 
...
label define label_cipcode 1001 "10.01 - Communications Technologies", add 
...
label define label_cipcode 1101 "11.01 - Computer and Information Sciences", add 
...
label define label_cipcode 1103 "11.03 - Data Processing Technology", add 
label define label_cipcode 110301 "11.0301 - Data Processing Tech./Technician", add 
label define label_cipcode 1104 "11.04 - Information Sciences and Systems", add 
...
label define label_cipcode 1199 "11.99 - Computer and Information Sciences, Other", add 
...
label define label_cipcode 1202 "12.02 - Gaming & Sports Officiating Services", add 
...
label define label_cipcode 1203 "12.03 - Funeral Services and Mortuary Science", add 
label define label_cipcode 120301 "12.0301 - Funeral Services and Mortuary Science", add 
label define label_cipcode 1204 "12.04 - Cosmetic Services", add 
...
label define label_cipcode 1205 "12.05 - Culinary Arts & Related Services", add 
...
label define label_cipcode 1299 "12.99 - Personal & Miscellaneous Services, Other", add 
...
label define label_cipcode 1302 "13.02 - Bilingual/Bicultural Education", add 
...
label define label_cipcode 1304 "13.04 - Education Administration & Supervision", add 
...
label define label_cipcode 1306 "13.06 - Educational Eval., Research & Statistics", add 
...
label define label_cipcode 1308 "13.08 - Educational Psychology", add 
label define label_cipcode 130802 "13.0802 - Educational Psychology", add 
label define label_cipcode 1309 "13.09 - Social/Philosophical Foundations of Educ", add 
label define label_cipcode 130901 "13.0901 - Social/Philosophical Foundations of Educ", add 
label define label_cipcode 1310 "13.10 - Special Education", add 
...
label define label_cipcode 1311 "13.11 - Student Counseling & Personnel Services", add 
...
label define label_cipcode 1312 "13.12 - General Teacher Education", add 
...
label define label_cipcode 1313 "13.13 - Teacher Education, Specif. Acad/Voc. Pgm", add 
...
label define label_cipcode 1314 "13.14 - Teaching ESL/Foreign Language", add 
label define label_cipcode 131401 "13.1401 - Teaching ESL/Foreign Language", add 
label define label_cipcode 1315 "13.15 - Teacher Assistant/Aide", add 
...
label define label_cipcode 1402 "14.02 - Aerospace, Aeronautical and Astronautic", add 
label define label_cipcode 140201 "14.0201 - Aerospace, Aeronautical and Astronautic", add 
label define label_cipcode 1403 "14.03 - Agricultural Engineering", add 
...
label define label_cipcode 1405 "14.05 - Bioengineering & Biomedical Engineering", add 
...
label define label_cipcode 1409 "14.09 - Computer Engineering", add 
label define label_cipcode 140901 "14.0901 - Computer Engineering", add 
label define label_cipcode 1410 "14.10 - Electrical, Electronics & Communication", add 
...
label define label_cipcode 1414 "14.14 - Environmental/Environmental Health Engin", add 
label define label_cipcode 141401 "14.1401 - Environmental/Environmental Health Engin", add 
label define label_cipcode 1415 "14.15 - Geological Engineering", add 
label define label_cipcode 141501 "14.1501 - Geological Engineering", add 
label define label_cipcode 1416 "14.16 - Geophysical Engineering", add 
label define label_cipcode 141601 "14.1601 - Geophysical Engineering", add 
label define label_cipcode 1417 "14.17 - Industrial/Manufacturing Engineering", add 
...
label define label_cipcode 1422 "14.22 - Naval Architecture & Marine Engineering", add 
...
label define label_cipcode 1429 "14.29 - Engineering Design", add 
label define label_cipcode 142901 "14.2901 - Engineering Design", add 
label define label_cipcode 1430 "14.30 - Engineering/Industrial Management", add 
...
label define label_cipcode 1501 "15.01 - Architectural Engineering Technology", add 
label define label_cipcode 150101 "15.0101 - Architectural Engineering Techno/Tech", add 
label define label_cipcode 1502 "15.02 - Civil Engineering/Civil Technology", add 
label define label_cipcode 150201 "15.0201 - Civil Engineering/Civil Tech./Technician", add 
label define label_cipcode 1503 "15.03 - Electrical/Electron. Engineer.-Rel. Tech", add 
...
label define label_cipcode 1504 "15.04 - Electomechanical Instrument./Maint. Tech", add 
...
label define label_cipcode 1505 "15.05 - Environmental Control Technologies", add 
...
label define label_cipcode 1506 "15.06 - Industrial Production Technologies", add 
...
label define label_cipcode 1507 "15.07 - Quality Control & Safety Technologies", add 
...
label define label_cipcode 1508 "15.08 - Mechanical Engineering-Related Tech.", add 
...
label define label_cipcode 1509 "15.09 - Mining & Petrolium Technologies", add 
...
label define label_cipcode 1510 "15.10 - Construction/Building Technology", add 
label define label_cipcode 151001 "15.1001 - Construction/Building Tech./Technician", add 
label define label_cipcode 1511 "15.11 - Misc. Engineering-Related Technologies", add 
...
label define label_cipcode 1599 "15.99 - Engineering-Related Technol./Techn, Oth.", add 
...
label define label_cipcode 1601 "16.01 - Foreign Languages and Literatures", add 
...
label define label_cipcode 1603 "16.03 - East/SE Asian Languages/Literature", add 
...
label define label_cipcode 1604 "16.04 - East European Languages & Literatures", add 
...
label define label_cipcode 1605 "16.05 - Germanic Languages & Literatures", add 
...
label define label_cipcode 1607 "16.07 - South Asian Languages and Literatures", add 
label define label_cipcode 160703 "16.0703 - South Asian Languages and Literatures", add 
label define label_cipcode 1609 "16.09 - Romance Languages and Literatures", add 
...
label define label_cipcode 1611 "16.11 - Middle Eastern Languages & Literatures", add 
...
label define label_cipcode 1612 "16.12 - Classical/Anc. Near East. Langs. & Lit", add 
...
label define label_cipcode 1699 "16.99 - Foreign Languages and Literatures, Other", add 
...
label define label_cipcode 1901 "19.01 - Home Economics, General", add 
label define label_cipcode 190101 "19.0101 - Home Economics, General", add 
label define label_cipcode 1902 "19.02 - Home Economics Business Services", add 
...
label define label_cipcode 1903 "19.03 - Family and Community Studies", add 
label define label_cipcode 190301 "19.0301 - Family and Community Studies", add 
label define label_cipcode 1904 "19.04 - Family/Consumer Resource Management", add 
...
label define label_cipcode 1905 "19.05 - Foods and Nutrition Studies", add 
...
label define label_cipcode 1906 "19.06 - Housing Studies", add 
...
label define label_cipcode 1907 "19.07 - Individual/Family Development Studies", add 
...
label define label_cipcode 1909 "19.09 - Clothing/Apparel and Textile Studies", add 
label define label_cipcode 190901 "19.0901 - Clothing/Apparel and Textile Studies", add 
label define label_cipcode 1999 "19.99 - Home Economics, Other", add 
...
label define label_cipcode 2002 "20.02 - Child Care/Guidance Workers & Managers", add 
...
label define label_cipcode 2003 "20.03 - Clothing, Apparel & Textile Workers & Ma", add 
...
label define label_cipcode 2004 "20.04 - Institutional Food Workers & Admins.", add 
...
label define label_cipcode 2005 "20.05 - Home Furnishings and Equipment Installer", add 
...
label define label_cipcode 2006 "20.06 - Custodial, Housekeeping and Home Service", add 
...
label define label_cipcode 2099 "20.99 - Vocational Home Economics, Other", add 
...
label define label_cipcode 2201 "22.01 - Law and Legal Studies", add 
...
label define label_cipcode 2303 "23.03 - Comparative Literature", add 
...
label define label_cipcode 2305 "23.05 - English Creative Writing", add 
label define label_cipcode 230501 "23.0501 - English Creative Writing", add 
label define label_cipcode 2307 "23.07 - American Literature (United States)", add 
label define label_cipcode 230701 "23.0701 - American Literature (United States)", add 
label define label_cipcode 2308 "23.08 - English Literature (British & Commonweal", add 
...
label define label_cipcode 2311 "23.11 - English Technical and Business Writing", add 
label define label_cipcode 231101 "23.1101 - English Technical and Business Writing", add 
label define label_cipcode 2399 "23.99 - English Language and Lit./Letters, Other", add 
label define label_cipcode 239999 "23.9999 - English Language and Literature/Letters,", add 
label define label_cipcode 24 "24 - Liberal Arts and Studies, General Sciences and Humanities", add 
label define label_cipcode 2401 "24.01 - Lib. Arts & Sci./Gen. Studies/Humanities", add 
...
label define label_cipcode 2604 "26.04 - Cell and Molecular Biology", add 
...
label define label_cipcode 2605 "26.05 - Microbiology/Bacteriology", add 
label define label_cipcode 260501 "26.0501 - Microbiology/Bacteriology", add 
label define label_cipcode 2606 "26.06 - Misc. Biological Specializations", add 
...
label define label_cipcode 2607 "26.07 - Zoology", add 
...
label define label_cipcode 2699 "26.99 - Biological Sciences/Life Sciences, Other", add 
...
label define label_cipcode 2705 "27.05 - Mathematical Statistics", add 
label define label_cipcode 270501 "27.0501 - Mathematical Statistics", add 
label define label_cipcode 2799 "27.99 - Mathematics, Other", add 
...
label define label_cipcode 3005 "30.05 - Peace and Conflict Studies", add 
...
label define label_cipcode 3012 "30.12 - Historic Preservation, Conservation and", add 
...
label define label_cipcode 3015 "30.15 - Science, Tech. and Society", add 
...
label define label_cipcode 3103 "31.03 - Parks, Rec. & Leisure Facilities Mgmt.", add 
...
label define label_cipcode 3199 "31.99 - Parks, Recreation, Leisure and Fitness S", add 
...
label define label_cipcode 3899 "38.99 - Philosophy and Religion", add 
...
label define label_cipcode 3901 "39.01 - Biblical & Oth Theological Lang. & Lit.", add 
...
label define label_cipcode 3903 "39.03 - Missions/Missionary Studies and Misology", add 
...
label define label_cipcode 3906 "39.06 - Theological & Ministerial Studies", add 
...
label define label_cipcode 3907 "39.07 - Pastoral Counseling & Specialized Minist", add 
label define label_cipcode 390701 "39.0701 - Pastoral Counseling & Specialized Minist", add 
label define label_cipcode 3999 "39.99 - Theological Studies & Rel. Vocations, Ot", add 
...
label define label_cipcode 4001 "40.01 - Physical Sciences, General", add 
label define label_cipcode 400101 "40.0101 - Physical Sciences, General", add 
label define label_cipcode 4002 "40.02 - Astronomy", add 
label define label_cipcode 400201 "40.0201 - Astronomy", add 
label define label_cipcode 4003 "40.03 - Astrophysics", add 
...
label define label_cipcode 4006 "40.06 - Geological and Related Sciences", add 
...
label define label_cipcode 4007 "40.07 - Miscellaneous Physical Sciences", add 
...
label define label_cipcode 4101 "41.01 - Biological Technologies", add 
label define label_cipcode 410101 "41.0101 - Biological Tech./Technician", add 
label define label_cipcode 4102 "41.02 - Nuclear & Industrial Radiologic Tech.", add 
...
label define label_cipcode 4103 "41.03 - Physical Science Technologies", add 
...
label define label_cipcode 4199 "41.99 - Science Technologies, Other", add 
...
label define label_cipcode 4203 "42.03 - Cognitive Psychology & Psycholinguistics", add 
...
label define label_cipcode 4399 "43.99 - Protective Services, Other", add 
...
label define label_cipcode 4402 "44.02 - Community Organization, Resources & Serv", add 
...
label define label_cipcode 4499 "44.99 - Public Administration and Services, Oth.", add 
...
label define label_cipcode 4505 "45.05 - Demography/Population Studies", add 
...
label define label_cipcode 4601 "46.01 - Mason and Tile Setters", add 
...
label define label_cipcode 4603 "46.03 - Elec. & Power Trans. Installers", add 
...
label define label_cipcode 4604 "46.04 - Construction/Building Finishers/Managers", add 
...
label define label_cipcode 4605 "46.05 - Plumbers and Pipefitters", add 
...
label define label_cipcode 4701 "47.01 - Elect./Electron. Equip. Install/Repair", add 
...
label define label_cipcode 4702 "47.02 - Heating, Air Conditioning and Refrigerat", add 
label define label_cipcode 470201 "47.0201 - Heating, Air Conditioning and Refrigerat", add 
label define label_cipcode 4703 "47.03 - Indust. Equipment Main. and Repairers", add 
...
label define label_cipcode 4704 "47.04 - Misc. Mechanics and Repairers", add 
...
label define label_cipcode 4705 "47.05 - Stationary Energy Sources Installer/Oper", add 
label define label_cipcode 470501 "47.0501 - Stationary Energy Sources Installer/Oper", add 
label define label_cipcode 4706 "47.06 - Vehicle/Mobile Equip. Mech/Repairers", add 
...
label define label_cipcode 4799 "47.99 - Mechanics and Repairers, Other", add 
...
label define label_cipcode 4801 "48.01 - Drafting", add 
...
label define label_cipcode 4802 "48.02 - Graphic & Printing Equipment Operators", add 
...
label define label_cipcode 4803 "48.03 - Leatherworkers and Upholsterers", add 
...
label define label_cipcode 4805 "48.05 - Precision Metal Workers", add 
...
label define label_cipcode 4807 "48.07 - Woodworkers", add 
...
label define label_cipcode 4899 "48.99 - Precision Production Trades, Other", add 
label define label_cipcode 489999 "48.9999 - Precision Production Trades, Other", add 
label define label_cipcode 49 "49 - Transporation and Material Moving Workers", add 
label define label_cipcode 4901 "49.01 - Air Transportation Workers", add 
...
label define label_cipcode 4902 "49.02 - Vehicle and Equipment Operators", add 
...
label define label_cipcode 4903 "49.03 - Water Transportation Workers", add 
...
label define label_cipcode 4999 "49.99 - Transportation and Materials Moving Work", add 
...
label define label_cipcode 5001 "50.01 - Visual and Performing Arts", add 
label define label_cipcode 500101 "50.0101 - Visual and Performing Arts", add 
label define label_cipcode 5002 "50.02 - Crafts, Folk Art and Artisanry", add 
...
label define label_cipcode 5005 "50.05 - Drama/Theater Arts and Stagecraft", add 
...
label define label_cipcode 5007 "50.07 - Fine Arts and Art Studies", add 
...
label define label_cipcode 5101 "51.01 - Chiropractic (D.C., D.C.M.)", add 
label define label_cipcode 510101 "51.0101 - Chiropractic (D.C., D.C.M.)", add 
label define label_cipcode 5102 "51.02 - Communication Disorders Sciences/Svcs.", add 
...
label define label_cipcode 5103 "51.03 - Community Health Services", add 
label define label_cipcode 510301 "51.0301 - Community Health Liaison", add 
label define label_cipcode 5104 "51.04 - Dentistry (D.D.S., D.M.D.)", add 
label define label_cipcode 510401 "51.0401 - Dentistry (D.D.S., D.M.D.)", add 
label define label_cipcode 5105 "51.05 - Dental Clinical Sciences/Graduate Dentis", add 
label define label_cipcode 510501 "51.0501 - Dental Clinical Sciences/Graduate Dentis", add 
label define label_cipcode 5106 "51.06 - Dental Services", add 
...
label define label_cipcode 5107 "51.07 - Health & Medical Administrative Services", add 
...
label define label_cipcode 5108 "51.08 - Health and Medical Assistants", add 
...
label define label_cipcode 5109 "51.09 - Health & Medical Diagnostic/Treatment Sv", add 
...
label define label_cipcode 5110 "51.10 - Health & Med. Lab. Techno/Technicians", add 
...
label define label_cipcode 5111 "51.11 - Health and Medical Prepatory Programs", add 
...
label define label_cipcode 5112 "51.12 - Medicine (M.D.)", add 
label define label_cipcode 511201 "51.1201 - Medicine (M.D.)", add 
label define label_cipcode 5113 "51.13 - Medical Basic Sciences", add 
...
label define label_cipcode 5114 "51.14 - Medical Clinical Sciences (M.S., Ph.D.)", add 
label define label_cipcode 511401 "51.1401 - Medical Clinical Sciences (M.S., Ph.D.)", add 
label define label_cipcode 5115 "51.15 - Mental Health Services", add 
...
label define label_cipcode 5117 "51.17 - Optometry (O.D.)", add 
label define label_cipcode 511701 "51.1701 - Optometry (O.D.)", add 
label define label_cipcode 5118 "51.18 - Ophthalmic/Optometric Services", add 
...
label define label_cipcode 5119 "51.19 - Osteopathic Medicine (D.O.)", add 
label define label_cipcode 511901 "51.1901 - Osteopathic Medicine (D.O.)", add 
label define label_cipcode 5120 "51.20 - Pharmacy", add 
...
label define label_cipcode 5121 "51.21 - Podiatry (D.P.M., D.P., Pod.D.)", add 
...
label define label_cipcode 5123 "51.23 - Rehabilitation/Therapeutic Services", add 
...
label define label_cipcode 5124 "51.24 - Veterinary Medicine (D.V.M.)", add 
label define label_cipcode 512401 "51.2401 - Veterinary Medicine (D.V.M.)", add 
label define label_cipcode 5125 "51.25 - Veterinary Clinical Sciences (M.S., Ph.D", add 
label define label_cipcode 512501 "51.2501 - Veterinary Clinical Sciences (M.S., Ph.D", add 
label define label_cipcode 5126 "51.26 - Miscellaneous Health Aides", add 
label define label_cipcode 512601 "51.2601 - Health Aide", add 
label define label_cipcode 5127 "51.27 - Misc. Health Sci. & Allied Health Svcs.", add 
...
label define label_cipcode 5199 "51.99 - Health Professions & Rel. Sciences, Oth.", add 
label define label_cipcode 519999 "51.9999 - Health Professions & Rel. Sciences, Oth.", add 
label define label_cipcode 52 "52 - Business Management and Administrative Services", add 
label define label_cipcode 5201 "52.01 - Business", add 
label define label_cipcode 520101 "52.0101 - Business, General", add 
label define label_cipcode 5202 "52.02 - Business Administration and Management", add 
...
label define label_cipcode 5203 "52.03 - Accounting", add 
...
label define label_cipcode 5204 "52.04 - Administrative & Secretarial Services", add 
...
label define label_cipcode 5205 "52.05 - Business Communications", add 
...
label define label_cipcode 5207 "52.07 - Enterprise Management and Operation", add 
...
label define label_cipcode 5208 "52.08 - Financial Management and Services", add 
...
label define label_cipcode 5209 "52.09 - Hospitality Services Management", add 
...
label define label_cipcode 5210 "52.10 - Human Resources Management", add 
...
label define label_cipcode 5212 "52.12 - Business Information & Data Process. Svc", add 
...
label define label_cipcode 5213 "52.13 - Business Quantitative Meth. & Mgmt. Sci.", add 
...
label define label_cipcode 5214 "52.14 - Marketing Management and Research", add 
...
label define label_cipcode 5299 "52.99 - Business Management & Admin. Serv., Oth.", add 
...
label define label_cipcode 99 "99 - Total of all programs", add 
...
label define label_xcrace01 14 "Data adjusted in scan edits", add 
label define label_xcrace01 15 "Data copied from another field", add 
label define label_xcrace01 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace01 17 "Details are adjusted to sum to total", add 
label define label_xcrace01 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace01 31 "Original data field was not reported", add 
label define label_xcrace01 36 "Original reported value was deleted", add 
...
label define label_xcrace02 14 "Data adjusted in scan edits", add 
label define label_xcrace02 15 "Data copied from another field", add 
label define label_xcrace02 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace02 17 "Details are adjusted to sum to total", add 
label define label_xcrace02 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace02 31 "Original data field was not reported", add 
label define label_xcrace02 36 "Original reported value was deleted", add 
...
label define label_xcrace03 14 "Data adjusted in scan edits", add 
label define label_xcrace03 15 "Data copied from another field", add 
label define label_xcrace03 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace03 17 "Details are adjusted to sum to total", add 
label define label_xcrace03 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace03 31 "Original data field was not reported", add 
label define label_xcrace03 36 "Original reported value was deleted", add 
...
label define label_xcrace04 14 "Data adjusted in scan edits", add 
label define label_xcrace04 15 "Data copied from another field", add 
label define label_xcrace04 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace04 17 "Details are adjusted to sum to total", add 
label define label_xcrace04 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace04 31 "Original data field was not reported", add 
label define label_xcrace04 36 "Original reported value was deleted", add 
...
label define label_xcrace05 14 "Data adjusted in scan edits", add 
label define label_xcrace05 15 "Data copied from another field", add 
label define label_xcrace05 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace05 17 "Details are adjusted to sum to total", add 
label define label_xcrace05 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace05 31 "Original data field was not reported", add 
label define label_xcrace05 36 "Original reported value was deleted", add 
...
label define label_xcrace06 14 "Data adjusted in scan edits", add 
label define label_xcrace06 15 "Data copied from another field", add 
label define label_xcrace06 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace06 17 "Details are adjusted to sum to total", add 
label define label_xcrace06 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace06 31 "Original data field was not reported", add 
label define label_xcrace06 36 "Original reported value was deleted", add 
...
label define label_xcrace07 14 "Data adjusted in scan edits", add 
label define label_xcrace07 15 "Data copied from another field", add 
label define label_xcrace07 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace07 17 "Details are adjusted to sum to total", add 
label define label_xcrace07 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace07 31 "Original data field was not reported", add 
label define label_xcrace07 36 "Original reported value was deleted", add 
...
label define label_xcrace08 14 "Data adjusted in scan edits", add 
label define label_xcrace08 15 "Data copied from another field", add 
label define label_xcrace08 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace08 17 "Details are adjusted to sum to total", add 
label define label_xcrace08 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace08 31 "Original data field was not reported", add 
label define label_xcrace08 36 "Original reported value was deleted", add 
...
label define label_xcrace09 14 "Data adjusted in scan edits", add 
label define label_xcrace09 15 "Data copied from another field", add 
label define label_xcrace09 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace09 17 "Details are adjusted to sum to total", add 
label define label_xcrace09 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace09 31 "Original data field was not reported", add 
label define label_xcrace09 36 "Original reported value was deleted", add 
...
label define label_xcrace10 14 "Data adjusted in scan edits", add 
label define label_xcrace10 15 "Data copied from another field", add 
label define label_xcrace10 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace10 17 "Details are adjusted to sum to total", add 
label define label_xcrace10 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace10 31 "Original data field was not reported", add 
label define label_xcrace10 36 "Original reported value was deleted", add 
...
label define label_xcrace11 14 "Data adjusted in scan edits", add 
label define label_xcrace11 15 "Data copied from another field", add 
label define label_xcrace11 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace11 17 "Details are adjusted to sum to total", add 
label define label_xcrace11 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace11 31 "Original data field was not reported", add 
label define label_xcrace11 36 "Original reported value was deleted", add 
...
label define label_xcrace12 14 "Data adjusted in scan edits", add 
label define label_xcrace12 15 "Data copied from another field", add 
label define label_xcrace12 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace12 17 "Details are adjusted to sum to total", add 
label define label_xcrace12 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace12 31 "Original data field was not reported", add 
label define label_xcrace12 36 "Original reported value was deleted", add 
...
label define label_xcrace13 14 "Data adjusted in scan edits", add 
label define label_xcrace13 15 "Data copied from another field", add 
label define label_xcrace13 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace13 17 "Details are adjusted to sum to total", add 
label define label_xcrace13 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace13 31 "Original data field was not reported", add 
label define label_xcrace13 36 "Original reported value was deleted", add 
...
label define label_xcrace14 14 "Data adjusted in scan edits", add 
label define label_xcrace14 15 "Data copied from another field", add 
label define label_xcrace14 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace14 17 "Details are adjusted to sum to total", add 
label define label_xcrace14 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace14 31 "Original data field was not reported", add 
label define label_xcrace14 36 "Original reported value was deleted", add 
...
label define label_xcrace15 14 "Data adjusted in scan edits", add 
label define label_xcrace15 15 "Data copied from another field", add 
label define label_xcrace15 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace15 17 "Details are adjusted to sum to total", add 
label define label_xcrace15 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace15 31 "Original data field was not reported", add 
label define label_xcrace15 36 "Original reported value was deleted", add 
...
label define label_xcrace16 14 "Data adjusted in scan edits", add 
label define label_xcrace16 15 "Data copied from another field", add 
label define label_xcrace16 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace16 17 "Details are adjusted to sum to total", add 
label define label_xcrace16 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace16 31 "Original data field was not reported", add 
label define label_xcrace16 36 "Original reported value was deleted", add 
...
label define label_xcrace17 14 "Data adjusted in scan edits", add 
label define label_xcrace17 15 "Data copied from another field", add 
label define label_xcrace17 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace17 17 "Details are adjusted to sum to total", add 
label define label_xcrace17 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace17 31 "Original data field was not reported", add 
label define label_xcrace17 36 "Original reported value was deleted", add 
label define label_xcrace17 40 "Suppressed to protect confidentiality", add 
...
label define label_xcrace18 14 "Data adjusted in scan edits", add 
label define label_xcrace18 15 "Data copied from another field", add 
label define label_xcrace18 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace18 17 "Details are adjusted to sum to total", add 
label define label_xcrace18 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace18 31 "Original data field was not reported", add 
label define label_xcrace18 36 "Original reported value was deleted", add 
label define label_xcrace18 40 "Suppressed to protect confidentiality", add 
...
label define label_xcrace19 14 "Data adjusted in scan edits", add 
label define label_xcrace19 15 "Data copied from another field", add 
label define label_xcrace19 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace19 17 "Details are adjusted to sum to total", add 
label define label_xcrace19 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace19 31 "Original data field was not reported", add 
label define label_xcrace19 36 "Original reported value was deleted", add 
label define label_xcrace19 40 "Suppressed to protect confidentiality", add 
...
label define label_xcrace20 14 "Data adjusted in scan edits", add 
label define label_xcrace20 15 "Data copied from another field", add 
label define label_xcrace20 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace20 17 "Details are adjusted to sum to total", add 
label define label_xcrace20 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace20 31 "Original data field was not reported", add 
label define label_xcrace20 36 "Original reported value was deleted", add 
label define label_xcrace20 40 "Suppressed to protect confidentiality", add 
...
label define label_xcrace21 14 "Data adjusted in scan edits", add 
label define label_xcrace21 15 "Data copied from another field", add 
label define label_xcrace21 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace21 17 "Details are adjusted to sum to total", add 
label define label_xcrace21 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace21 31 "Original data field was not reported", add 
label define label_xcrace21 36 "Original reported value was deleted", add 
label define label_xcrace21 40 "Suppressed to protect confidentiality", add 
...
label define label_xcrace22 14 "Data adjusted in scan edits", add 
label define label_xcrace22 15 "Data copied from another field", add 
label define label_xcrace22 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace22 17 "Details are adjusted to sum to total", add 
label define label_xcrace22 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace22 31 "Original data field was not reported", add 
label define label_xcrace22 36 "Original reported value was deleted", add 
label define label_xcrace22 40 "Suppressed to protect confidentiality", add 
...
label define label_xcrace23 14 "Data adjusted in scan edits", add 
label define label_xcrace23 15 "Data copied from another field", add 
label define label_xcrace23 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace23 17 "Details are adjusted to sum to total", add 
label define label_xcrace23 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace23 31 "Original data field was not reported", add 
label define label_xcrace23 36 "Original reported value was deleted", add 
label define label_xcrace23 40 "Suppressed to protect confidentiality", add 
...
label define label_xcrace24 14 "Data adjusted in scan edits", add 
label define label_xcrace24 15 "Data copied from another field", add 
label define label_xcrace24 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xcrace24 17 "Details are adjusted to sum to total", add 
label define label_xcrace24 18 "Total generated to equal the sum of detail", add 
...
label define label_xcrace24 31 "Original data field was not reported", add 
label define label_xcrace24 36 "Original reported value was deleted", add 
label define label_xcrace24 40 "Suppressed to protect confidentiality", add 
