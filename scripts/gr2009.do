...
*
insheet using "c:\dct\gr2009_rv_data_stata.csv", comma clear
label data "dct_gr2009_rv"
...
label define label_cohort 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2003 subcohorts (4-yr institution)"
label define label_cohort 2 "Bachelor^s or equiv 2003 subcohort (4-yr institution)",add
label define label_cohort 3 "Other degree/certif-seeking 2003 subcohort (4-yr institution)",add
label define label_cohort 4 "Degree/certif-seeking students 2006 cohort ( 2-yr institution)",add
label values cohort label_cohort
label define label_section 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2003 subcohort (4-yr institution)"
label define label_section 2 "Bachelor^s or equiv 2003 subcohort (4-yr institution)",add
label define label_section 3 "Other degree/certif-seeking 2003 subcohort (4-yr institution)",add
label define label_section 4 "Degree/certif-seeking students 2006 cohort ( 2-yr and <2-yr institution)",add
