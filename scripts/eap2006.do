...
*                                                        
insheet using "c:\dct\eap2006_data_stata.csv", comma clear
label data "dct_eap2006"
...
label define label_eaprectp 1223 "All employees, Public service/instruction/research, With faculty status, Non-tenured faculty, on tenure track", add 
label define label_eaprectp 1224 "All employees, Public service/instruction/research, With faculty status, Not on tenure track/no tenure system", add 
...
label define label_eaprectp 2223 "Full time, Public service/Instruction/Research, With faculty status, Non-tenured faculty, on tenure track", add 
label define label_eaprectp 2224 "Full time, Public service/Instruction/Research, With faculty status, Not on tenure track/no tenure system", add 
...
label define label_eaprectp 3223 "Part time, Public service/Instruction/Research, Employees, With faculty status, Non-tenured faculty, on tenure track", add 
label define label_eaprectp 3224 "Part time, Public service/Instruction/Research, Employees, With faculty status, Not on tenure track/no tenure system", add 
...
label define label_xeaptyp 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xeaptyp 51 "Outlier value derived from imported data", add 
label define label_xeaptyp 52 "Value not derived - parent/child differs across components", add 
label define label_xeaptyp 53 "Value not derived - data not usable", add 
...
label define label_xeapmed 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xeapmed 51 "Outlier value derived from imported data", add 
label define label_xeapmed 52 "Value not derived - parent/child differs across components", add 
label define label_xeapmed 53 "Value not derived - data not usable", add 
...
label define label_xeaptot 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xeaptot 51 "Outlier value derived from imported data", add 
label define label_xeaptot 52 "Value not derived - parent/child differs across components", add 
label define label_xeaptot 53 "Value not derived - data not usable", add 
