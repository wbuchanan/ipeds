...
*                                                        
insheet using "c:\dct\s97_cn_data_stata.csv", comma clear
label data "dct_s97_cn"
label variable unitid "unitid"
label variable part "Part of form CN"
...
label define label_line 22 "FT Faculty, total" 
