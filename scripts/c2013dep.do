...
*
insheet using "k:\ipedsdata\dct\c2013dep_data_stata.csv", comma clear
label data "dct_c2013dep"
label variable unitid   "Unique identification number of the institution"
label variable cipcode  "CIPCODE"
label variable ptotal   "Number of programs offered"
label variable ptotalde "Number of programs offered via distance education"
label variable passoc   "Number of Associate's degree programs offered"
label variable passocde "Number of Associate's degree programs offered via distance education"
label variable pbachl   "Number of Bachelor's degree programs offered"
label variable pbachlde "Number of Bachelor's degree programs offered via distance education"
label variable pmastr   "Number of Master's degree programs offered"
label variable pmastrde "Number of Master's degree programs offered via distance education"
label variable pdocrs   "Number of Doctor's degree-research/scholarship programs offered"
label variable pdocrsde "Number of Doctor's degree-research/scholarship programs offered via distance education"
label variable pdocpp   "Number of Doctor's degree-professional practice programs offered"
label variable pdocppde "Number of Doctor's degree-professional practice programs offered via distance education"
label variable pdocot   "Number of Doctor's degree-other programs offered"
label variable pdocotde "Number of Doctor's degree-other programs offered via distance education"
label variable pcert1   "Number of less than 1-year certificate programs offered"
label variable pcert1de "Number of less than 1-year certificate programs offered via distance education"
label variable pcert2   "Number of 1-year, but less than-2-year certificate programs offered"
label variable pcert2de "Number of 1-year, but less than 2-year certificate programs offered via distance education"
label variable pcert4   "Number of 2-year, but less than 4-year certificate programs offered"
label variable pcert4de "Number of 2-year, but less than 4-year certificate programs offered via distance education"
label variable ppbacc   "Number of Postbaccalaureate certificate programs offered"
label variable ppbaccde "Number of Postbaccalaureate certificate programs offered via distance education"
label variable ppmast   "Number of Post-master's certificate programs offered"
label variable ppmastde "Number of Post-master's certificate programs offered via distance education"
label define label_cipcode 99 "99     -Grand total"
label define label_cipcode  1 "01     -Agriculture, Agriculture Operations and Related Sciences",add
...
label define label_cipcode  5 "05     -Area, Ethnic, Cultural, Gender, and Group Studies",add
...
label define label_cipcode 15 "15     -Engineering Technologies and Engineering-related Fields",add
...
label define label_cipcode 29 "29     -Military Technologies and Applied Sciences",add
...
label define label_cipcode 43 "43     -Homeland Security, Law Enforcement, Firefighting, and Related Protective Servic",add
...
label define label_cipcode 51 "51     -Health Professions and Related Programs",add
...
label define label_cipcode 54 "54     -History",add
