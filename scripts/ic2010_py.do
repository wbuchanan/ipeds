...
*                                                        
insheet using "c:\dct\ic2010_py_rv_data_stata.csv", comma clear
label data "dct_ic2010_py_rv"
label variable unitid "unitid"
label variable prgmofr "Number of programs offered"
label variable cipcode1 "CIP code of largest program"
label variable xciptui1 "Imputation field for CIPTUIT1 - Tuition and fees 2010-11 (institutions with no full-time, first-time, undergraduate students)"
label variable ciptuit1 "Tuition and fees 2010-11 (institutions with no full-time, first-time, undergraduate students)"
label variable xcipsup1 "Imputation field for CIPSUPP1 - Books and supplies 2010-11 (institutions with no full-time, first-time, undergraduate students)"
label variable cipsupp1 "Books and supplies 2010-11 (institutions with no full-time, first-time, undergraduate students)"
...
label variable xchg1py0 "Imputation field for chg1py0 - Published tuition and fees 2007-08"
label variable chg1py0 "Published tuition and fees 2007-08"
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2008-09"
label variable chg1py1 "Published tuition and fees 2008-09"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2009-10"
label variable chg1py2 "Published tuition and fees 2009-10"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2010-11"
label variable chg1py3 "Published tuition and fees 2010-11"
label variable xchg4py0 "Imputation field for chg4py0 - Books and supplies 2007-08"
label variable chg4py0 "Books and supplies 2007-08"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2008-09"
label variable chg4py1 "Books and supplies 2008-09"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2009-10"
label variable chg4py2 "Books and supplies 2009-10"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2010-11"
label variable chg4py3 "Books and supplies 2010-11"
label variable xchg5py0 "Imputation field for chg5py0 - On campus, room and board 2007-08"
label variable chg5py0 "On campus, room and board 2007-08"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2008-09"
label variable chg5py1 "On campus, room and board 2008-09"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2009-10"
label variable chg5py2 "On campus, room and board 2009-10"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2010-11"
label variable chg5py3 "On campus, room and board 2010-11"
label variable xchg6py0 "Imputation field for chg6py0 - On campus, other expenses 2007-08"
label variable chg6py0 "On campus, other expenses 2007-08"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2008-09"
label variable chg6py1 "On campus, other expenses 2008-09"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2009-10"
label variable chg6py2 "On campus, other expenses 2009-10"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2010-11"
label variable chg6py3 "On campus, other expenses 2010-11"
label variable xchg7py0 "Imputation field for chg7py0 - Off campus (not with family), room and board 2007-08"
label variable chg7py0 "Off campus (not with family), room and board 2007-08"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2008-09"
label variable chg7py1 "Off campus (not with family), room and board 2008-09"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2009-10"
label variable chg7py2 "Off campus (not with family), room and board 2009-10"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board 2010-11"
label variable chg7py3 "Off campus (not with family), room and board 2010-11"
label variable xchg8py0 "Imputation field for chg8py0 - Off campus (not with family), other expenses 2007-08"
label variable chg8py0 "Off campus (not with family), other expenses 2007-08"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2008-09"
label variable chg8py1 "Off campus (not with family), other expenses 2008-09"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2009-10"
label variable chg8py2 "Off campus (not with family), other expenses 2009-10"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2010-11"
label variable chg8py3 "Off campus (not with family), other expenses 2010-11"
label variable xchg9py0 "Imputation field for chg9py0 - Off campus (with family), other expenses 2007-08"
label variable chg9py0 "Off campus (with family), other expenses 2007-08"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2008-09"
label variable chg9py1 "Off campus (with family), other expenses 2008-09"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2009-10"
label variable chg9py2 "Off campus (with family), other expenses 2009-10"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2010-11"
label variable chg9py3 "Off campus (with family), other expenses 2010-11"
label variable xcmp1py0 "Imputation field for CMP1PY0 - Comprehensive fee 2007-08"
label variable cmp1py0 "Comprehensive fee 2007-08"
label variable xcmp1py1 "Imputation field for CMP1PY1 - Comprehensive fee 2008-09"
label variable cmp1py1 "Comprehensive fee 2008-09"
label variable xcmp1py2 "Imputation field for CMP1PY2 - Comprehensive fee 2009-10"
label variable cmp1py2 "Comprehensive fee 2009-10"
label variable xcmp1py3 "Imputation field for CMP1PY3 - Comprehensive fee 2010-11"
label variable cmp1py3 "Comprehensive fee 2010-11"
...
label define label_cipcode1 150303 "15.0303 - Electrical, Electronic and Communications Engineering Technology/Technician", add
label define label_cipcode1 150403 "15.0403 - Electromechanical Technology/Electromechanical Engineering Technology", add
label define label_cipcode1 150501 "15.0501 - Heating, Ventilation, Air Conditioning and Refrigeration Engineering Technology/Technician", add
...
label define label_cipcode1 439999 "43.9999 - Homeland Security, Law Enforcement, Firefighting and Related Protective Services, Other", add
...
label define label_cipcode1 470201 "47.0201 - Heating, Air Conditioning, Ventilation and Refrigeration Maintenance Technology/Technician", add
...
label define label_cipcode1 513899 "51.3899 - Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing, Other", add
...
label define label_cipcode1 -2     "-2      - Not applicable", add
...
label define label_cipcode2 111099 "11.1099 - Computer/Information Technology Services Administration and Management, Other", add
...
label define label_cipcode2 144201 "14.4201 - Mechatronics, Robotics, and Automation Engineering", add
...
label define label_cipcode2 150501 "15.0501 - Heating, Ventilation, Air Conditioning and Refrigeration Engineering Technology/Technician", add
...
label define label_cipcode2 439999 "43.9999 - Homeland Security, Law Enforcement, Firefighting and Related Protective Services, Other", add
...
label define label_cipcode2 470201 "47.0201 - Heating, Air Conditioning, Ventilation and Refrigeration Maintenance Technology/Technician", add
...
label define label_cipcode2 512501 "51.2501 - Veterinary Sciences/Veterinary Clinical Sciences, General", add
...
label define label_cipcode2 513899 "51.3899 - Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing, Other", add
...
label define label_cipcode2 -1     "-1      - Not reported", add
...
label define label_cipcode3 144201 "14.4201 - Mechatronics, Robotics, and Automation Engineering", add
...
label define label_cipcode3 150501 "15.0501 - Heating, Ventilation, Air Conditioning and Refrigeration Engineering Technology/Technician", add
...
label define label_cipcode3 439999 "43.9999 - Homeland Security, Law Enforcement, Firefighting and Related Protective Services, Other", add
...
label define label_cipcode3 470201 "47.0201 - Heating, Air Conditioning, Ventilation and Refrigeration Maintenance Technology/Technician", add
...
label define label_cipcode3 500913 "50.0913 - Music Technology", add
...
label define label_cipcode3 510719 "51.0719 - Clinical Research Coordinator", add
...
label define label_cipcode3 512510 "51.2510 - Veterinary Preventive Medicine, Epidemiology, and Public Health", add
...
label define label_cipcode3 513818 "51.3818 - Nursing Practice", add
label define label_cipcode3 513899 "51.3899 - Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing, Other", add
...
label define label_cipcode3 520909 "52.0909 - Hotel, Motel, and Restaurant Management", add
label define label_cipcode3 521899 "52.1899 - General Merchandising, Sales, and Related Marketing Operations, Other", add
label define label_cipcode3 529999 "52.9999 - Business, Management, Marketing, and Related Support Services, Other", add
label define label_cipcode3 -1     "-1      - Not reported", add
...
label define label_cipcode4  40901 "04.0901 - Architectural Technology/Technician",
...
label define label_cipcode4 130501 "13.0501 - Educational/Instructional Technology", add
...
label define label_cipcode4 150501 "15.0501 - Heating, Ventilation, Air Conditioning and Refrigeration Engineering Technology/Technician", add
label define label_cipcode4 150506 "15.0506 - Water Quality and Wastewater Treatment Management and Recycling Technology/Technician", add
...
label define label_cipcode4 470201 "47.0201 - Heating, Air Conditioning, Ventilation and Refrigeration Maintenance Technology/Technician", add
...
label define label_cipcode4 510814 "51.0814 - Radiologist Assistant", add
...
label define label_cipcode4 512503 "51.2503 - Veterinary Physiology", add
...
label define label_cipcode4 513803 "51.3803 - Adult Health Nurse/Nursing", add
label define label_cipcode4 513899 "51.3899 - Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing, Other", add
...
label define label_cipcode4 -1     "-1      - Not reported", add
...
label define label_cipcode5 111003 "11.1003 - Computer and Information Systems Security/Information Assurance", add
...
label define label_cipcode5 130501 "13.0501 - Educational/Instructional Technology", add
...
label define label_cipcode5 141099 "14.1099 - Electrical, Electronics and Communications Engineering, Other", add
label define label_cipcode5 150399 "15.0399 - Electrical and Electronic Engineering Technologies/Technicians, Other", add
...
label define label_cipcode5 150501 "15.0501 - Heating, Ventilation, Air Conditioning and Refrigeration Engineering Technology/Technician", add
...
label define label_cipcode5 430301 "43.0301 - Homeland Security", add
...
label define label_cipcode5 470201 "47.0201 - Heating, Air Conditioning, Ventilation and Refrigeration Maintenance Technology/Technician", add
...
label define label_cipcode5 513803 "51.3803 - Adult Health Nurse/Nursing", add
label define label_cipcode5 513805 "51.3805 - Family Practice Nurse/Nursing", add
label define label_cipcode5 513899 "51.3899 - Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing, Other", add
...
label define label_cipcode5 520211 "52.0211 - Project Management", add
...
label define label_cipcode5 -1     "-1      - Not reported", add
...
label define label_cipcode6 109999 "10.9999 - Communications Technologies/Technicians and Support Services, Other", add
...
label define label_cipcode6 130501 "13.0501 - Educational/Instructional Technology", add
...
label define label_cipcode6 150501 "15.0501 - Heating, Ventilation, Air Conditioning and Refrigeration Engineering Technology/Technician", add
...
label define label_cipcode6 430120 "43.0120 - Protective Services Operations", add
...
label define label_cipcode6 470201 "47.0201 - Heating, Air Conditioning, Ventilation and Refrigeration Maintenance Technology/Technician", add
...
label define label_cipcode6 512502 "51.2502 - Veterinary Anatomy", add
...
label define label_cipcode6 513899 "51.3899 - Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing, Other", add
...
label define label_cipcode6 520212 "52.0212 - Retail Management", add
...
label define label_cipcode6 -1     "-1      - Not reported", add
