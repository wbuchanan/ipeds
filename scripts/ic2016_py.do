...
*
insheet using "c:\dct\ic2016_py_data_stata.csv", comma clear
label data "dct_ic2016_py"
label variable unitid   "Unique identification number of the institution"
label variable prgmofr  "Number of programs offered"
label variable cipcode1 "CIP code of largest program"
label variable xciptui1 "Imputation field for ciptuit1 - Tuition and fees 2016-17 (institutions with no full-time, first-time, undergraduate students)"
label variable ciptuit1 "Tuition and fees 2016-17 (institutions with no full-time, first-time, undergraduate students)"
label variable xcipsup1 "Imputation field for cipsupp1 - Books and supplies 2016-17 (institutions with no full-time, first-time, undergraduate students)"
label variable cipsupp1 "Books and supplies 2016-17 (institutions with no full-time, first-time, undergraduate students)"
...
label variable xchg1py0 "Imputation field for chg1py0 - Published tuition and fees 2013-14"
label variable chg1py0  "Published tuition and fees 2013-14"
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2014-15"
label variable chg1py1  "Published tuition and fees 2014-15"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2015-16"
label variable chg1py2  "Published tuition and fees 2015-16"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2016-17"
label variable chg1py3  "Published tuition and fees 2016-17"
label variable xchg4py0 "Imputation field for chg4py0 - Books and supplies 2013-14"
label variable chg4py0  "Books and supplies 2013-14"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2014-15"
label variable chg4py1  "Books and supplies 2014-15"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2015-16"
label variable chg4py2  "Books and supplies 2015-16"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2016-17"
label variable chg4py3  "Books and supplies 2016-17"
label variable xchg5py0 "Imputation field for chg5py0 - On campus, room and board 2013-14"
label variable chg5py0  "On campus, room and board 2013-14"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2014-15"
label variable chg5py1  "On campus, room and board 2014-15"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2015-16"
label variable chg5py2  "On campus, room and board 2015-16"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2016-17"
label variable chg5py3  "On campus, room and board 2016-17"
label variable xchg6py0 "Imputation field for chg6py0 - On campus, other expenses 2013-14"
label variable chg6py0  "On campus, other expenses 2013-14"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2014-15"
label variable chg6py1  "On campus, other expenses 2014-15"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2015-16"
label variable chg6py2  "On campus, other expenses 2015-16"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2016-17"
label variable chg6py3  "On campus, other expenses 2016-17"
label variable xchg7py0 "Imputation field for chg7py0 - Off campus (not with family), room and board 2013-14"
label variable chg7py0  "Off campus (not with family), room and board 2013-14"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2014-15"
label variable chg7py1  "Off campus (not with family), room and board 2014-15"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2015-16"
label variable chg7py2  "Off campus (not with family), room and board 2015-16"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board  2016-17"
label variable chg7py3  "Off campus (not with family), room and board  2016-17"
label variable xchg8py0 "Imputation field for chg8py0 - Off campus (not with family), other expenses 2013-14"
label variable chg8py0  "Off campus (not with family), other expenses 2013-14"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2014-15"
label variable chg8py1  "Off campus (not with family), other expenses 2014-15"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2015-16"
label variable chg8py2  "Off campus (not with family), other expenses 2015-16"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2016-17"
label variable chg8py3  "Off campus (not with family), other expenses 2016-17"
label variable xchg9py0 "Imputation field for chg9py0 - Off campus (with family), other expenses 2013-14"
label variable chg9py0  "Off campus (with family), other expenses 2013-14"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2014-15"
label variable chg9py1  "Off campus (with family), other expenses 2014-15"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2015-16"
label variable chg9py2  "Off campus (with family), other expenses 2015-16"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2016-17"
label variable chg9py3  "Off campus (with family), other expenses 2016-17"
...
label define label_cipcode1  10102 "01.0102-Agribusiness/Agricultural Business Operations"
...
label define label_cipcode1 111006 "11.1006-Computer Support Specialist",add
...
label define label_cipcode1 140102 "14.0102-Pre-Engineering",add
label define label_cipcode1 141001 "14.1001-Electrical and Electronics Engineering",add
...
label define label_cipcode1 310507 "31.0507-Physical Fitness Technician",add
...
label define label_cipcode1 480511 "48.0511-Metal Fabricator",add
...
label define label_cipcode1 500913 "50.0913-Music Technology",add
...
label define label_cipcode1 510806 "51.0806-Physical Therapy Technician/Assistant",add
...
label define label_cipcode1 510920 "51.0920-Magnetic Resonance Imaging (MRI) Technology/Technician",add
label define label_cipcode1 510999 "51.0999-Allied Health Diagnostic, Intervention, and Treatment Professions, Other.",add
...
label define label_cipcode1 511009 "51.1009-Phlebotomy Technician/Phlebotomist.",add
...
label define label_cipcode1 513306 "51.3306-Holistic Health",add
...
label define label_cipcode1 513808 "51.3808-Nursing Science",add
...
label define label_cipcode2  10307 "01.0307-Horse Husbandry/Equine Science and Management"
...
label define label_cipcode2  90900 "09.0900-Public Relations, Advertising, and Applied Communication",add
label define label_cipcode2  90906 "09.0906-Sports Communication",add
label define label_cipcode2  90907 "09.0907-International and Intercultural Communication",add
...
label define label_cipcode2 111003 "11.1003-Computer and Information Systems Security/Information Assurance.",add
...
label define label_cipcode2 131401 "13.1401-Teaching English as a Second or Foreign Language/ESL Language Instructor.",add
label define label_cipcode2 140102 "14.0102-Pre-Engineering",add
...
label define label_cipcode2 150499 "15.0499-Electromechanical and Instrumentation and Maintenance Technologies/Technicians, Oth",add
...
label define label_cipcode2 430201 "43.0201-Fire Prevention and Safety Technology/Technician.",add
...
label define label_cipcode2 490208 "49.0208-Railroad and Railway Transportation",add
...
label define label_cipcode2 501003 "50.1003-Music Management",add
...
label define label_cipcode2 511012 "51.1012-Sterile Processing Technology/Technician",add
...
label define label_cipcode2 513805 "51.3805-Family Practice Nurse/Nursing",add
label define label_cipcode2 513817 "51.3817-Nursing Education",add
...
label define label_cipcode3  40601 "04.0601-Landscape Architecture"
...
label define label_cipcode3  90900 "09.0900-Public Relations, Advertising, and Applied Communication",add
label define label_cipcode3  90906 "09.0906-Sports Communication",add
label define label_cipcode3  90907 "09.0907-International and Intercultural Communication",add
...
label define label_cipcode3 120510 "12.0510-Wine Steward/Sommelier",add
...
label define label_cipcode3 150403 "15.0403-Electromechanical Technology/Electromechanical Engineering Technology.",add
...
label define label_cipcode3 151305 "15.1305-Electrical/Electronics Drafting and Electrical/Electronics CAD/CADD",add
...
label define label_cipcode3 439999 "43.9999-Homeland Security, Law Enforcement, Firefighting and Related Protective Services, O",add
...
label define label_cipcode3 480510 "48.0510-Computer Numerically Controlled (CNC) Machinist Technology/CNC Machinist",add
...
label define label_cipcode3 500102 "50.0102-Digital Arts",add
label define label_cipcode3 500409 "50.0409-Graphic Design.",add
label define label_cipcode3 500510 "50.0510-Costume Design",add
...
label define label_cipcode3 510001 "51.0001-Health and Wellness, General",add
...
label define label_cipcode3 511012 "51.1012-Sterile Processing Technology/Technician",add
...
label define label_cipcode3 512604 "51.2604-Rehabilitation Aide",add
...
label define label_cipcode3 513817 "51.3817-Nursing Education",add
...
label define label_cipcode3 520211 "52.0211-Project Management",add
...
label define label_cipcode4  90900 "09.0900-Public Relations, Advertising, and Applied Communication",add
...
label define label_cipcode4 111003 "11.1003-Computer and Information Systems Security/Information Assurance.",add
label define label_cipcode4 111006 "11.1006-Computer Support Specialist",add
label define label_cipcode4 111099 "11.1099-Computer/Information Technology Services Administration and Management, Other.",add
...
label define label_cipcode4 131401 "13.1401-Teaching English as a Second or Foreign Language/ESL Language Instructor.",add
label define label_cipcode4 141001 "14.1001-Electrical and Electronics Engineering",add
...
label define label_cipcode4 150499 "15.0499-Electromechanical and Instrumentation and Maintenance Technologies/Technicians,",add
...
label define label_cipcode4 430116 "43.0116-Cyber/Computer Forensics and Counterterrorism",add
label define label_cipcode4 430203 "43.0203-Fire Science/Fire-fighting.",add
label define label_cipcode4 439999 "43.9999-Homeland Security, Law Enforcement, Firefighting and Related Protective Services, O",add
...
label define label_cipcode4 470600 "47.0600-Vehicle Maintenance and Repair Technologies, General",add
...
label define label_cipcode4 480511 "48.0511-Metal Fabricator",add
...
label define label_cipcode4 501001 "50.1001-Arts, Entertainment,and Media Management, General",add
...
label define label_cipcode4 511012 "51.1012-Sterile Processing Technology/Technician",add
...
label define label_cipcode4 512501 "51.2501-Veterinary Sciences/Veterinary Clinical Sciences, General",add
label define label_cipcode4 512602 "51.2602-Home Health Aide/Home Attendant.",add
label define label_cipcode4 512604 "51.2604-Rehabilitation Aide",add
label define label_cipcode4 513301 "51.3301-Acupuncture and Oriental Medicine",add
...
label define label_cipcode4 513812 "51.3812-Perioperative/Operating Room and Surgical Nurse/Nursing",add
label define label_cipcode4 513818 "51.3818-Nursing Practice",add
...
label define label_cipcode4 520909 "52.0909-Hotel, Motel, and Restaurant Management",add
...
label define label_cipcode5  90702 "09.0702-Digital Communication and Media/Multimedia."
label define label_cipcode5  90799 "09.0799-Radio, Television, and Digital Communication, Other",add
label define label_cipcode5  90906 "09.0906-Sports Communication",add
...
label define label_cipcode5 150406 "15.0406-Automation Engineer Technology/Technician",add
...
label define label_cipcode5 150613 "15.0613-Manufacturing Engineering Technology/Technician.",add
label define label_cipcode5 150614 "15.0614-Welding Engineering Technology/Technician",add
...
label define label_cipcode5 470617 "47.0617-High Performance and Custom Engine Technician/Mechanic",add
...
label define label_cipcode5 480511 "48.0511-Metal Fabricator",add
...
label define label_cipcode5 510814 "51.0814-Radiologist Assistant",add
...
label define label_cipcode5 510917 "51.0917-Polysomnography",add
...
label define label_cipcode5 513899 "51.3899-Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing,",add
...
label define label_cipcode5 520203 "52.0203-Logistics, Materials, and Supply Chain Management",add
...
label define label_cipcode5 520909 "52.0909-Hotel, Motel, and Restaurant Management",add
...
label define label_cipcode6 100202 "10.0202-Radio and Television Broadcasting Technology/Technician"
...
label define label_cipcode6 111003 "11.1003-Computer and Information Systems Security/Information Assurance.",add
...
label define label_cipcode6 131299 "13.1299-Teacher Education and Professional Development, Specific Levels and Methods, Other",add
...
label define label_cipcode6 141001 "14.1001-Electrical and Electronics Engineering",add
...
label define label_cipcode6 150499 "15.0499-Electromechanical and Instrumentation and Maintenance Technologies/Technicians,",add
...
label define label_cipcode6 310501 "31.0501-Health and Physical Education/Fitness, General",add
...
label define label_cipcode6 480510 "48.0510-Computer Numerically Controlled (CNC",add
label define label_cipcode6 490205 "49.0205-Truck and Bus Driver/Commercial Vehicle Operator and Instructor.",add
label define label_cipcode6 500102 "50.0102-Digital Arts",add
...
label define label_cipcode6 510001 "51.0001-Health and Wellness, General",add
...
label define label_cipcode6 510920 "51.0920-Magnetic Resonance Imaging (MRI",add
...
label define label_cipcode6 512604 "51.2604-Rehabilitation Aide",add
...
label define label_cipcode6 513817 "51.3817-Nursing Education",add
label define label_cipcode6 513818 "51.3818-Nursing Practice",add
