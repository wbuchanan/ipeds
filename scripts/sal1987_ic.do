...
*                                                        
insheet using "c:\dct\sal1987_ic_data_stata.csv", comma clear
label data "dct_sal1987_ic"
...
label define label_rstatus 6 "Nonrespondent, imputed based on prior years response", add 
