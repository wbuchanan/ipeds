...
*                                                        
insheet using "c:\dct\c1992_cip_data_stata.csv", comma clear
label data "dct_c1992_cip"
...
label define label_cipcode 10302 "01.0302 - Ag. Animal Husbandry and Prod. Management", add 
...
label define label_cipcode 10401 "01.0401 - Ag. and Food Products Process. Oper. and Management", add 
...
label define label_cipcode 10507 "01.0507 - Eques./Equine Stds., Horse Management and Training", add 
label define label_cipcode 10599 "01.0599 - Ag. Supplies and Related Services, Other", add 
label define label_cipcode 10601 "01.0601 - Horticulture Srvcs. Oper. and Management, General", add 
label define label_cipcode 10603 "01.0603 - Ornamental Horticulture Oper. and Management", add 
...
label define label_cipcode 10699 "01.0699 - Horticulture Srvcs. Oper. and Management, Other", add 
...
label define label_cipcode 30203 "03.0203 - Nat. Resrcs. Law Enforce. and Protect. Srvc.", add 
label define label_cipcode 30299 "03.0299 - Nat. Resrcs. Management and Protectv. Srvcs., Other", add 
...
label define label_cipcode 80299 "08.0299 - Business and Personal Srvc. Market. Opns, Other", add 
...
label define label_cipcode 80799 "08.0799 - General Retail and Wholesale Opns. and Skills, Other", add 
label define label_cipcode 80809 "08.0809 - Home Products Marketing Operations", add 
label define label_cipcode 80899 "08.0899 - Home and Office Products Marketing Opns., Other", add 
label define label_cipcode 80901 "08.0901 - Hospitality and Recrtn. Marketing Opns, General", add 
...
label define label_cipcode 80999 "08.0999 - Hospitality and Recrtn. Marketing Opns, Other", add 
...
label define label_cipcode 81203 "08.1203 - Vehicle Parts and Accessories Marketing Opns.", add 
label define label_cipcode 81208 "08.1208 - Vehicle Marketing Operations", add 
label define label_cipcode 81299 "08.1299 - Vehicle and Petrol. Prods. Marketing Opns. Other", add 
...
label define label_cipcode 120504 "12.0504 - Food and Beverage/Restaurant Opns. Manager", add 
label define label_cipcode 120505 "12.0505 - Kitchen Personnel/Cook and Asst. Trng.", add 
...
label define label_cipcode 131204 "13.1204 - Pre-Elementary Educ./Early Childhd/KG. Teacher Educ.", add 
...
label define label_cipcode 131327 "13.1327 - Health Occupations Teacher Educ. (Vocational)", add 
...
label define label_cipcode 151101 "15.1101 - Engineering-Related Tech./Technician, General", add 
...
label define label_cipcode 160103 "16.0103 - Foreign Language Interpretation\Translatn.", add 
...
label define label_cipcode 161202 "16.1202 - Greek Lang. and Lit. (Ancient/Medieval)", add 
label define label_cipcode 161203 "16.1203 - Latin Lang. and Lit. (Ancient/Medieval)", add 
label define label_cipcode 161299 "16.1299 - Classical and Ancient Near Eastern Lang.", add 
...
label define label_cipcode 190706 "19.0706 - Child Growth, Care and Development Studies", add 
...
label define label_cipcode 301201 "30.1201 - Historic Preservation, Conservation and Architectural History", add 
...
label define label_cipcode 310505 "31.0505 - Exercise Sciences/Physiology and Movement", add 
...
label define label_cipcode 390101 "39.0101 - Biblical and Other Theological Lang. and Lit.", add 
...
label define label_cipcode 390701 "39.0701 - Pastoral Counseling and Specialized Ministries", add 
...
label define label_cipcode 450604 "45.0604 - Development Econ. and International Dev.", add 
...
label define label_cipcode 450804 "45.0804 - History and Philosophy of Science and Tech.", add 
label define label_cipcode 450805 "45.0805 - Public/Applied History and Archival Admin.", add 
...
label define label_cipcode 480211 "48.0211 - Computer Typography and Composition Equip.", add 
...
label define label_cipcode 490205 "49.0205 - Truck, Bus and Other Commercial Vehicle Opns.", add 
...
label define label_cipcode 500502 "50.0502 - Technical Theater/Theater Design and Stage", add 
label define label_cipcode 500503 "50.0503 - Acting and Directing", add 
label define label_cipcode 500505 "50.0505 - Drama/Theater Lit., History and Critcism", add 
label define label_cipcode 500599 "50.0599 - Dramatic/Theater Arts and Stagecraft, Other", add 
...
label define label_cipcode 500908 "50.0908 - Music - Voice and Choral/Opera Performance", add 
label define label_cipcode 500909 "50.0909 - Music Business Management and Merchandising", add 
...
label define label_cipcode 510299 "51.0299 - Communication Disorders Sci and Srvc., Other", add 
...
label define label_cipcode 510799 "51.0799 - Health and Medical Admin. Services, Other", add 
...
label define label_cipcode 510808 "51.0808 - Veterinarian Assistant/Animal Health Tech.", add 
...
label define label_cipcode 510999 "51.0999 - Health and Med. Diagnostic and Treatment Srvc., Other", add 
...
label define label_cipcode 511099 "51.1099 - Health and Medical Laboratory Tech., Other", add 
...
label define label_cipcode 511199 "51.1199 - Health and Med. Preparatory Programs, Other", add 
...
label define label_cipcode 512002 "51.2002 - Pharmacy Administration and Pharmaceutics", add 
label define label_cipcode 512003 "51.2003 - Medical Pharmacology and Pharmaceutical Sciences", add 
...
label define label_cipcode 519999 "51.9999 - Health Professions and Related Sciences, Other", add 
label define label_cipcode 520101 "52.0101 - Business, General", add 
label define label_cipcode 520201 "52.0201 - Business Admin. and Management, General", add 
label define label_cipcode 520202 "52.0202 - Purchasing, Procurement and Contracts Management", add 
...
label define label_cipcode 520299 "52.0299 - Business Admin. and Management, Other", add 
...
label define label_cipcode 520408 "52.0408 - General Office/Clerical and Typing Srvc.", add 
label define label_cipcode 520499 "52.0499 - Administrative and Secretarial Srvc., Other", add 
...
label define label_cipcode 520701 "52.0701 - Enterprise Management and Operation, General", add 
label define label_cipcode 520702 "52.0702 - Franchise Operation", add 
label define label_cipcode 520799 "52.0799 - Enterprise Management and Operation, Other", add 
...
label define label_cipcode 521001 "52.1001 - Human Resources Management, General", add 
...
label define label_cipcode 521201 "52.1201 - ManagementInfo. Systems and Business Data Process", add 
...
label define label_cipcode 521399 "52.1399 - Business Quantitative Methods and Management, Other", add 
...
label define label_cipcode 529999 "52.9999 - Business Management and Admin. Services, Other", add 
