...
*                                                        
insheet using "c:\dct\gr2001ath_data_stata.csv", comma clear
label data "dct_gr2001ath"
...
label define label_grtype 10 "Degree/certificate-seeking students (4-year institutions) exclusions", add 
...
label define label_cohort 1 "Bachelors/ equiv+other degree/certif-seeking 1995 athletic subcohort (4-yr institution)" 
label define label_cohort 3 "Degree/certif-seeking students 1998 athletic subcohort ( 2-yr institution)", add 
