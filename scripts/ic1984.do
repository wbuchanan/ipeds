...
*                                                        
insheet using "c:\dct\ic1984_data_stata.csv", comma clear
label data "dct_ic1984"
...
label variable procc "Term occupational prog below bachelor^s"
...
label variable geost "Oe st code of actual location"
label variable oereg "Academic regions"
label variable obereg "Dept of com obe regions"
...
label variable excntl "Control - more detail than cntl84 var"
...
label variable period "Number of days coverd by room & board"
...
label define label_sequen # "Entry unknown" 
label define label_sequen 0 "00", add 
...
label define label_pr2yr 7 "Entry unknown", add 
...
label define label_prlib 2 "Entry unknown", add 
...
label define label_prtea 2 "Entry unknown", add 
...
label define label_prprof 5 "Entry unknown", add 
