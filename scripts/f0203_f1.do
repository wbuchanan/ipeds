...
*                                                        
insheet using "c:\dct\f0203_f1_data_stata.csv", comma clear
label data "dct_f0203_f1"
...
label variable xj053 "Imputation field for J053 - Gifts, grants, and contracts"
label variable j053 "Gifts, grants, and contracts"
...
label variable xb234 "Imputation field for B234 - Total salaries and wages for E and G"
label variable b234 "Total salaries and wages for E and G"
label variable xb244 "Imputation field for B244 - E and G employee fringe benefits paid from institutional accounts"
label variable b244 "E and G employee fringe benefits paid from institutional accounts"
...
label variable xg05 "Imputation field for G05 - Interest paymnts on physical plant indebtedness"
label variable g05 "Interest paymnts on physical plant indebtedness"
...
label variable xk014 "Imputation field for K014 - Land - Book value at end of year"
label variable k014 "Land - Book value at end of year"
label variable xk025 "Imputation field for K025 - Buildings - Current replacement value (estimate)"
label variable k025 "Buildings - Current replacement value (estimate)"
label variable xk035 "Imputation field for K035 - Equipment - Current replacement value (estimate)"
label variable k035 "Equipment - Current replacement value (estimate)"
...
label define label_xa013 23 "Logical imputation", add 
label define label_xa013 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa013 50 "Outlier value derived from reported data", add 
label define label_xa013 51 "Outlier value derived from imputed data", add 
label define label_xa013 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa023 23 "Logical imputation", add 
label define label_xa023 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa023 50 "Outlier value derived from reported data", add 
label define label_xa023 51 "Outlier value derived from imputed data", add 
label define label_xa023 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa043 23 "Logical imputation", add 
label define label_xa043 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa043 50 "Outlier value derived from reported data", add 
label define label_xa043 51 "Outlier value derived from imputed data", add 
label define label_xa043 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa053 23 "Logical imputation", add 
label define label_xa053 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa053 50 "Outlier value derived from reported data", add 
label define label_xa053 51 "Outlier value derived from imputed data", add 
label define label_xa053 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa063 23 "Logical imputation", add 
label define label_xa063 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa063 50 "Outlier value derived from reported data", add 
label define label_xa063 51 "Outlier value derived from imputed data", add 
label define label_xa063 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa073 23 "Logical imputation", add 
label define label_xa073 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa073 50 "Outlier value derived from reported data", add 
label define label_xa073 51 "Outlier value derived from imputed data", add 
label define label_xa073 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa083 23 "Logical imputation", add 
label define label_xa083 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa083 50 "Outlier value derived from reported data", add 
label define label_xa083 51 "Outlier value derived from imputed data", add 
label define label_xa083 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa093 23 "Logical imputation", add 
label define label_xa093 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa093 50 "Outlier value derived from reported data", add 
label define label_xa093 51 "Outlier value derived from imputed data", add 
label define label_xa093 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa103 23 "Logical imputation", add 
label define label_xa103 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa103 50 "Outlier value derived from reported data", add 
label define label_xa103 51 "Outlier value derived from imputed data", add 
label define label_xa103 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa113 23 "Logical imputation", add 
label define label_xa113 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa113 50 "Outlier value derived from reported data", add 
label define label_xa113 51 "Outlier value derived from imputed data", add 
label define label_xa113 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa123 23 "Logical imputation", add 
label define label_xa123 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa123 50 "Outlier value derived from reported data", add 
label define label_xa123 51 "Outlier value derived from imputed data", add 
label define label_xa123 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa133 23 "Logical imputation", add 
label define label_xa133 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa133 50 "Outlier value derived from reported data", add 
label define label_xa133 51 "Outlier value derived from imputed data", add 
label define label_xa133 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa143 23 "Logical imputation", add 
label define label_xa143 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa143 50 "Outlier value derived from reported data", add 
label define label_xa143 51 "Outlier value derived from imputed data", add 
label define label_xa143 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa153 23 "Logical imputation", add 
label define label_xa153 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa153 50 "Outlier value derived from reported data", add 
label define label_xa153 51 "Outlier value derived from imputed data", add 
label define label_xa153 52 "Value not derived - parent/child differs across components", add 
...
label define label_xa163 23 "Logical imputation", add 
label define label_xa163 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xa163 50 "Outlier value derived from reported data", add 
label define label_xa163 51 "Outlier value derived from imputed data", add 
label define label_xa163 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj013 23 "Logical imputation", add 
label define label_xj013 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj013 50 "Outlier value derived from reported data", add 
label define label_xj013 51 "Outlier value derived from imputed data", add 
label define label_xj013 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj023 23 "Logical imputation", add 
label define label_xj023 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj023 50 "Outlier value derived from reported data", add 
label define label_xj023 51 "Outlier value derived from imputed data", add 
label define label_xj023 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj033 23 "Logical imputation", add 
label define label_xj033 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj033 50 "Outlier value derived from reported data", add 
label define label_xj033 51 "Outlier value derived from imputed data", add 
label define label_xj033 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj043 23 "Logical imputation", add 
label define label_xj043 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj043 50 "Outlier value derived from reported data", add 
label define label_xj043 51 "Outlier value derived from imputed data", add 
label define label_xj043 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj053 23 "Logical imputation", add 
label define label_xj053 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj053 50 "Outlier value derived from reported data", add 
label define label_xj053 51 "Outlier value derived from imputed data", add 
label define label_xj053 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj063 23 "Logical imputation", add 
label define label_xj063 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj063 50 "Outlier value derived from reported data", add 
label define label_xj063 51 "Outlier value derived from imputed data", add 
label define label_xj063 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj073 23 "Logical imputation", add 
label define label_xj073 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj073 50 "Outlier value derived from reported data", add 
label define label_xj073 51 "Outlier value derived from imputed data", add 
label define label_xj073 52 "Value not derived - parent/child differs across components", add 
...
label define label_xj083 23 "Logical imputation", add 
label define label_xj083 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xj083 50 "Outlier value derived from reported data", add 
label define label_xj083 51 "Outlier value derived from imputed data", add 
label define label_xj083 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb013 23 "Logical imputation", add 
label define label_xb013 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb013 50 "Outlier value derived from reported data", add 
label define label_xb013 51 "Outlier value derived from imputed data", add 
label define label_xb013 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb023 23 "Logical imputation", add 
label define label_xb023 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb023 50 "Outlier value derived from reported data", add 
label define label_xb023 51 "Outlier value derived from imputed data", add 
label define label_xb023 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb033 23 "Logical imputation", add 
label define label_xb033 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb033 50 "Outlier value derived from reported data", add 
label define label_xb033 51 "Outlier value derived from imputed data", add 
label define label_xb033 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb043 23 "Logical imputation", add 
label define label_xb043 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb043 50 "Outlier value derived from reported data", add 
label define label_xb043 51 "Outlier value derived from imputed data", add 
label define label_xb043 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb063 23 "Logical imputation", add 
label define label_xb063 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb063 50 "Outlier value derived from reported data", add 
label define label_xb063 51 "Outlier value derived from imputed data", add 
label define label_xb063 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb073 23 "Logical imputation", add 
label define label_xb073 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb073 50 "Outlier value derived from reported data", add 
label define label_xb073 51 "Outlier value derived from imputed data", add 
label define label_xb073 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb083 23 "Logical imputation", add 
label define label_xb083 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb083 50 "Outlier value derived from reported data", add 
label define label_xb083 51 "Outlier value derived from imputed data", add 
label define label_xb083 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb093 23 "Logical imputation", add 
label define label_xb093 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb093 50 "Outlier value derived from reported data", add 
label define label_xb093 51 "Outlier value derived from imputed data", add 
label define label_xb093 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb103 23 "Logical imputation", add 
label define label_xb103 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb103 50 "Outlier value derived from reported data", add 
label define label_xb103 51 "Outlier value derived from imputed data", add 
label define label_xb103 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb113 23 "Logical imputation", add 
label define label_xb113 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb113 50 "Outlier value derived from reported data", add 
label define label_xb113 51 "Outlier value derived from imputed data", add 
label define label_xb113 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb123 23 "Logical imputation", add 
label define label_xb123 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb123 50 "Outlier value derived from reported data", add 
label define label_xb123 51 "Outlier value derived from imputed data", add 
label define label_xb123 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb133 23 "Logical imputation", add 
label define label_xb133 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb133 50 "Outlier value derived from reported data", add 
label define label_xb133 51 "Outlier value derived from imputed data", add 
label define label_xb133 52 "Value not derived - parent/child differs across components", add 
...
label define label_xbline15 23 "Logical imputation", add 
label define label_xbline15 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xbline15 50 "Outlier value derived from reported data", add 
label define label_xbline15 51 "Outlier value derived from imputed data", add 
label define label_xbline15 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb163 23 "Logical imputation", add 
label define label_xb163 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb163 50 "Outlier value derived from reported data", add 
label define label_xb163 51 "Outlier value derived from imputed data", add 
label define label_xb163 52 "Value not derived - parent/child differs across components", add 
...
label define label_xbline18 23 "Logical imputation", add 
label define label_xbline18 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xbline18 50 "Outlier value derived from reported data", add 
label define label_xbline18 51 "Outlier value derived from imputed data", add 
label define label_xbline18 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb193 23 "Logical imputation", add 
label define label_xb193 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb193 50 "Outlier value derived from reported data", add 
label define label_xb193 51 "Outlier value derived from imputed data", add 
label define label_xb193 52 "Value not derived - parent/child differs across components", add 
...
label define label_xbline21 23 "Logical imputation", add 
label define label_xbline21 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xbline21 50 "Outlier value derived from reported data", add 
label define label_xbline21 51 "Outlier value derived from imputed data", add 
label define label_xbline21 52 "Value not derived - parent/child differs across components", add 
...
label define label_xbother 23 "Logical imputation", add 
label define label_xbother 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xbother 50 "Outlier value derived from reported data", add 
label define label_xbother 51 "Outlier value derived from imputed data", add 
label define label_xbother 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb223 23 "Logical imputation", add 
label define label_xb223 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb223 50 "Outlier value derived from reported data", add 
label define label_xb223 51 "Outlier value derived from imputed data", add 
label define label_xb223 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb234 23 "Logical imputation", add 
label define label_xb234 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb234 50 "Outlier value derived from reported data", add 
label define label_xb234 51 "Outlier value derived from imputed data", add 
label define label_xb234 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb244 23 "Logical imputation", add 
label define label_xb244 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb244 50 "Outlier value derived from reported data", add 
label define label_xb244 51 "Outlier value derived from imputed data", add 
label define label_xb244 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb254 23 "Logical imputation", add 
label define label_xb254 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb254 50 "Outlier value derived from reported data", add 
label define label_xb254 51 "Outlier value derived from imputed data", add 
label define label_xb254 52 "Value not derived - parent/child differs across components", add 
...
label define label_xb274 23 "Logical imputation", add 
label define label_xb274 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xb274 50 "Outlier value derived from reported data", add 
label define label_xb274 51 "Outlier value derived from imputed data", add 
label define label_xb274 52 "Value not derived - parent/child differs across components", add 
...
label define label_xe013 23 "Logical imputation", add 
label define label_xe013 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xe013 50 "Outlier value derived from reported data", add 
label define label_xe013 51 "Outlier value derived from imputed data", add 
label define label_xe013 52 "Value not derived - parent/child differs across components", add 
...
label define label_xe023 23 "Logical imputation", add 
label define label_xe023 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xe023 50 "Outlier value derived from reported data", add 
label define label_xe023 51 "Outlier value derived from imputed data", add 
label define label_xe023 52 "Value not derived - parent/child differs across components", add 
...
label define label_xe033 23 "Logical imputation", add 
label define label_xe033 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xe033 50 "Outlier value derived from reported data", add 
label define label_xe033 51 "Outlier value derived from imputed data", add 
label define label_xe033 52 "Value not derived - parent/child differs across components", add 
...
label define label_xe043 23 "Logical imputation", add 
label define label_xe043 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xe043 50 "Outlier value derived from reported data", add 
label define label_xe043 51 "Outlier value derived from imputed data", add 
label define label_xe043 52 "Value not derived - parent/child differs across components", add 
...
label define label_xe053 23 "Logical imputation", add 
label define label_xe053 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xe053 50 "Outlier value derived from reported data", add 
label define label_xe053 51 "Outlier value derived from imputed data", add 
label define label_xe053 52 "Value not derived - parent/child differs across components", add 
...
label define label_xe063 23 "Logical imputation", add 
label define label_xe063 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xe063 50 "Outlier value derived from reported data", add 
label define label_xe063 51 "Outlier value derived from imputed data", add 
label define label_xe063 52 "Value not derived - parent/child differs across components", add 
...
label define label_xe073 23 "Logical imputation", add 
label define label_xe073 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xe073 50 "Outlier value derived from reported data", add 
label define label_xe073 51 "Outlier value derived from imputed data", add 
label define label_xe073 52 "Value not derived - parent/child differs across components", add 
...
label define label_xg01 23 "Logical imputation", add 
label define label_xg01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xg01 50 "Outlier value derived from reported data", add 
label define label_xg01 51 "Outlier value derived from imputed data", add 
label define label_xg01 52 "Value not derived - parent/child differs across components", add 
...
label define label_xg02 23 "Logical imputation", add 
label define label_xg02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xg02 50 "Outlier value derived from reported data", add 
label define label_xg02 51 "Outlier value derived from imputed data", add 
label define label_xg02 52 "Value not derived - parent/child differs across components", add 
...
label define label_xg03 23 "Logical imputation", add 
label define label_xg03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xg03 50 "Outlier value derived from reported data", add 
label define label_xg03 51 "Outlier value derived from imputed data", add 
label define label_xg03 52 "Value not derived - parent/child differs across components", add 
...
label define label_xg04 23 "Logical imputation", add 
label define label_xg04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xg04 50 "Outlier value derived from reported data", add 
label define label_xg04 51 "Outlier value derived from imputed data", add 
label define label_xg04 52 "Value not derived - parent/child differs across components", add 
...
label define label_xg05 23 "Logical imputation", add 
label define label_xg05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xg05 50 "Outlier value derived from reported data", add 
label define label_xg05 51 "Outlier value derived from imputed data", add 
label define label_xg05 52 "Value not derived - parent/child differs across components", add 
...
label define label_xh011 23 "Logical imputation", add 
label define label_xh011 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xh011 50 "Outlier value derived from reported data", add 
label define label_xh011 51 "Outlier value derived from imputed data", add 
label define label_xh011 52 "Value not derived - parent/child differs across components", add 
...
label define label_xh012 23 "Logical imputation", add 
label define label_xh012 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xh012 50 "Outlier value derived from reported data", add 
label define label_xh012 51 "Outlier value derived from imputed data", add 
label define label_xh012 52 "Value not derived - parent/child differs across components", add 
...
label define label_xh021 23 "Logical imputation", add 
label define label_xh021 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xh021 50 "Outlier value derived from reported data", add 
label define label_xh021 51 "Outlier value derived from imputed data", add 
label define label_xh021 52 "Value not derived - parent/child differs across components", add 
...
label define label_xh022 23 "Logical imputation", add 
label define label_xh022 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xh022 50 "Outlier value derived from reported data", add 
label define label_xh022 51 "Outlier value derived from imputed data", add 
label define label_xh022 52 "Value not derived - parent/child differs across components", add 
...
label define label_xk014 23 "Logical imputation", add 
label define label_xk014 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xk014 50 "Outlier value derived from reported data", add 
label define label_xk014 51 "Outlier value derived from imputed data", add 
label define label_xk014 52 "Value not derived - parent/child differs across components", add 
...
label define label_xk025 23 "Logical imputation", add 
label define label_xk025 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xk025 50 "Outlier value derived from reported data", add 
label define label_xk025 51 "Outlier value derived from imputed data", add 
label define label_xk025 52 "Value not derived - parent/child differs across components", add 
...
label define label_xk035 23 "Logical imputation", add 
label define label_xk035 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xk035 50 "Outlier value derived from reported data", add 
label define label_xk035 51 "Outlier value derived from imputed data", add 
label define label_xk035 52 "Value not derived - parent/child differs across components", add 
