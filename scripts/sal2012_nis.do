...
*
insheet using "k:\ipedsdata\dct\sal2012_nis_data_stata.csv", comma clear
...
label variable xsanin02 "Imputation field for sanin02 - Postsecondary Teachers - Research - number"
label variable sanin02  "Postsecondary Teachers - Research - number"
label variable xsanit02 "Imputation field for sanit02 - Postsecondary Teachers - Research - outlays"
label variable sanit02  "Postsecondary Teachers - Research - outlays"
label variable xsanin03 "Imputation field for sanin03 - Postsecondary Teachers - Public service - number"
label variable sanin03  "Postsecondary Teachers - Public service - number"
label variable xsanit03 "Imputation field for sanit03 - Postsecondary Teachers - Public service Outlays"
label variable sanit03  "Postsecondary Teachers - Public service Outlays"
label variable xsanin04 "Imputation field for sanin04 - Librarians, Curators, Archivists, other teaching and Instructional support  - number"
label variable sanin04  "Librarians, Curators, Archivists, other teaching and Instructional support  - number"
label variable xsanit04 "Imputation field for sanit04 - Librarians, Curators, Archivists, other teaching and Instructional support  - outlays"
label variable sanit04  "Librarians, Curators, Archivists, other teaching and Instructional support  - outlays"
...
label variable xsanin08 "Imputation field for sanin08 - Community Service, Legal, Arts, and Media - number"
label variable sanin08  "Community Service, Legal, Arts, and Media - number"
label variable xsanit08 "Imputation field for sanit08 - Community Service, Legal, Arts, and Media - outlays"
label variable sanit08  "Community Service, Legal, Arts, and Media - outlays"
