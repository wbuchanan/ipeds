...
*                                                        
insheet using "c:\dct\s2002_g_data_stata.csv", comma clear
label data "dct_s2002_g"
label variable unitid "unitid"
label variable sgtype "Primary function/occupational activity"
label variable functcd "Original function code on survey form"
