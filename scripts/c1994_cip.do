...
*                                                        
insheet using "c:\dct\c1994_cip_data_stata.csv", comma clear
label data "dct_c1994_cip"
...
label define label_cipcode 10199 "01.0199 - Agricultural Business and Management, Oth.", add 
...
label define label_cipcode 19999 "01.9999 - Agricultural Business and Production, Oth.", add 
...
label define label_cipcode 30299 "03.0299 - Nat. Resrcs. Mgmt. and Protectv Svcs, Oth.", add 
...
label define label_cipcode 39999 "03.9999 - Conservation and Renewable Nat. Resrs, Oth.", add 
...
label define label_cipcode 80101 "08.0101 - Apparel and Accessories Market. Opns, Gen.", add 
label define label_cipcode 80102 "08.0102 - Fashion Merchandising", add 
label define label_cipcode 80199 "08.0199 - Apparel and Accessories Market. Opns, Oth.", add 
label define label_cipcode 80204 "08.0204 - Business Services Marketing Operations", add 
label define label_cipcode 80299 "08.0299 - Bus. and Personal Ser. Market. Opns, Oth.", add 
...
label define label_cipcode 80899 "08.0899 - Home and Office Products Mrkting Opns, Oth.", add 
label define label_cipcode 80901 "08.0901 - Hospitality and Rec. Marketing Opns, Gen.", add 
...
label define label_cipcode 80999 "08.0999 - Hospitality and Recrtn. Market. Opns, Oth.", add 
...
label define label_cipcode 81199 "08.1199 - Tourism and Travel Serv. Market. Opns, Oth.", add 
...
label define label_cipcode 81299 "08.1299 - Vehicle and Petrol. Prods. Market. Ops, Oth.", add 
label define label_cipcode 89999 "08.9999 - Marketing Opns/Market. and Distrib., Oth.", add 
...
label define label_cipcode 130401 "13.0401 - Education Admin. and Supervision, Gen.", add 
...
label define label_cipcode 130499 "13.0499 - Education Admin. and Supervision, Oth.", add 
...
label define label_cipcode 130699 "13.0699 - Educ. Eval., Research and Statistics, Oth.", add 
...
label define label_cipcode 131399 "13.1399 - Teacher Ed., Spec Acad and Voc Prog, Oth.", add 
...
label define label_cipcode 160399 "16.0399 - East/Southeast Asian Lang. and Lit., Oth.", add 
...
label define label_cipcode 160499 "16.0499 - East Europe Languages and Literatures, Oth.", add 
...
label define label_cipcode 161199 "16.1199 - Mid Eastern Languages and Literatures, Oth.", add 
...
label define label_cipcode 200401 "20.0401 - Institutional Food Workers and Admin, Gen.", add 
...
label define label_cipcode 200499 "20.0499 - Institutional Food Workers and Admin, Oth.", add 
...
label define label_cipcode 240199 "24.0199 - Lib. Art and Sci., Gen. Studies and Human., Oth.", add 
...
label define label_cipcode 310599 "31.0599 - Health and Physical Education/Fitness, Oth.", add 
...
label define label_cipcode 390701 "39.0701 - Pastoral Counseling and Specialized Minist", add 
label define label_cipcode 399999 "39.9999 - Theological Studies and Rel. Vocations, Oth.", add 
...
label define label_cipcode 410299 "41.0299 - Nuclear and Industrial Radiologic Tech., Oth.", add 
...
label define label_cipcode 460301 "46.0301 - Elec. and Power Trans. Installer, Gen.", add 
label define label_cipcode 460302 "46.0302 - Electrician", add 
label define label_cipcode 460303 "46.0303 - Lineworker", add 
label define label_cipcode 460399 "46.0399 - Elec. and Power Trans. Installer, Oth.", add 
...
label define label_cipcode 460499 "46.0499 - Const. and Bldg. Finishers and Managers, Oth.", add 
...
label define label_cipcode 470101 "47.0101 - Electrical and Electronics Equipment Installer and Repairers, Gen.", add 
...
label define label_cipcode 470199 "47.0199 - Electrical and Electronics Equipment Installer and Repairers, Oth.", add 
...
label define label_cipcode 470499 "47.0499 - Miscellaneous Mechanics and Repairers, Oth.", add 
label define label_cipcode 470501 "47.0501 - Stationary Energy Sources Installer/Op.", add 
...
label define label_cipcode 480201 "48.0201 - Graphic and Printing Equip. Operator, Gen.", add 
...
label define label_cipcode 480299 "48.0299 - Graphic and Printing Equip. Operator, Oth.", add 
...
label define label_cipcode 500599 "50.0599 - Dramatic/Theater Arts and Stagecraft, Oth.", add 
...
label define label_cipcode 510299 "51.0299 - Communication Disorders Sci and Srvc., Oth.", add 
...
label define label_cipcode 510799 "51.0799 - Health and Medical Admin. Services, Oth.", add 
...
label define label_cipcode 510999 "51.0999 - Health and Med. Diagnostic and Treat Srvc., Oth.", add 
...
label define label_cipcode 511099 "51.1099 - Health and Medical Laboratory Tech., Oth.", add 
...
label define label_cipcode 511199 "51.1199 - Health and Med. Preparatory Programs, Oth.", add 
...
label define label_cipcode 519999 "51.9999 - Health Professions and Rel. Sciences, Oth.", add 
label define label_cipcode 520101 "52.0101 - Business, General", add 
label define label_cipcode 520201 "52.0201 - Business Administration and Mgmt., Gen.", add 
label define label_cipcode 520202 "52.0202 - Purchasing, Procurement and Contracts Mgmt.", add 
...
label define label_cipcode 520299 "52.0299 - Business Administration and Mgmt., Oth.", add 
...
label define label_cipcode 520499 "52.0499 - Administrative and Secretarial Serv., Oth.", add 
...
label define label_cipcode 521201 "52.1201 - Mgmt. Info. Systems and Bus. Data Process", add 
...
label define label_cipcode 521399 "52.1399 - Bus. Quantitative Methods and Mgmt., Oth.", add 
...
label define label_cipcode 529999 "52.9999 - Business Management and Admin. Srvc., Oth.", add 
