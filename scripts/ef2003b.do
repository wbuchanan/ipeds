...
*                                                        
insheet using "c:\dct\ef2003b_data_stata.csv", comma clear
label data "dct_ef2003b"
...
label define label_xefage01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage01 51 "Outlier value derived from imputed data", add 
...
label define label_xefage02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage02 51 "Outlier value derived from imputed data", add 
...
label define label_xefage03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage03 51 "Outlier value derived from imputed data", add 
...
label define label_xefage04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage04 51 "Outlier value derived from imputed data", add 
...
label define label_xefage05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage05 51 "Outlier value derived from imputed data", add 
...
label define label_xefage06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage06 51 "Outlier value derived from imputed data", add 
...
label define label_xefage07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage07 51 "Outlier value derived from imputed data", add 
...
label define label_xefage08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage08 51 "Outlier value derived from imputed data", add 
...
label define label_xefage09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefage09 51 "Outlier value derived from imputed data", add 
