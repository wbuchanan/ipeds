...
*
insheet using "k:\ipedsdata\dct\ic2013_py_data_stata.csv", comma clear
label data "dct_ic2013_py"
label variable unitid   "Unique identification number of the institution"
label variable prgmofr  "Number of programs offered"
label variable cipcode1 "CIP code of largest program"
label variable xciptui1 "Imputation field for ciptuit1 - Tuition and fees 2013-14 (institutions with no full-time, first-time, undergraduate students)"
label variable ciptuit1 "Tuition and fees 2013-14 (institutions with no full-time, first-time, undergraduate students)"
label variable xcipsup1 "Imputation field for cipsupp1 - Books and supplies 2013-14 (institutions with no full-time, first-time, undergraduate students)"
label variable cipsupp1 "Books and supplies 2013-14 (institutions with no full-time, first-time, undergraduate students)"
...
label variable xchg1py0 "Imputation field for chg1py0 - Published tuition and fees 2010-11"
label variable chg1py0  "Published tuition and fees 2010-11"
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2011-12"
label variable chg1py1  "Published tuition and fees 2011-12"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2012-13"
label variable chg1py2  "Published tuition and fees 2012-13"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2013-14"
label variable chg1py3  "Published tuition and fees 2013-14"
label variable xchg4py0 "Imputation field for chg4py0 - Books and supplies 2010-11"
label variable chg4py0  "Books and supplies 2010-11"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2011-12"
label variable chg4py1  "Books and supplies 2011-12"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2012-13"
label variable chg4py2  "Books and supplies 2012-13"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2013-14"
label variable chg4py3  "Books and supplies 2013-14"
label variable xchg5py0 "Imputation field for chg5py0 - On campus, room and board 2010-11"
label variable chg5py0  "On campus, room and board 2010-11"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2011-12"
label variable chg5py1  "On campus, room and board 2011-12"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2012-13"
label variable chg5py2  "On campus, room and board 2012-13"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2013-14"
label variable chg5py3  "On campus, room and board 2013-14"
label variable xchg6py0 "Imputation field for chg6py0 - On campus, other expenses 2010-11"
label variable chg6py0  "On campus, other expenses 2010-11"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2011-12"
label variable chg6py1  "On campus, other expenses 2011-12"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2012-13"
label variable chg6py2  "On campus, other expenses 2012-13"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2013-14"
label variable chg6py3  "On campus, other expenses 2013-14"
label variable xchg7py0 "Imputation field for chg7py0 - Off campus (not with family), room and board 2010-11"
label variable chg7py0  "Off campus (not with family), room and board 2010-11"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2011-12"
label variable chg7py1  "Off campus (not with family), room and board 2011-12"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2012-13"
label variable chg7py2  "Off campus (not with family), room and board 2012-13"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board 2013-14"
label variable chg7py3  "Off campus (not with family), room and board 2013-14"
label variable xchg8py0 "Imputation field for chg8py0 - Off campus (not with family), other expenses 2010-11"
label variable chg8py0  "Off campus (not with family), other expenses 2010-11"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2011-12"
label variable chg8py1  "Off campus (not with family), other expenses 2011-12"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2012-13"
label variable chg8py2  "Off campus (not with family), other expenses 2012-13"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2013-14"
label variable chg8py3  "Off campus (not with family), other expenses 2013-14"
label variable xchg9py0 "Imputation field for chg9py0 - Off campus (with family), other expenses 2010-11"
label variable chg9py0  "Off campus (with family), other expenses 2010-11"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2011-12"
label variable chg9py1  "Off campus (with family), other expenses 2011-12"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2012-13"
label variable chg9py2  "Off campus (with family), other expenses 2012-13"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2013-14"
label variable chg9py3  "Off campus (with family), other expenses 2013-14"
...
label define label_cipcode2 500510 "50.0510-Costume Design",add
...
label define label_cipcode2 512401 "51.2401-Veterinary Medicine",add
...
label define label_cipcode3 111005 "11.1005-Information Technology Project Management",add
...
label define label_cipcode3 510501 "51.0501-Dental Clinical Sciences, General.",add
...
label define label_cipcode3 513306 "51.3306-Holistic Health",add
...
label define label_cipcode4 100202 "10.0202-Radio and Television Broadcasting Technology/Technician."
...
label define label_cipcode4 310501 "31.0501-Health and Physical Education/Fitness, General.",add
...
label define label_cipcode4 501003 "50.1003-Music Management",add
...
label define label_cipcode5 430116 "43.0116-Cyber/Computer Forensics and Counterterrorism",add
label define label_cipcode5 430203 "43.0203-Fire Science/Fire-fighting.",add
label define label_cipcode5 439999 "43.9999-Homeland Security, Law Enforcement, Firefighting and Related Protective Services, O",add
...
label define label_cipcode6  10106 "01.0106-Agricultural Business Technology"
...
label define label_cipcode6 490208 "49.0208-Railroad and Railway Transportation",add
...
label define label_cipcode6 500913 "50.0913-Music Technology",add
