...
*                                                        
insheet using "c:\dct\sal2010_faculty_data_stata.csv", comma clear
label data "dct_sal2010_faculty"
...
* The following values are for the item imputation field variables
*'A' 'Not applicable'
