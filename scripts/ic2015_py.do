...
*
insheet using "c:\dct\ic2015_py_data_stata.csv", comma clear
label data "dct_ic2015_py"
label variable unitid   "Unique identification number of the institution"
label variable prgmofr  "Number of programs offered"
label variable cipcode1 "CIP code of largest program"
label variable xciptui1 "Imputation field for ciptuit1 - Tuition and fees 2015-16 (institutions with no full-time, first-time, undergraduate students)"
label variable ciptuit1 "Tuition and fees 2015-16 (institutions with no full-time, first-time, undergraduate students)"
label variable xcipsup1 "Imputation field for cipsupp1 - Books and supplies 2015-16 (institutions with no full-time, first-time, undergraduate students)"
label variable cipsupp1 "Books and supplies 2015-16 (institutions with no full-time, first-time, undergraduate students)"
...
label variable xchg1py0 "Imputation field for chg1py0 - Published tuition and fees 2012-13"
label variable chg1py0  "Published tuition and fees 2012-13"
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2013-14"
label variable chg1py1  "Published tuition and fees 2013-14"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2014-15"
label variable chg1py2  "Published tuition and fees 2014-15"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2015-16"
label variable chg1py3  "Published tuition and fees 2015-16"
label variable xchg4py0 "Imputation field for chg4py0 - Books and supplies 2012-13"
label variable chg4py0  "Books and supplies 2012-13"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2013-14"
label variable chg4py1  "Books and supplies 2013-14"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2014-15"
label variable chg4py2  "Books and supplies 2014-15"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2015-16"
label variable chg4py3  "Books and supplies 2015-16"
label variable xchg5py0 "Imputation field for chg5py0 - On campus, room and board 2012-13"
label variable chg5py0  "On campus, room and board 2012-13"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2013-14"
label variable chg5py1  "On campus, room and board 2013-14"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2014-15"
label variable chg5py2  "On campus, room and board 2014-15"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2015-16"
label variable chg5py3  "On campus, room and board 2015-16"
label variable xchg6py0 "Imputation field for chg6py0 - On campus, other expenses 2012-13"
label variable chg6py0  "On campus, other expenses 2012-13"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2013-14"
label variable chg6py1  "On campus, other expenses 2013-14"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2014-15"
label variable chg6py2  "On campus, other expenses 2014-15"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2015-16"
label variable chg6py3  "On campus, other expenses 2015-16"
label variable xchg7py0 "Imputation field for chg7py0 - Off campus (not with family), room and board 2012-13"
label variable chg7py0  "Off campus (not with family), room and board 2012-13"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2013-14"
label variable chg7py1  "Off campus (not with family), room and board 2013-14"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2014-15"
label variable chg7py2  "Off campus (not with family), room and board 2014-15"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board  2015-16"
label variable chg7py3  "Off campus (not with family), room and board  2015-16"
label variable xchg8py0 "Imputation field for chg8py0 - Off campus (not with family), other expenses 2012-13"
label variable chg8py0  "Off campus (not with family), other expenses 2012-13"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2013-14"
label variable chg8py1  "Off campus (not with family), other expenses 2013-14"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2014-15"
label variable chg8py2  "Off campus (not with family), other expenses 2014-15"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2015-16"
label variable chg8py3  "Off campus (not with family), other expenses 2015-16"
label variable xchg9py0 "Imputation field for chg9py0 - Off campus (with family), other expenses 2012-13"
label variable chg9py0  "Off campus (with family), other expenses 2012-13"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2013-14"
label variable chg9py1  "Off campus (with family), other expenses 2013-14"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2014-15"
label variable chg9py2  "Off campus (with family), other expenses 2014-15"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2015-16"
label variable chg9py3  "Off campus (with family), other expenses 2015-16"
...
label define label_cipcode2  11103 "01.1103-Horticultural Science"
...
label define label_cipcode3  90799 "09.0799-Radio, Television, and Digital Communication, Other"
...
label define label_cipcode3 510999 "51.0999-Allied Health Diagnostic, Intervention, and Treatment Professions, Other.",add
...
label define label_cipcode3 513810 "51.3810-Psychiatric/Mental Health Nurse/Nursing",add
...
label define label_cipcode4  10101 "01.0101-Agricultural Business and Management, General"
label define label_cipcode4  90903 "09.0903-Advertising",add
label define label_cipcode4  90906 "09.0906-Sports Communication",add
...
label define label_cipcode4 150406 "15.0406-Automation Engineer Technology/Technician",add
...
label define label_cipcode4 150614 "15.0614-Welding Engineering Technology/Technician",add
...
label define label_cipcode4 410303 "41.0303-Chemical Process Technology",add
...
label define label_cipcode5 150403 "15.0403-Electromechanical Technology/Electromechanical Engineering Technology.",add
...
label define label_cipcode5 501001 "50.1001-Arts, Entertainment,and Media Management, General",add
label define label_cipcode5 501003 "50.1003-Music Management",add
...
label define label_cipcode6  10605 "01.0605-Landscaping and Groundskeeping."
...
label define label_cipcode6 460499 "46.0499-Building/Construction Finishing, Management, and Inspection, Other",add
...
label define label_cipcode6 520203 "52.0203-Logistics, Materials, and Supply Chain Management",add
...
label define label_cipcode6 520907 "52.0907-Meeting and Event Planning",add
