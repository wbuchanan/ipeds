...
*                                                        
insheet using "c:\dct\ef2006d_data_stata.csv", comma clear
label data "dct_ef2006d"
...
label variable xugenter "Imputation field for UGENTERN - Total entering students at the undergraduate level, fall 2005"
label variable ugentern "Total entering students at the undergraduate level, fall 2005"
...
label define label_xgrcohrt 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrcohrt 51 "Outlier value derived from imported data", add 
label define label_xgrcohrt 52 "Value not derived - parent/child differs across components", add 
label define label_xgrcohrt 53 "Value not derived - data not usable", add 
...
label define label_xugenter 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xugenter 51 "Outlier value derived from imported data", add 
label define label_xugenter 52 "Value not derived - parent/child differs across components", add 
label define label_xugenter 53 "Value not derived - data not usable", add 
...
label define label_xpgrcohr 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xpgrcohr 51 "Outlier value derived from imported data", add 
label define label_xpgrcohr 52 "Value not derived - parent/child differs across components", add 
label define label_xpgrcohr 53 "Value not derived - data not usable", add 
...
label define label_xret_pcf 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xret_pcf 51 "Outlier value derived from imported data", add 
label define label_xret_pcf 52 "Value not derived - parent/child differs across components", add 
label define label_xret_pcf 53 "Value not derived - data not usable", add 
...
label define label_xret_pcp 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xret_pcp 51 "Outlier value derived from imported data", add 
label define label_xret_pcp 52 "Value not derived - parent/child differs across components", add 
label define label_xret_pcp 53 "Value not derived - data not usable", add 
