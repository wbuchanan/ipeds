...
*
insheet using "k:\ipedsdata\dct\ic2012_py_data_stata.csv", comma clear
label data "dct_ic2012_py"
label variable unitid   "Unique identification number of the institution"
label variable prgmofr  "Number of programs offered"
label variable cipcode1 "CIP code of largest program"
label variable xciptui1 "Imputation field for ciptuit1 - Tuition and fees 2012-13 (institutions with no full-time, first-time, undergraduate students)"
label variable ciptuit1 "Tuition and fees 2012-13 (institutions with no full-time, first-time, undergraduate students)"
label variable xcipsup1 "Imputation field for cipsupp1 - Books and supplies 2012-13 (institutions with no full-time, first-time, undergraduate students)"
label variable cipsupp1 "Books and supplies 2012-13 (institutions with no full-time, first-time, undergraduate students)"
...
label variable xchg1py0 "Imputation field for chg1py0 - Published tuition and fees 2009-10"
label variable chg1py0  "Published tuition and fees 2009-10"
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2010-11"
label variable chg1py1  "Published tuition and fees 2010-11"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2011-12"
label variable chg1py2  "Published tuition and fees 2011-12"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2012-13"
label variable chg1py3  "Published tuition and fees 2012-13"
label variable xchg4py0 "Imputation field for chg4py0 - Books and supplies 2009-10"
label variable chg4py0  "Books and supplies 2009-10"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2010-11"
label variable chg4py1  "Books and supplies 2010-11"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2011-12"
label variable chg4py2  "Books and supplies 2011-12"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2012-13"
label variable chg4py3  "Books and supplies 2012-13"
label variable xchg5py0 "Imputation field for chg5py0 - On campus, room and board 2009-10"
label variable chg5py0  "On campus, room and board 2009-10"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2010-11"
label variable chg5py1  "On campus, room and board 2010-11"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2011-12"
label variable chg5py2  "On campus, room and board 2011-12"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2012-13"
label variable chg5py3  "On campus, room and board 2012-13"
label variable xchg6py0 "Imputation field for chg6py0 - On campus, other expenses 2009-10"
label variable chg6py0  "On campus, other expenses 2009-10"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2010-11"
label variable chg6py1  "On campus, other expenses 2010-11"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2011-12"
label variable chg6py2  "On campus, other expenses 2011-12"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2012-13"
label variable chg6py3  "On campus, other expenses 2012-13"
label variable xchg7py0 "Imputation field for chg7py0 - Off campus (not with family), room and board 2009-10"
label variable chg7py0  "Off campus (not with family), room and board 2009-10"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2010-11"
label variable chg7py1  "Off campus (not with family), room and board 2010-11"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2011-12"
label variable chg7py2  "Off campus (not with family), room and board 2011-12"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board 2012-13"
label variable chg7py3  "Off campus (not with family), room and board 2012-13"
label variable xchg8py0 "Imputation field for chg8py0 - Off campus (not with family), other expenses 2009-10"
label variable chg8py0  "Off campus (not with family), other expenses 2009-10"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2010-11"
label variable chg8py1  "Off campus (not with family), other expenses 2010-11"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2011-12"
label variable chg8py2  "Off campus (not with family), other expenses 2011-12"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2012-13"
label variable chg8py3  "Off campus (not with family), other expenses 2012-13"
label variable xchg9py0 "Imputation field for chg9py0 - Off campus (with family), other expenses 2009-10"
label variable chg9py0  "Off campus (with family), other expenses 2009-10"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2010-11"
label variable chg9py1  "Off campus (with family), other expenses 2010-11"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2011-12"
label variable chg9py2  "Off campus (with family), other expenses 2011-12"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2012-13"
label variable chg9py3  "Off campus (with family), other expenses 2012-13"
label variable xcmp1py0 "Imputation field for cmp1py0 - Comprehensive fee 2009-10"
label variable cmp1py0  "Comprehensive fee 2009-10"
label variable xcmp1py1 "Imputation field for cmp1py1 - Comprehensive fee 2010-11"
label variable cmp1py1  "Comprehensive fee 2010-11"
label variable xcmp1py2 "Imputation field for cmp1py2 - Comprehensive fee 2011-12"
label variable cmp1py2  "Comprehensive fee 2011-12"
label variable xcmp1py3 "Imputation field for cmp1py3 - Comprehensive fee 2012-13"
label variable cmp1py3  "Comprehensive fee 2012-13"
...
label define label_cipcode1 310301 "31.0301-Parks, Recreation and Leisure Facilities Management, General.",add
...
label define label_cipcode1 512604 "51.2604-Rehabilitation Aide",add
...
label define label_cipcode2 111005 "11.1005-Information Technology Project Management",add
...
label define label_cipcode2 439999 "43.9999-Homeland Security, Law Enforcement, Firefighting and Related Protective Services, O",add
...
label define label_cipcode2 500601 "50.0601-Film/Cinema/Video Studies",add
...
label define label_cipcode2 501099 "50.1099-Arts, Entertainment, and Media Management, Other",add
...
label define label_cipcode3 310501 "31.0501-Health and Physical Education/Fitness, General.",add
...
label define label_cipcode3 500411 "50.0411-Game and Interactive Media Design",add
...
label define label_cipcode4  90701 "09.0701-Radio and Television"
...
label define label_cipcode4 131019 "13.1019-Education/Teaching of Individuals in Secondary Special Education Programs",add
...
label define label_cipcode4 512314 "51.2314-Rehabilitation Science",add
...
label define label_cipcode5  10608 "01.0608-Floriculture/Floristry Operations and Management."
...
label define label_cipcode5 120510 "12.0510-Wine Steward/Sommelier",add
...
label define label_cipcode5 131401 "13.1401-Teaching English as a Second or Foreign Language/ESL Language Instructor.",add
...
label define label_cipcode5 310508 "31.0508-Sports Studies",add
...
label define label_cipcode5 500509 "50.0509-Musical Theatre",add
...
label define label_cipcode5 -1 "-1     -Not applicable",add
...
label define label_cipcode6 430116 "43.0116-Cyber/Computer Forensics and Counterterrorism",add
