...
*                                                        
insheet using "c:\dct\s2006_abd_data_stata.csv", comma clear
label data "dct_s2006_abd"
...
label define label_xstaff01 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff01 51 "Outlier value derived from imported data", add 
label define label_xstaff01 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff01 53 "Value not derived - data not usable", add 
...
label define label_xstaff02 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff02 51 "Outlier value derived from imported data", add 
label define label_xstaff02 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff02 53 "Value not derived - data not usable", add 
...
label define label_xstaff03 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff03 51 "Outlier value derived from imported data", add 
label define label_xstaff03 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff03 53 "Value not derived - data not usable", add 
...
label define label_xstaff04 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff04 51 "Outlier value derived from imported data", add 
label define label_xstaff04 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff04 53 "Value not derived - data not usable", add 
...
label define label_xstaff05 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff05 51 "Outlier value derived from imported data", add 
label define label_xstaff05 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff05 53 "Value not derived - data not usable", add 
...
label define label_xstaff06 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff06 51 "Outlier value derived from imported data", add 
label define label_xstaff06 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff06 53 "Value not derived - data not usable", add 
...
label define label_xstaff07 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff07 51 "Outlier value derived from imported data", add 
label define label_xstaff07 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff07 53 "Value not derived - data not usable", add 
...
label define label_xstaff08 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff08 51 "Outlier value derived from imported data", add 
label define label_xstaff08 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff08 53 "Value not derived - data not usable", add 
...
label define label_xstaff09 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff09 51 "Outlier value derived from imported data", add 
label define label_xstaff09 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff09 53 "Value not derived - data not usable", add 
...
label define label_xstaff10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff10 51 "Outlier value derived from imported data", add 
label define label_xstaff10 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff10 53 "Value not derived - data not usable", add 
...
label define label_xstaff11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff11 51 "Outlier value derived from imported data", add 
label define label_xstaff11 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff11 53 "Value not derived - data not usable", add 
...
label define label_xstaff12 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff12 51 "Outlier value derived from imported data", add 
label define label_xstaff12 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff12 53 "Value not derived - data not usable", add 
...
label define label_xstaff13 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff13 51 "Outlier value derived from imported data", add 
label define label_xstaff13 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff13 53 "Value not derived - data not usable", add 
...
label define label_xstaff14 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff14 51 "Outlier value derived from imported data", add 
label define label_xstaff14 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff14 53 "Value not derived - data not usable", add 
...
label define label_xstaff15 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff15 51 "Outlier value derived from imported data", add 
label define label_xstaff15 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff15 53 "Value not derived - data not usable", add 
...
label define label_xstaff16 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff16 51 "Outlier value derived from imported data", add 
label define label_xstaff16 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff16 53 "Value not derived - data not usable", add 
...
label define label_xstaff17 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff17 51 "Outlier value derived from imported data", add 
label define label_xstaff17 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff17 53 "Value not derived - data not usable", add 
...
label define label_xstaff18 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff18 51 "Outlier value derived from imported data", add 
label define label_xstaff18 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff18 53 "Value not derived - data not usable", add 
...
label define label_xstaff19 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff19 51 "Outlier value derived from imported data", add 
label define label_xstaff19 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff19 53 "Value not derived - data not usable", add 
...
label define label_xstaff20 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff20 51 "Outlier value derived from imported data", add 
label define label_xstaff20 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff20 53 "Value not derived - data not usable", add 
...
label define label_xstaff21 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff21 51 "Outlier value derived from imported data", add 
label define label_xstaff21 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff21 53 "Value not derived - data not usable", add 
...
label define label_xstaff22 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff22 51 "Outlier value derived from imported data", add 
label define label_xstaff22 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff22 53 "Value not derived - data not usable", add 
...
label define label_xstaff23 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff23 51 "Outlier value derived from imported data", add 
label define label_xstaff23 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff23 53 "Value not derived - data not usable", add 
...
label define label_xstaff24 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xstaff24 51 "Outlier value derived from imported data", add 
label define label_xstaff24 52 "Value not derived - parent/child differs across components", add 
label define label_xstaff24 53 "Value not derived - data not usable", add 
