...
*                                                        
insheet using "c:\dct\eap2005_data_stata.csv", comma clear
label data "dct_eap2005"
...
label define label_xeaptyp 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xeapmed 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xeaptot 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
