...
*                                                        
insheet using "c:\dct\s2003_abd_data_stata.csv", comma clear
label data "dct_s2003_abd"
...
label define label_sabdtype 11 "Full time, faculty (instruction, research, and public service) total", add 
...
label define label_sabdtype 2 "Full time and part time, faculty (instruction, research, and public service)", add 
...
label define label_sabdtype 70 "Part time, faculty (instruction, research, and public service)", add 
...
label define label_line 69 "Part time, iInstruction/research assistants", add 
