...
*                                                        
insheet using "c:\dct\sal97_hdr_data_stata.csv", comma clear
label data "dct_sal97_hdr"
...
label variable idx "UNITID of parent institution reporting Faculty Salaries"
