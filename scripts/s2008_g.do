...
*
insheet using "c:\dct\s2008_g_data_stata.csv", comma clear
label data "dct_s2008_g"
...
label define label_sgtype 2 "New hires, Instruction/research/public service staff total",add
label define label_sgtype 3 "New hires, Instruction/research/public service staff, With tenure",add
label define label_sgtype 4 "New hires, Instruction/research/public service staff, Non-tenured on tenure track",add
label define label_sgtype 5 "New hires, Instruction/research/public service staff, Non-tenured not on tenure track",add
label define label_sgtype 15 "New hires, Staff, Instruction/research/public service staff, without faculty status",add
