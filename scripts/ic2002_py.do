...
*                                                        
insheet using "c:\dct\ic2002_py_data_stata.csv", comma clear
label data "dct_ic2002_py"
...
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2000-01"
label variable chg1py1 "Published tuition and fees 2000-01"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2001-02"
label variable chg1py2 "Published tuition and fees 2001-02"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition snd fees 2002-03"
label variable chg1py3 "Published tuition snd fees 2002-03"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2000-01"
label variable chg4py1 "Books and supplies 2000-01"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2001-02"
label variable chg4py2 "Books and supplies 2001-02"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2002-03"
label variable chg4py3 "Books and supplies 2002-03"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2000-01"
label variable chg5py1 "On campus, room and board 2000-01"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2001-02"
label variable chg5py2 "On campus, room and board 2001-02"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2002-03"
label variable chg5py3 "On campus, room and board 2002-03"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2000-01"
label variable chg6py1 "On campus, other expenses 2000-01"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2001-02"
label variable chg6py2 "On campus, other expenses 2001-02"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2002-03"
label variable chg6py3 "On campus, other expenses 2002-03"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2000-01"
label variable chg7py1 "Off campus (not with family), room and board 2000-01"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2001-02"
label variable chg7py2 "Off campus (not with family), room and board 2001-02"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board 2002-03"
label variable chg7py3 "Off campus (not with family), room and board 2002-03"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2000-01"
label variable chg8py1 "Off campus (not with family), other expenses 2000-01"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2001-02"
label variable chg8py2 "Off campus (not with family), other expenses 2001-02"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2002-03"
label variable chg8py3 "Off campus (not with family), other expenses 2002-03"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2000-01"
label variable chg9py1 "Off campus (with family), other expenses 2000-01"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2001-02"
label variable chg9py2 "Off campus (with family), other expenses 2001-02"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2002-03"
label variable chg9py3 "Off campus (with family), other expenses 2002-03"
...
label variable cipcode3 "CIP code of 3nd largest program"
