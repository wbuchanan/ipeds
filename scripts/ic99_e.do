...
*                                                        
insheet using "c:\dct\ic99_e_data_stata.csv", comma clear
label data "dct_ic99_e"
label variable unitid "unitid"
label variable xenrolmn "Imputation field for ENROLMNT - Corrected fall enrollment count for Fall 1998"
label variable enrolmnt "Corrected fall enrollment count for Fall 1998"
label variable xgenenrl "Imputation field for GENENRL - Enrollment reported on the Fall 1998 enrollment file."
label variable genenrl "Enrollment reported on the Fall 1998 enrollment file."
...
label variable xcnactuf "Imputation field for CNACTUF - Fall term undergraduate contact hour activity"
...
label define label_xenrolmn 10 "Reported" 
label define label_xenrolmn 11 "Analyst corrected reported value", add 
label define label_xenrolmn 12 "Data generated from other data values", add 
label define label_xenrolmn 13 "Implied zero", add 
label define label_xenrolmn 14 "Data adjusted in scan edits", add 
label define label_xenrolmn 15 "Data copied from another field", add 
label define label_xenrolmn 16 "Analyst corrected a cell that was previously not reported", add 
label define label_xenrolmn 17 "Details are adjusted to sum to total", add 
label define label_xenrolmn 18 "Total generated to equal the sum of detail", add 
label define label_xenrolmn 30 "Not applicable", add 
label define label_xenrolmn 31 "Original data field was not reported", add 
label define label_xenrolmn 36 "Original reported value was deleted", add 
label define label_xenrolmn 40 "Suppressed to protect confidentiality", add 
label values xenrolmn label_xenrolmn
...
label define label_xgenenrl 36 "Original reported value was deleted", add 
label define label_xgenenrl 40 "Suppressed to protect confidentiality", add 
label values xgenenrl label_xgenenrl
label define label_month -2 "{Item not applicable}" 
label define label_month Alpha "{Alpha}", add 
label values month label_month
...
label define label_xtostucu 36 "Original reported value was deleted", add 
...
label define label_xtostucg 36 "Original reported value was deleted", add 
...
label define label_xtostucp 36 "Original reported value was deleted", add 
...
label define label_xcdactua 36 "Original reported value was deleted", add 
...
label define label_xcnactua 36 "Original reported value was deleted", add 
...
label define label_xcdactga 36 "Original reported value was deleted", add 
...
label define label_xcdactpa 36 "Original reported value was deleted", add 
...
label define label_xcdactuf 36 "Original reported value was deleted", add 
...
label define label_xcnactuf 36 "Original reported value was deleted", add 
...
label define label_xcdactgf 36 "Original reported value was deleted", add 
...
label define label_xcdactpf 36 "Original reported value was deleted", add 
