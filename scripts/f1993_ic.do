...
*                                                        
insheet using "c:\dct\f1993_ic_data_stata.csv", comma clear
label data "dct_f1993_ic"
...
label variable formrt "Survey forms F1, CN"
label variable parchild "Parent/child indicator"
label define label_rstatus 1 "Respondent" 
label define label_rstatus 10 "Imputed from FY 88", add 
label define label_rstatus 3 "Nonrespondent, not imputed", add 
label define label_rstatus 4 "Imputed using hotdeck method", add 
label define label_rstatus 56 "Combined imputed data", add 
label define label_rstatus 6 "Imputed from FY 92", add 
label define label_rstatus 7 "Imputed from FY 91", add 
label define label_rstatus 8 "Imputed from FY 90", add 
label define label_rstatus 9 "Imputed from FY 89", add 
