...
*                                                        
insheet using "c:\dct\f1991_k_data_stata.csv", comma clear
label data "dct_f1991_k"
...
label variable formrt "Survey form submitted by institution (1,2 or 3)."
