...
*                                                        
insheet using "c:\dct\gr2001_data_stata.csv", comma clear
...
label define label_section 1 "Bachelors/ equiv +  other degree/certif-seeking 1995 subcohorts (4-yr institution)" 
label define label_section 2 "Bachelors or equiv 1995 subcohort (4-yr institution)", add 
label define label_section 3 "Other degree/certif-seeking 1995 subcohort (4-yr institution)", add 
label define label_section 4 "Degree/certif-seeking students 1998 cohort ( 2-yr and <2-yr institution)", add 
label values section label_section
label define label_cohort 1 "Bachelors/ equiv +  other degree/certif-seeking 1995 subcohorts (4-yr institution)" 
label define label_cohort 2 "Bachelors or equiv 1995 subcohort (4-yr institution)", add 
label define label_cohort 3 "Other degree/certif-seeking 1995 subcohort (4-yr institution)", add 
label define label_cohort 4 "Degree/certif-seeking students 1998 cohort ( 2-yr institution)", add 
label define label_cohort 5 "Degree/certif-seeking students 1998 cohort ( <2-yr institution)", add 
