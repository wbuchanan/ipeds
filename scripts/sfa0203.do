...
*                                                        
insheet using "c:\dct\sfa0203_data_stata.csv", comma clear
label data "dct_sfa0203"
...
label define label_xscfa1n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa1p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa11n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa11p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa12n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa12p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa13n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa13p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa14n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa14p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfa2 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfy1n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfy1p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xscfy2 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xanyaidn 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xanyaidp 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xfgrnt_n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xfgrnt_p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xfgrnt_a 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xsgrnt_n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xsgrnt_p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xsgrnt_a 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xigrnt_n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xigrnt_p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xigrnt_a 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xloan_n 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xloan_p 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xloan_a 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
