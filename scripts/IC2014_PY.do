...
*
insheet using "c:\dct\ic2014_py_data_stata.csv", comma clear
label data "dct_ic2014_py"
label variable unitid   "Unique identification number of the institution"
label variable prgmofr  "Number of programs offered"
label variable cipcode1 "CIP code of largest program"
label variable xciptui1 "Imputation field for ciptuit1 - Tuition and fees 2014-15 (institutions with no full-time, first-time, undergraduate students)"
label variable ciptuit1 "Tuition and fees 2014-15 (institutions with no full-time, first-time, undergraduate students)"
label variable xcipsup1 "Imputation field for cipsupp1 - Books and supplies 2014-15 (institutions with no full-time, first-time, undergraduate students)"
label variable cipsupp1 "Books and supplies 2014-15 (institutions with no full-time, first-time, undergraduate students)"
...
label variable xchg1py0 "Imputation field for chg1py0 - Published tuition and fees 2011-12"
label variable chg1py0  "Published tuition and fees 2011-12"
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2012-13"
label variable chg1py1  "Published tuition and fees 2012-13"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2013-14"
label variable chg1py2  "Published tuition and fees 2013-14"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2014-15"
label variable chg1py3  "Published tuition and fees 2014-15"
label variable xchg4py0 "Imputation field for chg4py0 - Books and supplies 2011-12"
label variable chg4py0  "Books and supplies 2011-12"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2012-13"
label variable chg4py1  "Books and supplies 2012-13"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2013-14"
label variable chg4py2  "Books and supplies 2013-14"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2014-15"
label variable chg4py3  "Books and supplies 2014-15"
label variable xchg5py0 "Imputation field for chg5py0 - On campus, room and board 2011-12"
label variable chg5py0  "On campus, room and board 2011-12"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2012-13"
label variable chg5py1  "On campus, room and board 2012-13"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2013-14"
label variable chg5py2  "On campus, room and board 2013-14"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2014-15"
label variable chg5py3  "On campus, room and board 2014-15"
label variable xchg6py0 "Imputation field for chg6py0 - On campus, other expenses 2011-12"
label variable chg6py0  "On campus, other expenses 2011-12"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2012-13"
label variable chg6py1  "On campus, other expenses 2012-13"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2013-14"
label variable chg6py2  "On campus, other expenses 2013-14"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2014-15"
label variable chg6py3  "On campus, other expenses 2014-15"
label variable xchg7py0 "Imputation field for chg7py0 - Off campus (not with family), room and board 2011-12"
label variable chg7py0  "Off campus (not with family), room and board 2011-12"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2012-13"
label variable chg7py1  "Off campus (not with family), room and board 2012-13"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2013-14"
label variable chg7py2  "Off campus (not with family), room and board 2013-14"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board 2014-15"
label variable chg7py3  "Off campus (not with family), room and board 2014-15"
label variable xchg8py0 "Imputation field for chg8py0 - Off campus (not with family), other expenses 2011-12"
label variable chg8py0  "Off campus (not with family), other expenses 2011-12"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2012-13"
label variable chg8py1  "Off campus (not with family), other expenses 2012-13"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2013-14"
label variable chg8py2  "Off campus (not with family), other expenses 2013-14"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2014-15"
label variable chg8py3  "Off campus (not with family), other expenses 2014-15"
label variable xchg9py0 "Imputation field for chg9py0 - Off campus (with family), other expenses 2011-12"
label variable chg9py0  "Off campus (with family), other expenses 2011-12"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2012-13"
label variable chg9py1  "Off campus (with family), other expenses 2012-13"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2013-14"
label variable chg9py2  "Off campus (with family), other expenses 2013-14"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2014-15"
label variable chg9py3  "Off campus (with family), other expenses 2014-15"
...
label define label_cipcode1 470600 "47.0600-Vehicle Maintenance and Repair Technologies, General",add
...
label define label_cipcode1 513804 "51.3804-Nurse Anesthetist",add
...
label define label_cipcode1 513818 "51.3818-Nursing Practice",add
...
label define label_cipcode2  10601 "01.0601-Applied Horticulture/Horticulture Operations, General"
...
label define label_cipcode2 120510 "12.0510-Wine Steward/Sommelier",add
...
label define label_cipcode2 480511 "48.0511-Metal Fabricator",add
...
label define label_cipcode2 510719 "51.0719-Clinical Research Coordinator",add
...
label define label_cipcode3 150499 "15.0499-Electromechanical and Instrumentation and Maintenance Technologies/Technicians,",add
...
label define label_cipcode3 500601 "50.0601-Film/Cinema/Video Studies",add
...
label define label_cipcode3 501001 "50.1001-Arts, Entertainment,and Media Management, General",add
label define label_cipcode3 501099 "50.1099-Arts, Entertainment, and Media Management, Other",add
...
label define label_cipcode4  10504 "01.0504-Dog/Pet/Animal Grooming"
...
label define label_cipcode4 470612 "47.0612-Vehicle Emissions Inspection and Maintenance Technology/Technician.",add
...
label define label_cipcode4 500913 "50.0913-Music Technology",add
label define label_cipcode4 501099 "50.1099-Arts, Entertainment, and Media Management, Other",add
...
label define label_cipcode5 141001 "14.1001-Electrical and Electronics Engineering",add
...
label define label_cipcode5 500913 "50.0913-Music Technology",add
...
label define label_cipcode5 510999 "51.0999-Allied Health Diagnostic, Intervention, and Treatment Professions, Other",add
...
label define label_cipcode5 512604 "51.2604-Rehabilitation Aide",add
...
label define label_cipcode6  10102 "01.0102-Agribusiness/Agricultural Business Operations"
...
label define label_cipcode6 111005 "11.1005-Information Technology Project Management",add
...
label define label_cipcode6 131401 "13.1401-Teaching English as a Second or Foreign Language/ESL Language Instructor",add
...
label define label_cipcode6 439999 "43.9999-Homeland Security, Law Enforcement, Firefighting and Related Protective Services, O",add
...
label define label_cipcode6 470600 "47.0600-Vehicle Maintenance and Repair Technologies, General",add
...
label define label_cipcode6 500411 "50.0411-Game and Interactive Media Design",add
...
label define label_cipcode6 501003 "50.1003-Music Management",add
...
label define label_cipcode6 510903 "51.0903-Electroneurodiagnostic/Electroencephalographic Technology/Technologist",add
...
label define label_cipcode6 513899 "51.3899-Registered Nursing, Nursing Administration, Nursing Research and Clinical Nursing,",add
...
label define label_cipcode6 520909 "52.0909-Hotel, Motel, and Restaurant Management",add
