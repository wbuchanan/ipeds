...
*
insheet using "c:\dct\ic2009_py_rv_data_stata.csv", comma clear
label data "dct_ic2009_py_rv"
label variable unitid   "Unique identification number of the institution"
label variable prgmofr  "Number of programs offered"
label variable cipcode1 "CIP code of largest program"
label variable xciptui1 "Imputation field for ciptuit1 - Tuition and fees 2009-10 (institutions with no full-time, first-time, undergraduate students)"
label variable ciptuit1 "Tuition and fees 2009-10 (institutions with no full-time, first-time, undergraduate students)"
label variable xcipsup1 "Imputation field for cipsupp1 - Books and supplies 2009-10 (institutions with no full-time, first-time, undergraduate students)"
label variable cipsupp1 "Books and supplies 2009-10 (institutions with no full-time, first-time, undergraduate students)"
...
label variable xchg1py0 "Imputation field for chg1py0 - Published tuition and fees 2006-07"
label variable chg1py0  "Published tuition and fees 2006-07"
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2007-08"
label variable chg1py1  "Published tuition and fees 2007-08"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2008-09"
label variable chg1py2  "Published tuition and fees 2008-09"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2009-10"
label variable chg1py3  "Published tuition and fees 2009-10"
label variable xchg4py0 "Imputation field for chg4py0 - Books and supplies 2006-07"
label variable chg4py0  "Books and supplies 2006-07"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2007-08"
label variable chg4py1  "Books and supplies 2007-08"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2008-09"
label variable chg4py2  "Books and supplies 2008-09"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2009-10"
label variable chg4py3  "Books and supplies 2009-10"
label variable xchg5py0 "Imputation field for chg5py0 - On campus, room and board 2006-07"
label variable chg5py0  "On campus, room and board 2006-07"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2007-08"
label variable chg5py1  "On campus, room and board 2007-08"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2008-09"
label variable chg5py2  "On campus, room and board 2008-09"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2009-10"
label variable chg5py3  "On campus, room and board 2009-10"
label variable xchg6py0 "Imputation field for chg6py0 - On campus, other expenses 2006-07"
label variable chg6py0  "On campus, other expenses 2006-07"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2007-08"
label variable chg6py1  "On campus, other expenses 2007-08"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2008-09"
label variable chg6py2  "On campus, other expenses 2008-09"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2009-10"
label variable chg6py3  "On campus, other expenses 2009-10"
label variable xchg7py0 "Imputation field for chg7py0 - Off campus (not with family), room and board 2006-07"
label variable chg7py0  "Off campus (not with family), room and board 2006-07"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2007-08"
label variable chg7py1  "Off campus (not with family), room and board 2007-08"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2008-09"
label variable chg7py2  "Off campus (not with family), room and board 2008-09"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board 2009-10"
label variable chg7py3  "Off campus (not with family), room and board 2009-10"
label variable xchg8py0 "Imputation field for chg8py0 - Off campus (not with family), other expenses 2006-07"
label variable chg8py0  "Off campus (not with family), other expenses 2006-07"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2007-08"
label variable chg8py1  "Off campus (not with family), other expenses 2007-08"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2008-09"
label variable chg8py2  "Off campus (not with family), other expenses 2008-09"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2009-10"
label variable chg8py3  "Off campus (not with family), other expenses 2009-10"
label variable xchg9py0 "Imputation field for chg9py0 - Off campus (with family), other expenses 2006-07"
label variable chg9py0  "Off campus (with family), other expenses 2006-07"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2007-08"
label variable chg9py1  "Off campus (with family), other expenses 2007-08"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2008-09"
label variable chg9py2  "Off campus (with family), other expenses 2008-09"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2009-10"
label variable chg9py3  "Off campus (with family), other expenses 2009-10"
label variable xcmp1py0 "Imputation field for cmp1py0 - Comprehensive fee 2006-07"
label variable cmp1py0  "Comprehensive fee 2006-07"
label variable xcmp1py1 "Imputation field for cmp1py1 - Comprehensive fee 2007-08"
label variable cmp1py1  "Comprehensive fee 2007-08"
label variable xcmp1py2 "Imputation field for cmp1py2 - Comprehensive fee 2008-09"
label variable cmp1py2  "Comprehensive fee 2008-09"
label variable xcmp1py3 "Imputation field for cmp1py3 - Comprehensive fee 2009-10"
label variable cmp1py3  "Comprehensive fee 2009-10"
...
label define label_cipcode1 131399 "13.1399-Teacher Education and Professional Development, Specific Subject Areas, Ot",add
...
label define label_cipcode2  10605 "01.0605-Landscaping and Groundskeeping"
...
label define label_cipcode2 510999 "51.0999-Allied Health Diagnostic, Intervention, and Treatment Professions, Other",add
...
label define label_cipcode3 131299 "13.1299-Teacher Education and Professional Development, Specific Levels and Method",add
...
label define label_cipcode4  30199 "03.0199-Natural Resources Conservation and Research, Other"
...
label define label_cipcode4 460499 "46.0499-Building/Construction Finishing, Management, and Inspection, Other",add
...
label define label_cipcode5  10601 "01.0601-Applied Horticulture/Horticultural Operations, General",add
...
label define label_cipcode5 131299 "13.1299-Teacher Education and Professional Development, Specific Levels and Method",add
...
label define label_cipcode5 511601 "51.1601-Nursing - Registered Nurse Training (RN, ASN, BSN, MSN)",add
...
label define label_cipcode6 131399 "13.1399-Teacher Education and Professional Development, Specific Subject Areas, Ot",add
