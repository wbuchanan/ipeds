...
*                                                        
insheet using "c:\dct\ef96_acp_data_stata.csv", comma clear
label data "dct_ef96_acp"
label variable unitid "unitid"
label variable part "part"
label variable line "Year of study by level of student count"
...
label variable balmen "Balance for men"
label variable balwomen "Balance for women"
label variable cipcode "Classification of instruction program code"
...
label define label_section -1 "No Response/Missing" 
label define label_section 1 "Full-time students", add 
