...
*                                                        
insheet using "c:\dct\gr1997_l2_data_stata.csv", comma clear
label data "dct_gr1997_l2"
...
label define label_xline_10 17 "Details are adjusted to sum of total", add 
label define label_xline_10 18 "Total generated to equal the sum of detail", add 
label define label_xline_10 20 "Imputed using data from prior year", add 
label define label_xline_10 21 "Imputed using method other than prior year data", add 
...
label define label_xline_10 99 "{Item flag value not assigned}", add 
...
label define label_xline_45 17 "Details are adjusted to sum of total", add 
label define label_xline_45 18 "Total generated to equal the sum of detail", add 
label define label_xline_45 20 "Imputed using data from prior year", add 
label define label_xline_45 21 "Imputed using method other than prior year data", add 
...
label define label_xline_45 99 "{Item flag value not assigned}", add 
...
label define label_xline_50 17 "Details are adjusted to sum of total", add 
label define label_xline_50 18 "Total generated to equal the sum of detail", add 
label define label_xline_50 20 "Imputed using data from prior year", add 
label define label_xline_50 21 "Imputed using method other than prior year data", add 
...
label define label_xline_50 99 "{Item flag value not assigned}", add 
...
label define label_xline_11 17 "Details are adjusted to sum of total", add 
label define label_xline_11 18 "Total generated to equal the sum of detail", add 
label define label_xline_11 20 "Imputed using data from prior year", add 
label define label_xline_11 21 "Imputed using method other than prior year data", add 
...
label define label_xline_11 99 "{Item flag value not assigned}", add 
...
label define label_xline_30 17 "Details are adjusted to sum of total", add 
label define label_xline_30 18 "Total generated to equal the sum of detail", add 
label define label_xline_30 20 "Imputed using data from prior year", add 
label define label_xline_30 21 "Imputed using method other than prior year data", add 
...
label define label_xline_30 99 "{Item flag value not assigned}", add 
