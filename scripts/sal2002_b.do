...
*                                                        
insheet using "c:\dct\sal2002_b_data_stata.csv", comma clear
label data "dct_sal2002_b"
...
label define label_xsab09 23 "Partial imputation", add 
...
label define label_xsab11 23 "Partial imputation", add 
...
label define label_xsabeq9 23 "Partial imputation", add 
