...
*                                                        
insheet using "c:\dct\f9495_c_data_stata.csv", comma clear
label data "dct_f9495_c"
label variable unitid "unitid"
label variable part "part"
label variable c1_1 "Institutional system code"
label variable c1_2 "Costs of operation of central administration inclu"
label variable c1amt "Amount of operation of central administration incl"
label variable c2a "Tuition and fees"
label variable c2b "Tuition and fees included used for other than oper"
label variable c2c "Tuition fees not included used for other than oper"
label variable c2d "Total tution and fees"
label variable c3_1 "Intercollegiate athletic program"
label variable c3_3 "Intercollegiate athletic auxiliary enterprises cod"
label variable c3amt3 "Intercollegiate athletic auxiliary enterprises amo"
