...
*                                                        
insheet using "c:\dct\f1992_k_data_stata.csv", comma clear
label data "dct_f1992_k"
...
label define label_xk011 98 "Not a valid code value", add 
...
label define label_xk012 98 "Not a valid code value", add 
...
label define label_xk013 98 "Not a valid code value", add 
...
label define label_xk014 98 "Not a valid code value", add 
...
label define label_xk021 98 "Not a valid code value", add 
...
label define label_xk022 98 "Not a valid code value", add 
...
label define label_xk023 98 "Not a valid code value", add 
...
label define label_xk024 98 "Not a valid code value", add 
...
label define label_xk025 98 "Not a valid code value", add 
...
label define label_xk031 98 "Not a valid code value", add 
...
label define label_xk032 98 "Not a valid code value", add 
...
label define label_xk033 98 "Not a valid code value", add 
...
label define label_xk034 98 "Not a valid code value", add 
...
label define label_xk035 98 "Not a valid code value", add 
