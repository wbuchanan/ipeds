...
*                                                        
insheet using "c:\dct\ic2005_py_data_stata.csv", comma clear
label data "dct_ic2005_py"
...
label variable xchg1py1 "Imputation field for chg1py1 - Published tuition and fees 2003-04"
label variable chg1py1 "Published tuition and fees 2003-04"
label variable xchg1py2 "Imputation field for chg1py2 - Published tuition and fees 2004-05"
label variable chg1py2 "Published tuition and fees 2004-05"
label variable xchg1py3 "Imputation field for chg1py3 - Published tuition and fees 2005-06"
label variable chg1py3 "Published tuition and fees 2005-06"
label variable xchg4py1 "Imputation field for chg4py1 - Books and supplies 2003-04"
label variable chg4py1 "Books and supplies 2003-04"
label variable xchg4py2 "Imputation field for chg4py2 - Books and supplies 2004-05"
label variable chg4py2 "Books and supplies 2004-05"
label variable xchg4py3 "Imputation field for chg4py3 - Books and supplies 2005-06"
label variable chg4py3 "Books and supplies 2005-06"
label variable xchg5py1 "Imputation field for chg5py1 - On campus, room and board 2003-04"
label variable chg5py1 "On campus, room and board 2003-04"
label variable xchg5py2 "Imputation field for chg5py2 - On campus, room and board 2004-05"
label variable chg5py2 "On campus, room and board 2004-05"
label variable xchg5py3 "Imputation field for chg5py3 - On campus, room and board 2005-06"
label variable chg5py3 "On campus, room and board 2005-06"
label variable xchg6py1 "Imputation field for chg6py1 - On campus, other expenses 2003-04"
label variable chg6py1 "On campus, other expenses 2003-04"
label variable xchg6py2 "Imputation field for chg6py2 - On campus, other expenses 2004-05"
label variable chg6py2 "On campus, other expenses 2004-05"
label variable xchg6py3 "Imputation field for chg6py3 - On campus, other expenses 2005-06"
label variable chg6py3 "On campus, other expenses 2005-06"
label variable xchg7py1 "Imputation field for chg7py1 - Off campus (not with family), room and board 2003-04"
label variable chg7py1 "Off campus (not with family), room and board 2003-04"
label variable xchg7py2 "Imputation field for chg7py2 - Off campus (not with family), room and board 2004-05"
label variable chg7py2 "Off campus (not with family), room and board 2004-05"
label variable xchg7py3 "Imputation field for chg7py3 - Off campus (not with family), room and board 2005-06"
label variable chg7py3 "Off campus (not with family), room and board 2005-06"
label variable xchg8py1 "Imputation field for chg8py1 - Off campus (not with family), other expenses 2003-04"
label variable chg8py1 "Off campus (not with family), other expenses 2003-04"
label variable xchg8py2 "Imputation field for chg8py2 - Off campus (not with family), other expenses 2004-05"
label variable chg8py2 "Off campus (not with family), other expenses 2004-05"
label variable xchg8py3 "Imputation field for chg8py3 - Off campus (not with family), other expenses 2005-06"
label variable chg8py3 "Off campus (not with family), other expenses 2005-06"
label variable xchg9py1 "Imputation field for chg9py1 - Off campus (with family), other expenses 2003-04"
label variable chg9py1 "Off campus (with family), other expenses 2003-04"
label variable xchg9py2 "Imputation field for chg9py2 - Off campus (with family), other expenses 2004-05"
label variable chg9py2 "Off campus (with family), other expenses 2004-05"
label variable xchg9py3 "Imputation field for chg9py3 - Off campus (with family), other expenses 2005-06"
label variable chg9py3 "Off campus (with family), other expenses 2005-06"
...
label variable xcmp1py1 "Imputation field for CMP1PY1 - Comprehensive fee 2003-04"
label variable cmp1py1 "Comprehensive fee 2003-04"
label variable xcmp1py2 "Imputation field for CMP1PY2 - Comprehensive fee 2004-05"
label variable cmp1py2 "Comprehensive fee 2004-05"
label variable xcmp1py3 "Imputation field for CMP1PY3 - Comprehensive fee 2005-06"
label variable cmp1py3 "Comprehensive fee 2005-06"
...
label define label_xciplgt1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg1py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg1py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg1py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg4py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg4py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg4py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg5py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg5py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg5py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg6py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg6py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg6py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg7py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg7py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg7py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg8py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg8py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg8py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg9py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg9py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xchg9py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciptui2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcipsup2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciplgt2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciptui3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcipsup3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciplgt3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciptui4 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcipsup4 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciplgt4 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciptui5 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcipsup5 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciplgt5 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciptui6 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcipsup6 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xciplgt6 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcmp1py1 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcmp1py2 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcmp1py3 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
