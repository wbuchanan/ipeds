...
*                                                        
insheet using "c:\dct\sal1989_ic_data_stata.csv", comma clear
label data "dct_sal1989_ic"
...
label variable box1 "All instructional faculty are employed part-time"
label variable box2 "All instructional faculty are military personnel"
label variable box3 "All instructional faculty contribute their services (e.g., members of a religious order)"
