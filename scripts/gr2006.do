...
*                                                        
insheet using "c:\dct\gr2006_data_stata.csv", comma clear
...
label define label_section 1 "Bachelors/ equiv +  other degree/certif-seeking 1999 subcohort (4-yr institution)" 
label define label_section 2 "Bachelors or equiv 1999 subcohort (4-yr institution)", add 
label define label_section 3 "Other degree/certif-seeking 1999 subcohort (4-yr institution)", add 
label define label_section 4 "Degree/certif-seeking students 2002 cohort ( 2-yr and <2-yr institution)", add 
label values section label_section
label define label_cohort 1 "Bachelors/ equiv +  other degree/certif-seeking 1999 subcohorts (4-yr institution)" 
label define label_cohort 2 "Bachelors or equiv 1999 subcohort (4-yr institution)", add 
label define label_cohort 3 "Other degree/certif-seeking 1999 subcohort (4-yr institution)", add 
label define label_cohort 4 "Degree/certif-seeking students 2002 cohort ( 2-yr institution)", add 
...
label define label_xgrrac01 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac01 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac02 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac02 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac03 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac03 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac04 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac04 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac05 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac05 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac06 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac06 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac07 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac07 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac08 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac08 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac09 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac09 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac10 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac11 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac12 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac12 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac13 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac13 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac14 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac14 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac15 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac15 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac16 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac16 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac17 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac17 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac18 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac18 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac19 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac19 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac20 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac20 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac21 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac21 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac22 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac22 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac23 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac23 51 "Outlier value derived from imported data", add 
...
label define label_xgrrac24 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xgrrac24 51 "Outlier value derived from imported data", add 
