...
*                                                        
insheet using "c:\dct\efia2006_data_stata.csv", comma clear
label data "dct_efia2006"
...
label variable xefteug "Imputation field for EFTEUG - Estimated full-time equivalent (FTE) undergraduate enrollment, academic year 2005-06"
label variable efteug "Estimated full-time equivalent (FTE) undergraduate enrollment, academic year 2005-06"
label variable xeftegd "Imputation field for EFTEGD - Estimated full-time equivalent (FTE) graduate enrollment, academic year 2005-06"
label variable eftegd "Estimated full-time equivalent (FTE) graduate enrollment, academic year 2005-06"
label variable xfteug "Imputation field for FTEUG - Reported full-time equivalent (FTE) undergraduate enrollment, academic year 2005-06"
label variable fteug "Reported full-time equivalent (FTE) undergraduate enrollment, academic year 2005-06"
label variable xftegd "Imputation field for FTEGD - Reported full-time equivalent (FTE) graduate enrollment, academic year 2005-06"
label variable ftegd "Reported full-time equivalent (FTE) graduate enrollment, academic year 2005-06"
...
label define label_xcdactua 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xcdactua 51 "Outlier value derived from imported data", add 
label define label_xcdactua 52 "Value not derived - parent/child differs across components", add 
label define label_xcdactua 53 "Value not derived - data not usable", add 
...
label define label_xcnactua 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xcnactua 51 "Outlier value derived from imported data", add 
label define label_xcnactua 52 "Value not derived - parent/child differs across components", add 
label define label_xcnactua 53 "Value not derived - data not usable", add 
...
label define label_xcdactga 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xcdactga 51 "Outlier value derived from imported data", add 
label define label_xcdactga 52 "Value not derived - parent/child differs across components", add 
label define label_xcdactga 53 "Value not derived - data not usable", add 
...
label define label_xefteug 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xefteug 51 "Outlier value derived from imported data", add 
label define label_xefteug 52 "Value not derived - parent/child differs across components", add 
label define label_xefteug 53 "Value not derived - data not usable", add 
...
label define label_xeftegd 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xeftegd 51 "Outlier value derived from imported data", add 
label define label_xeftegd 52 "Value not derived - parent/child differs across components", add 
label define label_xeftegd 53 "Value not derived - data not usable", add 
...
label define label_xfteug 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfteug 51 "Outlier value derived from imported data", add 
label define label_xfteug 52 "Value not derived - parent/child differs across components", add 
label define label_xfteug 53 "Value not derived - data not usable", add 
...
label define label_xftegd 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xftegd 51 "Outlier value derived from imported data", add 
label define label_xftegd 52 "Value not derived - parent/child differs across components", add 
label define label_xftegd 53 "Value not derived - data not usable", add 
