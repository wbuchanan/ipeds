...
*                                                        
insheet using "c:\dct\gr2000_l2_data_stata.csv", comma clear
label data "dct_gr2000_l2"
...
label define label_xline_10 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xline_45 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xline_50 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xline_11 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xline_30 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
