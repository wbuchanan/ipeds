...
*                                                        
insheet using "c:\dct\c2005_a_data_stata.csv", comma clear
label data "dct_c2005_a"
...
label define label_xcrace01 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace02 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace03 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace04 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace05 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace06 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace07 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace08 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace09 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace10 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace11 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace12 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace13 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace14 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace15 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace16 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace17 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace18 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace19 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace20 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace21 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace22 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace23 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xcrace24 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
