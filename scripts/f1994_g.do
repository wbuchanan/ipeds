...
*                                                        
insheet using "c:\dct\f1994_g_data_stata.csv", comma clear
label data "dct_f1994_g"
...
label define label_xg01 20 "Imputed for a missing item using data from prior year", add 
label define label_xg01 21 "Imputed for a missing item using method other than prior year", add 
label define label_xg01 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xg01 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xg02 20 "Imputed for a missing item using data from prior year", add 
label define label_xg02 21 "Imputed for a missing item using method other than prior year", add 
label define label_xg02 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xg02 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xg03 20 "Imputed for a missing item using data from prior year", add 
label define label_xg03 21 "Imputed for a missing item using method other than prior year", add 
label define label_xg03 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xg03 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xg04 20 "Imputed for a missing item using data from prior year", add 
label define label_xg04 21 "Imputed for a missing item using method other than prior year", add 
label define label_xg04 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xg04 26 "Imputed for an item that was previously reported using method other than prior year", add 
...
label define label_xg05 20 "Imputed for a missing item using data from prior year", add 
label define label_xg05 21 "Imputed for a missing item using method other than prior year", add 
label define label_xg05 25 "Imputed for an item that was previously reported using data from prior year", add 
label define label_xg05 26 "Imputed for an item that was previously reported using method other than prior year", add 
