...
*                                                        
insheet using "c:\dct\ef2000cp_data_stata.csv", comma clear
label data "dct_ef2000cp"
...
label variable cipcode "Classification of instructional program"
