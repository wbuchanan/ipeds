...
*                                                        
insheet using "c:\dct\f9900f3_data_stata.csv", comma clear
label data "dct_f9900f3"
...
label variable xf3e03 "Imputation field for F3E03 - Academic and institutional support, and Student servicest"
label variable f3e03 "Academic and institutional support, and Student servicest"
label variable xf3e04 "Imputation field for F3E04 - Auxiliary enterises"
label variable f3e04 "Auxiliary enterises"
...
label define label_xf3a01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3a02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3a03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3a04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3b08 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3c01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3c02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3c03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3c04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3c05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3c06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3c07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d08 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3d09 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3e01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3e02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3e03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3e04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3e05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3e06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf3e07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
