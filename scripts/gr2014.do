...
*
insheet using "k:\ipedsdata\dct\gr2014_data_stata.csv", comma clear
...
label define label_section 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2008 subcohort (4-yr institution)"
label define label_section 2 "Bachelor^s or equiv 2008 subcohort (4-yr institution)",add
label define label_section 3 "Other degree/certif-seeking 2008 subcohort (4-yr institution)",add
label define label_section 4 "Degree/certif-seeking students 2011 cohort ( 2-yr )",add
label values section label_section
label define label_cohort 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2008 subcohorts (4-yr institution)"
label define label_cohort 2 "Bachelor^s or equiv 2008  subcohort (4-yr institution)",add
label define label_cohort 3 "Other degree/certif-seeking 2008 subcohort (4-yr institution)",add
label define label_cohort 4 "Degree/certif-seeking students 2011 cohort ( 2-yr institution)",add
