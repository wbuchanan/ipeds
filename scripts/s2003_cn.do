...
*                                                        
insheet using "c:\dct\s2003_cn_data_stata.csv", comma clear
label data "dct_s2003_cn"
...
label define label_scnlevel 11 "Full time, faculty (instruction, research, and public service)", add 
label define label_scnlevel 2 "Total employees, faculty (instruction, research, and public service)", add 
...
label define label_scnlevel 4 "Total employees, faculty (instruction, research, and public service), executive, administrative, and managerial", add 
label define label_scnlevel 45 "Full time, nonprofessional staff, technical and paraprofessionals", add 
label define label_scnlevel 5 "Total employees, faculty (instruction, research, and public service), other professionals", add 
...
label define label_scnlevel 70 "Part time, faculty (instruction, research, and public service)", add 
