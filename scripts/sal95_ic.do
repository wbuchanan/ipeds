...
*                                                        
insheet using "c:\dct\sal95_ic_data_stata.csv", comma clear
label data "dct_sal95_ic"
...
label define label_box3 -1 "No Response/Missing" 
label define label_box3 1 "Yes", add 
label values box3 label_box3
label define label_box4 -1 "No Response/Missing" 
label define label_box4 1 "All faculty teach preclinical/clinical medicine", add 
