...
*                                                        
insheet using "c:\dct\ef2005b_data_stata.csv", comma clear
label data "dct_ef2005b"
...
label define label_xefage01 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage02 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage03 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage04 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage05 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage06 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage07 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage08 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefage09 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
